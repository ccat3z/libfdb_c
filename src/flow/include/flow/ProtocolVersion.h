...
constexpr uint64_t defaultProtocolVersionValue = 0x0FDB00B073000000LL;
...
constexpr uint64_t minInvalidProtocolVersionValue = 0x0FDB00B075000000LL;

// The lowest protocol version that can be downgraded to.
constexpr uint64_t minCompatibleProtocolVersionValue = 0x0FDB00B072000000LL;

// The protocol version that will most likely follow the current one
// Used only for testing upgrades to the future version
constexpr uint64_t futureProtocolVersionValue = 0x0FDB00B074000000LL;
...
public: // introduced features
	...
	PROTOCOL_VERSION_FEATURE(0x0FDB00B072000000LL, EncryptedSnapshotBackupFile);
	PROTOCOL_VERSION_FEATURE(0x0FDB00B072000000LL, ClusterIdSpecialKey);
	PROTOCOL_VERSION_FEATURE(0x0FDB00B072000000LL, BlobGranuleFileLogicalSize);
	PROTOCOL_VERSION_FEATURE(0x0FDB00B072000000LL, BlobRangeChangeLog);
	PROTOCOL_VERSION_FEATURE(0x0FDB00B073000000LL, GcTxnGenerations);
};
