...
#line 1 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
/*
...
// An actor that can join a set of threads in an async way.
															#line 182 "/src/flow/WriteOnlySet.actor.g.cpp"
// This generated class is to be used only via threadjoiner()
															#line 180 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
template <class ThreadjoinerActor>
															#line 180 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
class ThreadjoinerActorState {
															#line 188 "/src/flow/WriteOnlySet.actor.g.cpp"
public:
															#line 180 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
	ThreadjoinerActorState(std::shared_ptr<std::vector<std::thread>> const& threads,std::shared_ptr<TestSet> const& set) 
		 ...
		 : threads(threads),
															#line 180 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
		   set(set)
															#line 197 "/src/flow/WriteOnlySet.actor.g.cpp"
	{
	...
	{
		try {
															#line 181 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			;
															#line 210 "/src/flow/WriteOnlySet.actor.g.cpp"
	...
	{
															#line 182 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
		...
		if (static_cast<ThreadjoinerActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), std::max(0, loopDepth - 1));
															#line 242 "/src/flow/WriteOnlySet.actor.g.cpp"
		...
		__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< ThreadjoinerActor, 0, Void >*>(static_cast<ThreadjoinerActor*>(this)));
															#line 247 "/src/flow/WriteOnlySet.actor.g.cpp"
		loopDepth = 0;
	...
	{
															#line 183 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
		for(unsigned i = 0;;) {
															#line 184 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			if (threads->size() == i)
															#line 258 "/src/flow/WriteOnlySet.actor.g.cpp"
			{
				break;
			}
															#line 187 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			auto& t = (*threads)[i];
															#line 188 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			if (t.joinable())
															#line 266 "/src/flow/WriteOnlySet.actor.g.cpp"
			{
															#line 189 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
				t.join();
															#line 190 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
				if (i + 1 < threads->size())
															#line 272 "/src/flow/WriteOnlySet.actor.g.cpp"
				{
															#line 191 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
					std::swap(*threads->rbegin(), (*threads)[i]);
															#line 276 "/src/flow/WriteOnlySet.actor.g.cpp"
				}
															#line 193 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
				threads->pop_back();
															#line 280 "/src/flow/WriteOnlySet.actor.g.cpp"
			}
			else
			{
															#line 195 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
				++i;
															#line 286 "/src/flow/WriteOnlySet.actor.g.cpp"
			}
		}
															#line 198 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
		if (threads->empty())
															#line 291 "/src/flow/WriteOnlySet.actor.g.cpp"
		{
															#line 199 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			set->copy();
															#line 200 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			ASSERT(instanceCounter.load() == 0);
															#line 201 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			if (!static_cast<ThreadjoinerActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~ThreadjoinerActorState(); static_cast<ThreadjoinerActor*>(this)->destroy(); return 0; }
															#line 299 "/src/flow/WriteOnlySet.actor.g.cpp"
	...
	int a_body1loopBody1cont1(Void && _,int loopDepth) 
	{
		...
		for(unsigned i = 0;;) {
															#line 184 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			if (threads->size() == i)
															#line 315 "/src/flow/WriteOnlySet.actor.g.cpp"
			{
				break;
			}
															#line 187 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			auto& t = (*threads)[i];
															#line 188 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			if (t.joinable())
															#line 323 "/src/flow/WriteOnlySet.actor.g.cpp"
			{
															#line 189 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
				t.join();
															#line 190 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
				if (i + 1 < threads->size())
															#line 329 "/src/flow/WriteOnlySet.actor.g.cpp"
				{
															#line 191 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
					std::swap(*threads->rbegin(), (*threads)[i]);
															#line 333 "/src/flow/WriteOnlySet.actor.g.cpp"
				}
															#line 193 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
				threads->pop_back();
															#line 337 "/src/flow/WriteOnlySet.actor.g.cpp"
			}
			else
			{
															#line 195 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
				++i;
															#line 343 "/src/flow/WriteOnlySet.actor.g.cpp"
			}
		}
															#line 198 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
		if (threads->empty())
															#line 348 "/src/flow/WriteOnlySet.actor.g.cpp"
		{
															#line 199 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			set->copy();
															#line 200 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			ASSERT(instanceCounter.load() == 0);
															#line 201 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			if (!static_cast<ThreadjoinerActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~ThreadjoinerActorState(); static_cast<ThreadjoinerActor*>(this)->destroy(); return 0; }
															#line 356 "/src/flow/WriteOnlySet.actor.g.cpp"
			new (&static_cast<ThreadjoinerActor*>(this)->SAV< Void >::value()) Void(Void());
			this->~ThreadjoinerActorState();
			static_cast<ThreadjoinerActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
	...
	std::shared_ptr<TestSet> set;
															#line 427 "/src/flow/WriteOnlySet.actor.g.cpp"
};
// This generated class is to be used only via threadjoiner()
															#line 180 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
class ThreadjoinerActor final : public Actor<Void>, public ActorCallback< ThreadjoinerActor, 0, Void >, public FastAllocated<ThreadjoinerActor>, public ThreadjoinerActorState<ThreadjoinerActor> {
															#line 432 "/src/flow/WriteOnlySet.actor.g.cpp"
public:
...
friend struct ActorCallback< ThreadjoinerActor, 0, Void >;
	...
	ThreadjoinerActor(std::shared_ptr<std::vector<std::thread>> const& threads,std::shared_ptr<TestSet> const& set) 
															#line 443 "/src/flow/WriteOnlySet.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] Future<Void> threadjoiner( std::shared_ptr<std::vector<std::thread>> const& threads, std::shared_ptr<TestSet> const& set ) {
	...
	return Future<Void>(new ThreadjoinerActor(threads, set));
															#line 468 "/src/flow/WriteOnlySet.actor.g.cpp"
}

#line 205 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
...
// This unit test creates 5 writer threads and one copier thread.
															#line 523 "/src/flow/WriteOnlySet.actor.g.cpp"
// This generated class is to be used only via flowTestCase256()
															#line 256 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
template <class FlowTestCase256Actor>
															#line 256 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
class FlowTestCase256ActorState {
															#line 529 "/src/flow/WriteOnlySet.actor.g.cpp"
public:
															#line 256 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
	FlowTestCase256ActorState(UnitTestParameters const& params) 
															...
															#line 256 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
		 : params(params)
															#line 536 "/src/flow/WriteOnlySet.actor.g.cpp"
	{
	...
	{
		try {
															#line 257 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			if (g_network->isSimulated())
															#line 549 "/src/flow/WriteOnlySet.actor.g.cpp"
			{
															#line 259 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
				if (!static_cast<FlowTestCase256Actor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~FlowTestCase256ActorState(); static_cast<FlowTestCase256Actor*>(this)->destroy(); return 0; }
															#line 553 "/src/flow/WriteOnlySet.actor.g.cpp"
				...
				return 0;
															...
															#line 261 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			auto set = std::make_shared<TestSet>();
															#line 262 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			auto threads = std::make_shared<std::vector<std::thread>>();
															#line 263 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			std::chrono::seconds runFor(10);
															#line 264 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			for(int i = 0;i < 5;++i) {
															#line 265 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
				threads->emplace_back([set, runFor]() { writer(set, runFor); });
															#line 569 "/src/flow/WriteOnlySet.actor.g.cpp"
			}
															#line 267 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			threads->emplace_back([set, runFor]() { testCopier(set, runFor); });
															#line 268 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
			...
			if (static_cast<FlowTestCase256Actor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 577 "/src/flow/WriteOnlySet.actor.g.cpp"
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< FlowTestCase256Actor, 0, Void >*>(static_cast<FlowTestCase256Actor*>(this)));
															#line 582 "/src/flow/WriteOnlySet.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	{
															#line 269 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
		TraceEvent("WriteOnlySetTestResult") .detail("Inserts", numInserts.load()) .detail("Erases", numErase.load()) .detail("Copies", numCopied.load()) .detail("LockedErase", numLockedErase.load());
															#line 274 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
		if (!static_cast<FlowTestCase256Actor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~FlowTestCase256ActorState(); static_cast<FlowTestCase256Actor*>(this)->destroy(); return 0; }
															#line 607 "/src/flow/WriteOnlySet.actor.g.cpp"
		new (&static_cast<FlowTestCase256Actor*>(this)->SAV< Void >::value()) Void(Void());
		this->~FlowTestCase256ActorState();
		static_cast<FlowTestCase256Actor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	int a_body1cont1(Void && _,int loopDepth) 
	{
		...
		TraceEvent("WriteOnlySetTestResult") .detail("Inserts", numInserts.load()) .detail("Erases", numErase.load()) .detail("Copies", numCopied.load()) .detail("LockedErase", numLockedErase.load());
															#line 274 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
		if (!static_cast<FlowTestCase256Actor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~FlowTestCase256ActorState(); static_cast<FlowTestCase256Actor*>(this)->destroy(); return 0; }
															#line 621 "/src/flow/WriteOnlySet.actor.g.cpp"
		new (&static_cast<FlowTestCase256Actor*>(this)->SAV< Void >::value()) Void(Void());
		this->~FlowTestCase256ActorState();
		static_cast<FlowTestCase256Actor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	UnitTestParameters params;
															#line 688 "/src/flow/WriteOnlySet.actor.g.cpp"
};
// This generated class is to be used only via flowTestCase256()
															#line 256 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
class FlowTestCase256Actor final : public Actor<Void>, public ActorCallback< FlowTestCase256Actor, 0, Void >, public FastAllocated<FlowTestCase256Actor>, public FlowTestCase256ActorState<FlowTestCase256Actor> {
															#line 693 "/src/flow/WriteOnlySet.actor.g.cpp"
public:
...
friend struct ActorCallback< FlowTestCase256Actor, 0, Void >;
	...
	FlowTestCase256Actor(UnitTestParameters const& params) 
															#line 704 "/src/flow/WriteOnlySet.actor.g.cpp"
		 : Actor<Void>(),
...
static Future<Void> flowTestCase256( UnitTestParameters const& params ) {
	...
	return Future<Void>(new FlowTestCase256Actor(params));
															#line 729 "/src/flow/WriteOnlySet.actor.g.cpp"
}
ACTOR_TEST_CASE(flowTestCase256, "/flow/WriteOnlySet")

#line 276 "/tmp/fdb_c/foundationdb_ep/flow/WriteOnlySet.actor.cpp"
} // namespace
#endif
