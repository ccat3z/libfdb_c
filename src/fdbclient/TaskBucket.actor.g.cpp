...
#line 1 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
/*
...
struct UnblockFutureTaskFunc : TaskFuncBase {
	...
	Future<Void> finish(Reference<ReadYourWritesTransaction> tr,
		...
		return _finish(tr, tb, fb, task);
																...
																#line 53 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via _finish()
															#line 51 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class _finishActor>
															#line 51 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class _finishActorState {
															#line 59 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 51 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	_finishActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<FutureBucket> const& futureBucket,Reference<Task> const& task) 
		 ...
		 : tr(tr),
		   ...
		   futureBucket(futureBucket),
															#line 51 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   task(task),
															#line 55 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   future(futureBucket->unpack(task->params[Task::reservedTaskParamKeyFuture]))
															#line 74 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 57 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			futureBucket->setOptions(tr);
															#line 59 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			tr->clear(future->blocks.pack(task->params[Task::reservedTaskParamKeyBlockID]));
															#line 61 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<_finishActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 95 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< _finishActor, 0, bool >*>(static_cast<_finishActor*>(this)));
															#line 100 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
	...
	{
															#line 62 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (is_set)
															#line 123 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 63 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<Void> __when_expr_1 = future->performAllActions(tr, taskBucket);
															#line 63 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<_finishActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 129 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< _finishActor, 1, Void >*>(static_cast<_finishActor*>(this)));
															#line 134 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		else
		{
	...
	int a_body1cont1(bool && is_set,int loopDepth) 
	{
															#line 62 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (is_set)
															#line 148 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 63 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<Void> __when_expr_1 = future->performAllActions(tr, taskBucket);
															#line 63 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<_finishActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 154 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
			static_cast<_finishActor*>(this)->actor_wait_state = 2;
															#line 63 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< _finishActor, 1, Void >*>(static_cast<_finishActor*>(this)));
															#line 159 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		else
		{
	...
	{
															#line 66 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<_finishActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~_finishActorState(); static_cast<_finishActor*>(this)->destroy(); return 0; }
															#line 236 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	Reference<TaskFuture> future;
															#line 329 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via _finish()
															#line 51 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class _finishActor final : public Actor<Void>, public ActorCallback< _finishActor, 0, bool >, public ActorCallback< _finishActor, 1, Void >, public FastAllocated<_finishActor>, public _finishActorState<_finishActor> {
															#line 334 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< _finishActor, 1, Void >;
	...
	_finishActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<FutureBucket> const& futureBucket,Reference<Task> const& task) 
															#line 346 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> _finish( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket, Reference<FutureBucket> const& futureBucket, Reference<Task> const& task ) {
	...
	return Future<Void>(new _finishActor(tr, taskBucket, futureBucket, task));
															#line 374 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 68 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
};
...
public:
																#line 476 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via getTaskKey()
															#line 166 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class GetTaskKeyActor>
															#line 166 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class GetTaskKeyActorState {
															#line 482 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 166 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	GetTaskKeyActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,int const& priority = 0) 
		 ...
		 : tr(tr),
		   ...
		   taskBucket(taskBucket),
															#line 166 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   priority(priority)
															#line 493 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 169 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			Standalone<StringRef> uid = StringRef(deterministicRandom()->randomUniqueID().toString());
															#line 172 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			space = taskBucket->getAvailableSpace(priority);
															#line 510 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 176 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				...
				if (static_cast<GetTaskKeyActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 516 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
				...
				__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< GetTaskKeyActor, 0, Key >*>(static_cast<GetTaskKeyActor*>(this)));
															#line 521 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				loopDepth = 0;
			}
		}
		catch (Error& error) {
	...
	{
		{
															#line 183 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<Key> __when_expr_1 = tr->getKey(lastLessOrEqual(space.pack(maxUIDKey)), Snapshot::True);
															#line 183 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<GetTaskKeyActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 548 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
			...
			__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< GetTaskKeyActor, 1, Key >*>(static_cast<GetTaskKeyActor*>(this)));
															#line 553 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
	...
	{
															#line 177 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (space.contains(k))
															#line 563 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 178 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<GetTaskKeyActor*>(this)->SAV<Optional<Key>>::futures) { (void)(Optional<Key>(k)); this->~GetTaskKeyActorState(); static_cast<GetTaskKeyActor*>(this)->destroy(); return 0; }
															#line 567 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont2(Key && k,int loopDepth) 
	{
															#line 177 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (space.contains(k))
															#line 581 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 178 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<GetTaskKeyActor*>(this)->SAV<Optional<Key>>::futures) { (void)(Optional<Key>(k)); this->~GetTaskKeyActorState(); static_cast<GetTaskKeyActor*>(this)->destroy(); return 0; }
															#line 585 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<GetTaskKeyActor*>(this)->SAV< Optional<Key> >::value()) Optional<Key>(Optional<Key>(k));
			this->~GetTaskKeyActorState();
			static_cast<GetTaskKeyActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
	...
	{
															#line 188 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<GetTaskKeyActor*>(this)->SAV<Optional<Key>>::futures) { (void)(Optional<Key>()); this->~GetTaskKeyActorState(); static_cast<GetTaskKeyActor*>(this)->destroy(); return 0; }
															#line 662 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	{
															#line 184 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (space.contains(k))
															#line 674 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 185 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<GetTaskKeyActor*>(this)->SAV<Optional<Key>>::futures) { (void)(Optional<Key>(k)); this->~GetTaskKeyActorState(); static_cast<GetTaskKeyActor*>(this)->destroy(); return 0; }
															#line 678 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<GetTaskKeyActor*>(this)->SAV< Optional<Key> >::value()) Optional<Key>(Optional<Key>(k));
			this->~GetTaskKeyActorState();
			static_cast<GetTaskKeyActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
	...
	int a_body1cont6(Key && k,int loopDepth) 
	{
															#line 184 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (space.contains(k))
															#line 692 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 185 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<GetTaskKeyActor*>(this)->SAV<Optional<Key>>::futures) { (void)(Optional<Key>(k)); this->~GetTaskKeyActorState(); static_cast<GetTaskKeyActor*>(this)->destroy(); return 0; }
															#line 696 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<GetTaskKeyActor*>(this)->SAV< Optional<Key> >::value()) Optional<Key>(Optional<Key>(k));
			this->~GetTaskKeyActorState();
			static_cast<GetTaskKeyActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
	...
	int priority;
															#line 172 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	Subspace space;
															#line 777 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via getTaskKey()
															#line 166 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class GetTaskKeyActor final : public Actor<Optional<Key>>, public ActorCallback< GetTaskKeyActor, 0, Key >, public ActorCallback< GetTaskKeyActor, 1, Key >, public FastAllocated<GetTaskKeyActor>, public GetTaskKeyActorState<GetTaskKeyActor> {
															#line 782 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< GetTaskKeyActor, 1, Key >;
	...
	GetTaskKeyActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,int const& priority = 0) 
															#line 794 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<Optional<Key>>(),
...
[[nodiscard]] static Future<Optional<Key>> getTaskKey( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket, int const& priority = 0 ) {
	...
	return Future<Optional<Key>>(new GetTaskKeyActor(tr, taskBucket, priority));
															#line 822 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 190 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 827 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via getOne()
															#line 191 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class GetOneActor>
															#line 191 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class GetOneActorState {
															#line 833 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 191 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	GetOneActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket) 
		 ...
		 : tr(tr),
															#line 191 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   taskBucket(taskBucket)
															#line 842 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 193 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (taskBucket->priority_batch)
															#line 857 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 194 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				tr->setOption(FDBTransactionOptions::PRIORITY_BATCH);
															#line 861 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
															#line 196 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskBucket->setOptions(tr);
															#line 200 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (deterministicRandom()->random01() < CLIENT_KNOBS->TASKBUCKET_CHECK_TIMEOUT_CHANCE)
															#line 867 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 201 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				...
				if (static_cast<GetOneActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 873 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
				...
				__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< GetOneActor, 0, bool >*>(static_cast<GetOneActor*>(this)));
															#line 878 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				loopDepth = 0;
			}
			else
			{
	...
	int a_body1cont1(int loopDepth) 
	{
															#line 205 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		taskKeyFutures = std::vector<Future<Optional<Key>>>(CLIENT_KNOBS->TASKBUCKET_MAX_PRIORITY + 1);
															#line 208 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		pri = int();
															#line 209 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		for(pri = CLIENT_KNOBS->TASKBUCKET_MAX_PRIORITY;pri >= 0;--pri) {
															#line 210 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskKeyFutures[pri] = getTaskKey(tr, taskBucket, pri);
															#line 912 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
															#line 213 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		taskKey = Optional<Key>();
															#line 214 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		availableSpace = Subspace();
															#line 218 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		pri = CLIENT_KNOBS->TASKBUCKET_MAX_PRIORITY;
															#line 920 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	{
															#line 202 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		TEST(anyTimeouts);
															#line 929 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = a_body1cont1(loopDepth);
	...
	int a_body1cont3(bool && anyTimeouts,int loopDepth) 
	{
															#line 202 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		TEST(anyTimeouts);
															#line 938 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = a_body1cont1(loopDepth);
	...
	int a_body1cont5(int loopDepth) 
	{
															#line 232 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!taskKey.present())
															#line 1010 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 233 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<bool> __when_expr_2 = requeueTimedOutTasks(tr, taskBucket);
															#line 233 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<GetOneActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 1016 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< GetOneActor, 2, bool >*>(static_cast<GetOneActor*>(this)));
															#line 1021 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		else
		{
	...
	int a_body1cont1loopBody1(int loopDepth) 
	{
															#line 218 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!(pri >= 0))
															#line 1042 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
			return a_body1cont1break1(loopDepth==0?0:loopDepth-1); // break
		}
															#line 220 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (taskKey.present())
															#line 1048 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 221 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskKeyFutures[pri].cancel();
															#line 1052 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = a_body1cont1loopBody1cont1(loopDepth);
		}
		else
		{
															#line 223 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<GetOneActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), std::max(0, loopDepth - 1));
															#line 1061 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< GetOneActor, 1, Optional<Key> >*>(static_cast<GetOneActor*>(this)));
															#line 1066 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
	...
	int a_body1cont1loopBody1cont1(int loopDepth) 
	{
															#line 218 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		--pri;
															#line 1089 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	{
															#line 224 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (key.present())
															#line 1098 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 225 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskKey = key;
															#line 226 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			availableSpace = taskBucket->getAvailableSpace(pri);
															#line 1104 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
		loopDepth = a_body1cont1loopBody1cont1(loopDepth);
	...
	int a_body1cont1loopBody1cont4(Optional<Key> && key,int loopDepth) 
	{
															#line 224 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (key.present())
															#line 1114 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 225 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskKey = key;
															#line 226 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			availableSpace = taskBucket->getAvailableSpace(pri);
															#line 1120 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
		loopDepth = a_body1cont1loopBody1cont1(loopDepth);
	...
	{
															#line 244 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		t = availableSpace.unpack(taskKey.get());
															#line 245 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		taskUID = t.getString(0);
															#line 246 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		taskAvailableSpace = availableSpace.get(taskUID);
															#line 248 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		task = Reference<Task>(new Task());
															#line 249 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		task->key = taskUID;
															#line 251 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		StrictFuture<RangeResult> __when_expr_4 = tr->getRange(taskAvailableSpace.range(), CLIENT_KNOBS->TOO_MANY);
															#line 251 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<GetOneActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 1205 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		...
		__when_expr_4.addCallbackAndClear(static_cast<ActorCallback< GetOneActor, 4, RangeResult >*>(static_cast<GetOneActor*>(this)));
															#line 1210 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	{
															#line 235 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (anyTimeouts)
															#line 1219 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 236 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TEST(true);
															#line 237 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<Reference<Task>> __when_expr_3 = getOne(tr, taskBucket);
															#line 237 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<GetOneActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 1227 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			__when_expr_3.addCallbackAndClear(static_cast<ActorCallback< GetOneActor, 3, Reference<Task> >*>(static_cast<GetOneActor*>(this)));
															#line 1232 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		else
		{
	...
	int a_body1cont8(bool && anyTimeouts,int loopDepth) 
	{
															#line 235 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (anyTimeouts)
															#line 1246 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 236 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TEST(true);
															#line 237 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<Reference<Task>> __when_expr_3 = getOne(tr, taskBucket);
															#line 237 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<GetOneActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 1254 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_3.isReady()) { if (__when_expr_3.isError()) return a_body1Catch1(__when_expr_3.getError(), loopDepth); else return a_body1cont8when1(__when_expr_3.get(), loopDepth); };
			static_cast<GetOneActor*>(this)->actor_wait_state = 4;
															#line 237 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			__when_expr_3.addCallbackAndClear(static_cast<ActorCallback< GetOneActor, 3, Reference<Task> >*>(static_cast<GetOneActor*>(this)));
															#line 1259 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		else
		{
	...
	{
															#line 240 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<GetOneActor*>(this)->SAV<Reference<Task>>::futures) { (void)(Reference<Task>()); this->~GetOneActorState(); static_cast<GetOneActor*>(this)->destroy(); return 0; }
															#line 1336 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	{
															#line 238 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<GetOneActor*>(this)->SAV<Reference<Task>>::futures) { (void)(task); this->~GetOneActorState(); static_cast<GetOneActor*>(this)->destroy(); return 0; }
															#line 1348 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont10(Reference<Task> && task,int loopDepth) 
	{
															#line 238 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<GetOneActor*>(this)->SAV<Reference<Task>>::futures) { (void)(task); this->~GetOneActorState(); static_cast<GetOneActor*>(this)->destroy(); return 0; }
															#line 1360 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<GetOneActor*>(this)->SAV< Reference<Task> >::value()) Reference<Task>(task);
		this->~GetOneActorState();
		static_cast<GetOneActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	{
															#line 252 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		StrictFuture<Version> __when_expr_5 = tr->getReadVersion();
															#line 252 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<GetOneActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 1437 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		...
		__when_expr_5.addCallbackAndClear(static_cast<ActorCallback< GetOneActor, 5, Version >*>(static_cast<GetOneActor*>(this)));
															#line 1442 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1cont7when1(RangeResult const& __values,int loopDepth) 
	{
															#line 251 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		values = __values;
															#line 1451 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	{
															#line 253 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		task->timeoutVersion = version + (uint64_t)(taskBucket->timeout * (CLIENT_KNOBS->TASKBUCKET_TIMEOUT_JITTER_OFFSET + CLIENT_KNOBS->TASKBUCKET_TIMEOUT_JITTER_RANGE * deterministicRandom()->random01()));
															#line 258 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		Subspace timeoutSpace = taskBucket->timeouts.get(task->timeoutVersion).get(taskUID);
															#line 260 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		for( auto& s : values ) {
															#line 261 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			Key param = taskAvailableSpace.unpack(s.key).getString(0);
															#line 262 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			task->params[param] = s.value;
															#line 263 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			tr->set(timeoutSpace.pack(param), s.value);
															#line 1528 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
															#line 267 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		tr->clear(taskAvailableSpace.range());
															#line 268 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		tr->set(taskBucket->active.key(), deterministicRandom()->randomUniqueID().toString());
															#line 270 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<GetOneActor*>(this)->SAV<Reference<Task>>::futures) { (void)(task); this->~GetOneActorState(); static_cast<GetOneActor*>(this)->destroy(); return 0; }
															#line 1536 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont12cont1(Version && version,int loopDepth) 
	{
		...
		for( auto& s : values ) {
			...
			task->params[param] = s.value;
															#line 263 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			tr->set(timeoutSpace.pack(param), s.value);
															#line 1558 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
															#line 267 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		tr->clear(taskAvailableSpace.range());
															#line 268 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		tr->set(taskBucket->active.key(), deterministicRandom()->randomUniqueID().toString());
															#line 270 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<GetOneActor*>(this)->SAV<Reference<Task>>::futures) { (void)(task); this->~GetOneActorState(); static_cast<GetOneActor*>(this)->destroy(); return 0; }
															#line 1566 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<GetOneActor*>(this)->SAV< Reference<Task> >::value()) Reference<Task>(std::move(task)); // state_var_RVO
		this->~GetOneActorState();
		static_cast<GetOneActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Reference<Task> task;
															#line 251 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	RangeResult values;
															#line 1659 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via getOne()
															#line 191 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class GetOneActor final : public Actor<Reference<Task>>, public ActorCallback< GetOneActor, 0, bool >, public ActorCallback< GetOneActor, 1, Optional<Key> >, public ActorCallback< GetOneActor, 2, bool >, public ActorCallback< GetOneActor, 3, Reference<Task> >, public ActorCallback< GetOneActor, 4, RangeResult >, public ActorCallback< GetOneActor, 5, Version >, public FastAllocated<GetOneActor>, public GetOneActorState<GetOneActor> {
															#line 1664 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< GetOneActor, 5, Version >;
	...
	GetOneActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket) 
															#line 1680 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
...
[[nodiscard]] static Future<Reference<Task>> getOne( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket ) {
	...
	return Future<Reference<Task>>(new GetOneActor(tr, taskBucket));
															#line 1712 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 272 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

	// Verify that the user configured task verification key still has the user specified value
																#line 1718 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via taskVerify()
															#line 274 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class TaskVerifyActor>
															#line 274 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class TaskVerifyActorState {
															#line 1724 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 274 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	TaskVerifyActorState(Reference<TaskBucket> const& tb,Reference<ReadYourWritesTransaction> const& tr,Reference<Task> const& task) 
		 ...
		 : tb(tb),
		   ...
		   tr(tr),
															#line 274 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   task(task)
															#line 1735 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 278 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (task->params.find(Task::reservedTaskParamValidKey) == task->params.end())
															#line 1750 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 279 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				TraceEvent("TaskBucketTaskVerifyInvalidTask") .detail("Task", task->params[Task::reservedTaskParamKeyType]) .detail("ReservedTaskParamValidKey", "missing");
															#line 282 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				if (!static_cast<TaskVerifyActor*>(this)->SAV<bool>::futures) { (void)(false); this->~TaskVerifyActorState(); static_cast<TaskVerifyActor*>(this)->destroy(); return 0; }
															#line 1756 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				...
				return 0;
															...
															#line 285 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (task->params.find(Task::reservedTaskParamValidValue) == task->params.end())
															#line 1764 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 286 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				TraceEvent("TaskBucketTaskVerifyInvalidTask") .detail("Task", task->params[Task::reservedTaskParamKeyType]) .detail("ReservedTaskParamValidKey", task->params[Task::reservedTaskParamValidKey]) .detail("ReservedTaskParamValidValue", "missing");
															#line 290 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				if (!static_cast<TaskVerifyActor*>(this)->SAV<bool>::futures) { (void)(false); this->~TaskVerifyActorState(); static_cast<TaskVerifyActor*>(this)->destroy(); return 0; }
															#line 1770 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				new (&static_cast<TaskVerifyActor*>(this)->SAV< bool >::value()) bool(false);
				this->~TaskVerifyActorState();
				static_cast<TaskVerifyActor*>(this)->finishSendAndDelPromiseRef();
				return 0;
			}
															#line 293 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			tb->setOptions(tr);
															#line 295 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<TaskVerifyActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 1782 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< TaskVerifyActor, 0, Optional<Value> >*>(static_cast<TaskVerifyActor*>(this)));
															#line 1787 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	{
															#line 297 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!keyValue.present())
															#line 1810 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 298 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TraceEvent("TaskBucketTaskVerifyInvalidTask") .detail("Task", task->params[Task::reservedTaskParamKeyType]) .detail("ReservedTaskParamValidKey", task->params[Task::reservedTaskParamValidKey]) .detail("ReservedTaskParamValidValue", task->params[Task::reservedTaskParamValidValue]) .detail("KeyValue", "missing");
															#line 303 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<TaskVerifyActor*>(this)->SAV<bool>::futures) { (void)(false); this->~TaskVerifyActorState(); static_cast<TaskVerifyActor*>(this)->destroy(); return 0; }
															#line 1816 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<TaskVerifyActor*>(this)->SAV< bool >::value()) bool(false);
			this->~TaskVerifyActorState();
			static_cast<TaskVerifyActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
		}
															#line 306 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (keyValue.get().compare(StringRef(task->params[Task::reservedTaskParamValidValue])))
															#line 1824 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 307 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TraceEvent("TaskBucketTaskVerifyAbortedTask") .detail("Task", task->params[Task::reservedTaskParamKeyType]) .detail("ReservedTaskParamValidKey", task->params[Task::reservedTaskParamValidKey]) .detail("ReservedTaskParamValidValue", task->params[Task::reservedTaskParamValidValue]) .detail("KeyValue", keyValue.get());
															#line 312 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<TaskVerifyActor*>(this)->SAV<bool>::futures) { (void)(false); this->~TaskVerifyActorState(); static_cast<TaskVerifyActor*>(this)->destroy(); return 0; }
															#line 1830 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<TaskVerifyActor*>(this)->SAV< bool >::value()) bool(false);
			this->~TaskVerifyActorState();
			static_cast<TaskVerifyActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
		}
															#line 315 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<TaskVerifyActor*>(this)->SAV<bool>::futures) { (void)(true); this->~TaskVerifyActorState(); static_cast<TaskVerifyActor*>(this)->destroy(); return 0; }
															#line 1838 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont1(Optional<Value> && keyValue,int loopDepth) 
	{
															#line 297 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!keyValue.present())
															#line 1850 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 298 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TraceEvent("TaskBucketTaskVerifyInvalidTask") .detail("Task", task->params[Task::reservedTaskParamKeyType]) .detail("ReservedTaskParamValidKey", task->params[Task::reservedTaskParamValidKey]) .detail("ReservedTaskParamValidValue", task->params[Task::reservedTaskParamValidValue]) .detail("KeyValue", "missing");
															#line 303 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<TaskVerifyActor*>(this)->SAV<bool>::futures) { (void)(false); this->~TaskVerifyActorState(); static_cast<TaskVerifyActor*>(this)->destroy(); return 0; }
															#line 1856 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<TaskVerifyActor*>(this)->SAV< bool >::value()) bool(false);
			this->~TaskVerifyActorState();
			static_cast<TaskVerifyActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
															...
															#line 306 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (keyValue.get().compare(StringRef(task->params[Task::reservedTaskParamValidValue])))
															#line 1864 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 307 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TraceEvent("TaskBucketTaskVerifyAbortedTask") .detail("Task", task->params[Task::reservedTaskParamKeyType]) .detail("ReservedTaskParamValidKey", task->params[Task::reservedTaskParamValidKey]) .detail("ReservedTaskParamValidValue", task->params[Task::reservedTaskParamValidValue]) .detail("KeyValue", keyValue.get());
															#line 312 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<TaskVerifyActor*>(this)->SAV<bool>::futures) { (void)(false); this->~TaskVerifyActorState(); static_cast<TaskVerifyActor*>(this)->destroy(); return 0; }
															#line 1870 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<TaskVerifyActor*>(this)->SAV< bool >::value()) bool(false);
			this->~TaskVerifyActorState();
			static_cast<TaskVerifyActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
															...
															#line 315 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<TaskVerifyActor*>(this)->SAV<bool>::futures) { (void)(true); this->~TaskVerifyActorState(); static_cast<TaskVerifyActor*>(this)->destroy(); return 0; }
															#line 1878 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<TaskVerifyActor*>(this)->SAV< bool >::value()) bool(true);
		this->~TaskVerifyActorState();
		static_cast<TaskVerifyActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Reference<ReadYourWritesTransaction> tr;
															#line 274 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	Reference<Task> task;
															#line 1955 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via taskVerify()
															#line 274 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class TaskVerifyActor final : public Actor<bool>, public ActorCallback< TaskVerifyActor, 0, Optional<Value> >, public FastAllocated<TaskVerifyActor>, public TaskVerifyActorState<TaskVerifyActor> {
															#line 1960 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< TaskVerifyActor, 0, Optional<Value> >;
	...
	TaskVerifyActor(Reference<TaskBucket> const& tb,Reference<ReadYourWritesTransaction> const& tr,Reference<Task> const& task) 
															#line 1971 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<bool>(),
...
[[nodiscard]] static Future<bool> taskVerify( Reference<TaskBucket> const& tb, Reference<ReadYourWritesTransaction> const& tr, Reference<Task> const& task ) {
	...
	return Future<bool>(new TaskVerifyActor(tb, tr, task));
															#line 1998 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 317 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 2003 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via taskVerify()
															#line 318 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class TaskVerifyActor1>
															#line 318 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class TaskVerifyActor1State {
															#line 2009 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 318 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	TaskVerifyActor1State(Reference<TaskBucket> const& tb,Database const& cx,Reference<Task> const& task) 
		 ...
		 : tb(tb),
		   ...
		   cx(cx),
															#line 318 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   task(task)
															#line 2020 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
		fdb_probe_actor_create("taskVerify", reinterpret_cast<unsigned long>(this));
	...
	{
		try {
															#line 319 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			;
															#line 2035 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	{
															#line 320 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		tr = Reference<ReadYourWritesTransaction>(new ReadYourWritesTransaction(cx));
															#line 2065 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		try {
															#line 323 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<TaskVerifyActor1*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 2071 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< TaskVerifyActor1, 0, bool >*>(static_cast<TaskVerifyActor1*>(this)));
															#line 2076 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
	...
	{
		try {
															#line 326 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<TaskVerifyActor1*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), std::max(0, loopDepth - 1));
															#line 2100 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< TaskVerifyActor1, 1, Void >*>(static_cast<TaskVerifyActor1*>(this)));
															#line 2105 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
	...
	{
															#line 324 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<TaskVerifyActor1*>(this)->SAV<bool>::futures) { (void)(verified); this->~TaskVerifyActor1State(); static_cast<TaskVerifyActor1*>(this)->destroy(); return 0; }
															#line 2120 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1loopBody1cont2(bool && verified,int loopDepth) 
	{
															#line 324 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<TaskVerifyActor1*>(this)->SAV<bool>::futures) { (void)(verified); this->~TaskVerifyActor1State(); static_cast<TaskVerifyActor1*>(this)->destroy(); return 0; }
															#line 2132 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<TaskVerifyActor1*>(this)->SAV< bool >::value()) bool(verified);
		this->~TaskVerifyActor1State();
		static_cast<TaskVerifyActor1*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Reference<Task> task;
															#line 320 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	Reference<ReadYourWritesTransaction> tr;
															#line 2286 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via taskVerify()
															#line 318 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class TaskVerifyActor1 final : public Actor<bool>, public ActorCallback< TaskVerifyActor1, 0, bool >, public ActorCallback< TaskVerifyActor1, 1, Void >, public FastAllocated<TaskVerifyActor1>, public TaskVerifyActor1State<TaskVerifyActor1> {
															#line 2291 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< TaskVerifyActor1, 1, Void >;
	...
	TaskVerifyActor1(Reference<TaskBucket> const& tb,Database const& cx,Reference<Task> const& task) 
															#line 2303 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<bool>(),
...
[[nodiscard]] static Future<bool> taskVerify( Reference<TaskBucket> const& tb, Database const& cx, Reference<Task> const& task ) {
	...
	return Future<bool>(new TaskVerifyActor1(tb, cx, task));
															#line 2331 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 330 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 2336 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via finishTaskRun()
															#line 331 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class FinishTaskRunActor>
															#line 331 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class FinishTaskRunActorState {
															#line 2342 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 331 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	FinishTaskRunActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<FutureBucket> const& futureBucket,Reference<Task> const& task,Reference<TaskFuncBase> const& taskFunc,VerifyTask const& verifyTask) 
		 ...
		 : tr(tr),
		   ...
		   verifyTask(verifyTask)
															#line 2359 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 337 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<FinishTaskRunActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 2376 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< FinishTaskRunActor, 0, bool >*>(static_cast<FinishTaskRunActor*>(this)));
															#line 2381 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	{
															#line 338 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (isFinished)
															#line 2404 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 339 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<FinishTaskRunActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~FinishTaskRunActorState(); static_cast<FinishTaskRunActor*>(this)->destroy(); return 0; }
															#line 2408 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			return 0;
															...
															#line 342 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		validTask = true;
															#line 343 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (verifyTask)
															#line 2418 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 344 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<bool> __when_expr_1 = taskVerify(taskBucket, tr, task);
															#line 344 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<FinishTaskRunActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 2424 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
			...
			__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< FinishTaskRunActor, 1, bool >*>(static_cast<FinishTaskRunActor*>(this)));
															#line 2429 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		else
		{
	...
	int a_body1cont1(bool && isFinished,int loopDepth) 
	{
															#line 338 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (isFinished)
															#line 2443 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 339 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<FinishTaskRunActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~FinishTaskRunActorState(); static_cast<FinishTaskRunActor*>(this)->destroy(); return 0; }
															#line 2447 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<FinishTaskRunActor*>(this)->SAV< Void >::value()) Void(Void());
			this->~FinishTaskRunActorState();
			static_cast<FinishTaskRunActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
		...
		validTask = true;
															#line 343 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (verifyTask)
															#line 2457 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 344 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<bool> __when_expr_1 = taskVerify(taskBucket, tr, task);
															#line 344 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<FinishTaskRunActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 2463 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
			static_cast<FinishTaskRunActor*>(this)->actor_wait_state = 2;
															#line 344 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< FinishTaskRunActor, 1, bool >*>(static_cast<FinishTaskRunActor*>(this)));
															#line 2468 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		else
		{
	...
	int a_body1cont2(int loopDepth) 
	{
															#line 347 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!validTask)
															#line 2545 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 348 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<Void> __when_expr_2 = taskBucket->finish(tr, task);
															#line 348 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<FinishTaskRunActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 2551 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< FinishTaskRunActor, 2, Void >*>(static_cast<FinishTaskRunActor*>(this)));
															#line 2556 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		else
		{
															#line 350 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<Void> __when_expr_3 = taskFunc->finish(tr, taskBucket, futureBucket, task);
															#line 350 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<FinishTaskRunActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 2565 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			__when_expr_3.addCallbackAndClear(static_cast<ActorCallback< FinishTaskRunActor, 3, Void >*>(static_cast<FinishTaskRunActor*>(this)));
															#line 2570 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
	...
	{
															#line 345 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		validTask = _validTask;
															#line 2580 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = a_body1cont2(loopDepth);
	...
	int a_body1cont4(bool && _validTask,int loopDepth) 
	{
															#line 345 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		validTask = _validTask;
															#line 2589 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = a_body1cont2(loopDepth);
	...
	{
															#line 353 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<FinishTaskRunActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~FinishTaskRunActorState(); static_cast<FinishTaskRunActor*>(this)->destroy(); return 0; }
															#line 2661 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<FinishTaskRunActor*>(this)->SAV< Void >::value()) Void(Void());
		this->~FinishTaskRunActorState();
		static_cast<FinishTaskRunActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	VerifyTask verifyTask;
															#line 342 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	bool validTask;
															#line 2833 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via finishTaskRun()
															#line 331 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class FinishTaskRunActor final : public Actor<Void>, public ActorCallback< FinishTaskRunActor, 0, bool >, public ActorCallback< FinishTaskRunActor, 1, bool >, public ActorCallback< FinishTaskRunActor, 2, Void >, public ActorCallback< FinishTaskRunActor, 3, Void >, public FastAllocated<FinishTaskRunActor>, public FinishTaskRunActorState<FinishTaskRunActor> {
															#line 2838 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< FinishTaskRunActor, 3, Void >;
	...
	FinishTaskRunActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<FutureBucket> const& futureBucket,Reference<Task> const& task,Reference<TaskFuncBase> const& taskFunc,VerifyTask const& verifyTask) 
															#line 2852 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> finishTaskRun( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket, Reference<FutureBucket> const& futureBucket, Reference<Task> const& task, Reference<TaskFuncBase> const& taskFunc, VerifyTask const& verifyTask ) {
	...
	return Future<Void>(new FinishTaskRunActor(tr, taskBucket, futureBucket, task, taskFunc, verifyTask));
															#line 2882 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 355 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 2887 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via doOne()
															#line 356 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class DoOneActor>
															#line 356 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class DoOneActorState {
															#line 2893 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 356 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	DoOneActorState(Database const& cx,Reference<TaskBucket> const& taskBucket,Reference<FutureBucket> const& futureBucket) 
		 ...
		 : cx(cx),
		   ...
		   taskBucket(taskBucket),
															#line 356 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   futureBucket(futureBucket)
															#line 2904 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 359 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<DoOneActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 2921 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< DoOneActor, 0, Reference<Task> >*>(static_cast<DoOneActor*>(this)));
															#line 2926 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont1(int loopDepth) 
	{
															#line 360 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		StrictFuture<bool> __when_expr_1 = taskBucket->doTask(cx, futureBucket, task);
															#line 360 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<DoOneActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 2951 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< DoOneActor, 1, bool >*>(static_cast<DoOneActor*>(this)));
															#line 2956 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1when1(Reference<Task> const& __task,int loopDepth) 
	{
															#line 359 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		task = __task;
															#line 2965 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = a_body1cont1(loopDepth);
	...
	{
															#line 361 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<DoOneActor*>(this)->SAV<bool>::futures) { (void)(result); this->~DoOneActorState(); static_cast<DoOneActor*>(this)->destroy(); return 0; }
															#line 3032 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont2(bool && result,int loopDepth) 
	{
															#line 361 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<DoOneActor*>(this)->SAV<bool>::futures) { (void)(result); this->~DoOneActorState(); static_cast<DoOneActor*>(this)->destroy(); return 0; }
															#line 3044 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<DoOneActor*>(this)->SAV< bool >::value()) bool(result);
		this->~DoOneActorState();
		static_cast<DoOneActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Reference<FutureBucket> futureBucket;
															#line 359 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	Reference<Task> task;
															#line 3123 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via doOne()
															#line 356 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class DoOneActor final : public Actor<bool>, public ActorCallback< DoOneActor, 0, Reference<Task> >, public ActorCallback< DoOneActor, 1, bool >, public FastAllocated<DoOneActor>, public DoOneActorState<DoOneActor> {
															#line 3128 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< DoOneActor, 1, bool >;
	...
	DoOneActor(Database const& cx,Reference<TaskBucket> const& taskBucket,Reference<FutureBucket> const& futureBucket) 
															#line 3140 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<bool>(),
...
[[nodiscard]] static Future<bool> doOne( Database const& cx, Reference<TaskBucket> const& taskBucket, Reference<FutureBucket> const& futureBucket ) {
	...
	return Future<bool>(new DoOneActor(cx, taskBucket, futureBucket));
															#line 3168 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 363 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 3173 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via extendTimeoutRepeatedly()
															#line 364 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class ExtendTimeoutRepeatedlyActor>
															#line 364 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class ExtendTimeoutRepeatedlyActorState {
															#line 3179 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 364 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	ExtendTimeoutRepeatedlyActorState(Database const& cx,Reference<TaskBucket> const& taskBucket,Reference<Task> const& task) 
		 ...
		 : cx(cx),
		   ...
		   taskBucket(taskBucket),
															#line 364 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   task(task),
															#line 367 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   tr(new ReadYourWritesTransaction(cx)),
															#line 368 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   start(now())
															#line 3194 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 369 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<ExtendTimeoutRepeatedlyActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 3211 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< ExtendTimeoutRepeatedlyActor, 0, Version >*>(static_cast<ExtendTimeoutRepeatedlyActor*>(this)));
															#line 3216 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont1(int loopDepth) 
	{
															#line 374 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		;
															#line 3239 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = a_body1cont1loopHead1(loopDepth);
	...
	int a_body1when1(Version const& __versionNow,int loopDepth) 
	{
		...
		versionNow = __versionNow;
															#line 3248 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = a_body1cont1(loopDepth);
	...
	int a_body1cont1loopBody1(int loopDepth) 
	{
															#line 375 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		releaser = FlowLock::Releaser();
															#line 378 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		...
		if (static_cast<ExtendTimeoutRepeatedlyActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), std::max(0, loopDepth - 1));
															#line 3326 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), std::max(0, loopDepth - 1)); else return a_body1cont1loopBody1when1(__when_expr_1.get(), loopDepth); };
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< ExtendTimeoutRepeatedlyActor, 1, Void >*>(static_cast<ExtendTimeoutRepeatedlyActor*>(this)));
															#line 3331 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	{
															#line 381 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (now() - start > 300)
															#line 3340 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 382 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TraceEvent(SevWarnAlways, "TaskBucketLongExtend") .detail("Duration", now() - start) .detail("TaskUID", task->key) .detail("TaskType", task->params[Task::reservedTaskParamKeyType]) .detail("Priority", task->getPriority());
															#line 3344 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
															#line 389 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		StrictFuture<Void> __when_expr_2 = task->extendMutex.take();
															#line 389 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<ExtendTimeoutRepeatedlyActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), std::max(0, loopDepth - 1));
															#line 3350 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		...
		__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< ExtendTimeoutRepeatedlyActor, 2, Void >*>(static_cast<ExtendTimeoutRepeatedlyActor*>(this)));
															#line 3355 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1cont1loopBody1cont1(Void && _,int loopDepth) 
	{
															#line 381 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (now() - start > 300)
															#line 3364 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 382 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TraceEvent(SevWarnAlways, "TaskBucketLongExtend") .detail("Duration", now() - start) .detail("TaskUID", task->key) .detail("TaskType", task->params[Task::reservedTaskParamKeyType]) .detail("Priority", task->getPriority());
															#line 3368 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
															#line 389 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		StrictFuture<Void> __when_expr_2 = task->extendMutex.take();
															#line 389 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<ExtendTimeoutRepeatedlyActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), std::max(0, loopDepth - 1));
															#line 3374 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_2.isReady()) { if (__when_expr_2.isError()) return a_body1Catch1(__when_expr_2.getError(), std::max(0, loopDepth - 1)); else return a_body1cont1loopBody1cont1when1(__when_expr_2.get(), loopDepth); };
		static_cast<ExtendTimeoutRepeatedlyActor*>(this)->actor_wait_state = 3;
															#line 389 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< ExtendTimeoutRepeatedlyActor, 2, Void >*>(static_cast<ExtendTimeoutRepeatedlyActor*>(this)));
															#line 3379 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	{
															#line 390 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		releaser = FlowLock::Releaser(task->extendMutex, 1);
															#line 392 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		;
															#line 3453 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont1loopBody1cont2(Void && _,int loopDepth) 
	{
		...
		releaser = FlowLock::Releaser(task->extendMutex, 1);
															#line 392 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		;
															#line 3464 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = a_body1cont1loopBody1cont2loopHead1(loopDepth);
	...
	{
		try {
															#line 394 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			tr->reset();
															#line 395 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskBucket->setOptions(tr);
															#line 398 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<ExtendTimeoutRepeatedlyActor*>(this)->actor_wait_state < 0) return a_body1cont1loopBody1cont2loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 3556 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			__when_expr_3.addCallbackAndClear(static_cast<ActorCallback< ExtendTimeoutRepeatedlyActor, 3, Version >*>(static_cast<ExtendTimeoutRepeatedlyActor*>(this)));
															#line 3561 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
	...
	{
		try {
															#line 404 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<ExtendTimeoutRepeatedlyActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), std::max(0, loopDepth - 2));
															#line 3598 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			__when_expr_5.addCallbackAndClear(static_cast<ActorCallback< ExtendTimeoutRepeatedlyActor, 5, Void >*>(static_cast<ExtendTimeoutRepeatedlyActor*>(this)));
															#line 3603 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
	...
	{
															#line 399 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		StrictFuture<Void> __when_expr_4 = tr->commit();
															#line 399 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<ExtendTimeoutRepeatedlyActor*>(this)->actor_wait_state < 0) return a_body1cont1loopBody1cont2loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 3620 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		...
		__when_expr_4.addCallbackAndClear(static_cast<ActorCallback< ExtendTimeoutRepeatedlyActor, 4, Void >*>(static_cast<ExtendTimeoutRepeatedlyActor*>(this)));
															#line 3625 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1cont1loopBody1cont2loopBody1when1(Version const& __newTimeout,int loopDepth) 
	{
		...
		newTimeout = __newTimeout;
															#line 3634 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	{
															#line 400 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		task->timeoutVersion = newTimeout;
															#line 401 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		versionNow = tr->getCommittedVersion();
															#line 3703 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont1loopBody1cont2loopBody1cont3(Void && _,int loopDepth) 
	{
		...
		task->timeoutVersion = newTimeout;
															#line 401 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		versionNow = tr->getCommittedVersion();
															#line 3714 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		return a_body1cont1loopBody1cont2break1(loopDepth==0?0:loopDepth-1); // break
	...
	FlowLock::Releaser releaser;
															#line 398 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	Version newTimeout;
															#line 3873 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via extendTimeoutRepeatedly()
															#line 364 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class ExtendTimeoutRepeatedlyActor final : public Actor<Void>, public ActorCallback< ExtendTimeoutRepeatedlyActor, 0, Version >, public ActorCallback< ExtendTimeoutRepeatedlyActor, 1, Void >, public ActorCallback< ExtendTimeoutRepeatedlyActor, 2, Void >, public ActorCallback< ExtendTimeoutRepeatedlyActor, 3, Version >, public ActorCallback< ExtendTimeoutRepeatedlyActor, 4, Void >, public ActorCallback< ExtendTimeoutRepeatedlyActor, 5, Void >, public FastAllocated<ExtendTimeoutRepeatedlyActor>, public ExtendTimeoutRepeatedlyActorState<ExtendTimeoutRepeatedlyActor> {
															#line 3878 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< ExtendTimeoutRepeatedlyActor, 5, Void >;
	...
	ExtendTimeoutRepeatedlyActor(Database const& cx,Reference<TaskBucket> const& taskBucket,Reference<Task> const& task) 
															#line 3894 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> extendTimeoutRepeatedly( Database const& cx, Reference<TaskBucket> const& taskBucket, Reference<Task> const& task ) {
	...
	return Future<Void>(new ExtendTimeoutRepeatedlyActor(cx, taskBucket, task));
															#line 3926 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 409 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 3931 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via doTask()
															#line 410 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class DoTaskActor>
															#line 410 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class DoTaskActorState {
															#line 3937 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 410 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	DoTaskActorState(Database const& cx,Reference<TaskBucket> const& taskBucket,Reference<FutureBucket> const& futureBucket,Reference<Task> const& task) 
		 ...
		 : cx(cx),
		   ...
		   futureBucket(futureBucket),
															#line 410 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   task(task),
															#line 414 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   taskFunc(),
															#line 415 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   verifyTask(false)
															#line 3954 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 417 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!task || !TaskFuncBase::isValidTask(task))
															#line 3969 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 418 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				if (!static_cast<DoTaskActor*>(this)->SAV<bool>::futures) { (void)(false); this->~DoTaskActorState(); static_cast<DoTaskActor*>(this)->destroy(); return 0; }
															#line 3973 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			try {
															#line 421 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				taskFunc = TaskFuncBase::create(task->params[Task::reservedTaskParamKeyType]);
															#line 422 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				if (taskFunc)
															#line 3984 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				{
															#line 423 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
					verifyTask.set(task->params.find(Task::reservedTaskParamValidKey) != task->params.end());
															#line 425 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
					if (verifyTask)
															#line 3990 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
					{
															#line 426 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
						;
															#line 3994 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
						loopDepth = a_body1loopHead1(loopDepth);
					}
					else
					{
	...
	int a_body1cont1(int loopDepth) 
	{
															#line 475 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<DoTaskActor*>(this)->SAV<bool>::futures) { (void)(true); this->~DoTaskActorState(); static_cast<DoTaskActor*>(this)->destroy(); return 0; }
															#line 4033 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	{
		try {
															#line 458 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TraceEvent(SevWarn, "TaskBucketExecuteFailure") .error(e) .detail("TaskUID", task->key) .detail("TaskType", task->params[Task::reservedTaskParamKeyType].printable()) .detail("Priority", task->getPriority());
															#line 4046 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			try {
															#line 464 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				...
				if (static_cast<DoTaskActor*>(this)->actor_wait_state < 0) return a_body1Catch2Catch1(actor_cancelled(), loopDepth);
															#line 4052 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				...
				__when_expr_8.addCallbackAndClear(static_cast<ActorCallback< DoTaskActor, 8, Void >*>(static_cast<DoTaskActor*>(this)));
															#line 4057 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				loopDepth = 0;
			}
			catch (Error& error) {
	...
	{
															#line 448 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		...
		if (static_cast<DoTaskActor*>(this)->actor_wait_state < 0) return a_body1Catch2(actor_cancelled(), loopDepth);
															#line 4086 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		...
		__when_expr_5.addCallbackAndClear(static_cast<ActorCallback< DoTaskActor, 5, Void >*>(static_cast<DoTaskActor*>(this)));
															#line 4091 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1loopBody1(int loopDepth) 
	{
															#line 427 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		tr = Reference<ReadYourWritesTransaction>(new ReadYourWritesTransaction(cx));
															#line 428 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		taskBucket->setOptions(tr);
															#line 4115 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		try {
															#line 431 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<DoTaskActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 4121 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1loopBody1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1loopBody1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< DoTaskActor, 0, bool >*>(static_cast<DoTaskActor*>(this)));
															#line 4126 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1loopBody1Catch1(error, loopDepth);
	...
	int a_body1loopBody1Catch1(const Error& e,int loopDepth=0) 
	{
		try {
			...
			__when_expr_4.addCallbackAndClear(static_cast<ActorCallback< DoTaskActor, 4, Void >*>(static_cast<DoTaskActor*>(this)));
															#line 4168 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
	...
	{
															#line 433 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!validTask)
															#line 4183 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 434 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<bool> __when_expr_1 = taskBucket->isFinished(tr, task);
															#line 434 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<DoTaskActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 4189 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< DoTaskActor, 1, bool >*>(static_cast<DoTaskActor*>(this)));
															#line 4194 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		else
		{
	...
	int a_body1loopBody1cont2(bool && validTask,int loopDepth) 
	{
															#line 433 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!validTask)
															#line 4208 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 434 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<bool> __when_expr_1 = taskBucket->isFinished(tr, task);
															#line 434 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<DoTaskActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 4214 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1loopBody1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1loopBody1cont2when1(__when_expr_1.get(), loopDepth); };
			static_cast<DoTaskActor*>(this)->actor_wait_state = 2;
															#line 434 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< DoTaskActor, 1, bool >*>(static_cast<DoTaskActor*>(this)));
															#line 4219 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		else
		{
	...
	{
															#line 435 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!isFinished)
															#line 4302 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 436 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<Void> __when_expr_2 = taskBucket->finish(tr, task);
															#line 436 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<DoTaskActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 4308 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< DoTaskActor, 2, Void >*>(static_cast<DoTaskActor*>(this)));
															#line 4313 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		else
		{
	...
	int a_body1loopBody1cont4(bool && isFinished,int loopDepth) 
	{
															#line 435 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!isFinished)
															#line 4327 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 436 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<Void> __when_expr_2 = taskBucket->finish(tr, task);
															#line 436 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<DoTaskActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 4333 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_2.isReady()) { if (__when_expr_2.isError()) return a_body1loopBody1Catch1(__when_expr_2.getError(), loopDepth); else return a_body1loopBody1cont4when1(__when_expr_2.get(), loopDepth); };
			static_cast<DoTaskActor*>(this)->actor_wait_state = 3;
															#line 436 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< DoTaskActor, 2, Void >*>(static_cast<DoTaskActor*>(this)));
															#line 4338 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		else
		{
	...
	{
															#line 438 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		StrictFuture<Void> __when_expr_3 = tr->commit();
															#line 438 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<DoTaskActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 4417 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		...
		__when_expr_3.addCallbackAndClear(static_cast<ActorCallback< DoTaskActor, 3, Void >*>(static_cast<DoTaskActor*>(this)));
															#line 4422 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	{
															#line 439 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<DoTaskActor*>(this)->SAV<bool>::futures) { (void)(true); this->~DoTaskActorState(); static_cast<DoTaskActor*>(this)->destroy(); return 0; }
															#line 4506 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<DoTaskActor*>(this)->SAV< bool >::value()) bool(true);
		this->~DoTaskActorState();
		static_cast<DoTaskActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	int a_body1loopBody1cont7(Void && _,int loopDepth) 
	{
															#line 439 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<DoTaskActor*>(this)->SAV<bool>::futures) { (void)(true); this->~DoTaskActorState(); static_cast<DoTaskActor*>(this)->destroy(); return 0; }
															#line 4518 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<DoTaskActor*>(this)->SAV< bool >::value()) bool(true);
		this->~DoTaskActorState();
		static_cast<DoTaskActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	{
															#line 451 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (BUGGIFY)
															#line 4668 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 452 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<Void> __when_expr_6 = delay(10.0);
															#line 452 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<DoTaskActor*>(this)->actor_wait_state < 0) return a_body1Catch2(actor_cancelled(), loopDepth);
															#line 4674 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			__when_expr_6.addCallbackAndClear(static_cast<ActorCallback< DoTaskActor, 6, Void >*>(static_cast<DoTaskActor*>(this)));
															#line 4679 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		else
		{
	...
	int a_body1cont6(Void && _,int loopDepth) 
	{
															#line 451 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (BUGGIFY)
															#line 4693 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 452 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<Void> __when_expr_6 = delay(10.0);
															#line 452 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<DoTaskActor*>(this)->actor_wait_state < 0) return a_body1Catch2(actor_cancelled(), loopDepth);
															#line 4699 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_6.isReady()) { if (__when_expr_6.isError()) return a_body1Catch2(__when_expr_6.getError(), loopDepth); else return a_body1cont6when1(__when_expr_6.get(), loopDepth); };
			static_cast<DoTaskActor*>(this)->actor_wait_state = 7;
															#line 452 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			__when_expr_6.addCallbackAndClear(static_cast<ActorCallback< DoTaskActor, 6, Void >*>(static_cast<DoTaskActor*>(this)));
															#line 4704 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		else
		{
	...
	int a_body1cont7(int loopDepth) 
	{
															#line 453 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		StrictFuture<Void> __when_expr_7 = runRYWTransaction(cx, [=](Reference<ReadYourWritesTransaction> tr) { return finishTaskRun(tr, taskBucket, futureBucket, task, taskFunc, verifyTask); });
															#line 453 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<DoTaskActor*>(this)->actor_wait_state < 0) return a_body1Catch2(actor_cancelled(), loopDepth);
															#line 4783 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		...
		__when_expr_7.addCallbackAndClear(static_cast<ActorCallback< DoTaskActor, 7, Void >*>(static_cast<DoTaskActor*>(this)));
															#line 4788 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	{
		try {
															#line 466 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TraceEvent(SevWarn, "TaskBucketExecuteFailureLogErrorFailed") .error(e) .detail("TaskUID", task->key.printable()) .detail("TaskType", task->params[Task::reservedTaskParamKeyType].printable()) .detail("Priority", task->getPriority());
															#line 4967 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	VerifyTask verifyTask;
															#line 427 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	Reference<ReadYourWritesTransaction> tr;
															#line 5080 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via doTask()
															#line 410 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class DoTaskActor final : public Actor<bool>, public ActorCallback< DoTaskActor, 0, bool >, public ActorCallback< DoTaskActor, 1, bool >, public ActorCallback< DoTaskActor, 2, Void >, public ActorCallback< DoTaskActor, 3, Void >, public ActorCallback< DoTaskActor, 4, Void >, public ActorCallback< DoTaskActor, 5, Void >, public ActorCallback< DoTaskActor, 6, Void >, public ActorCallback< DoTaskActor, 7, Void >, public ActorCallback< DoTaskActor, 8, Void >, public FastAllocated<DoTaskActor>, public DoTaskActorState<DoTaskActor> {
															#line 5085 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< DoTaskActor, 8, Void >;
	...
	DoTaskActor(Database const& cx,Reference<TaskBucket> const& taskBucket,Reference<FutureBucket> const& futureBucket,Reference<Task> const& task) 
															#line 5104 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<bool>(),
...
[[nodiscard]] static Future<bool> doTask( Database const& cx, Reference<TaskBucket> const& taskBucket, Reference<FutureBucket> const& futureBucket, Reference<Task> const& task ) {
	...
	return Future<bool>(new DoTaskActor(cx, taskBucket, futureBucket, task));
															#line 5139 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 477 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 5144 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via dispatch()
															#line 478 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class DispatchActor>
															#line 478 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class DispatchActorState {
															#line 5150 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 478 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	DispatchActorState(Database const& cx,Reference<TaskBucket> const& taskBucket,Reference<FutureBucket> const& futureBucket,std::shared_ptr<double const> const& pollDelay,int const& maxConcurrentTasks) 
		 ...
		 : cx(cx),
		   ...
		   maxConcurrentTasks(maxConcurrentTasks),
															#line 483 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   tasks(maxConcurrentTasks)
															#line 5167 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 484 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			for( auto& f : tasks ) {
															#line 485 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				f = Never();
															#line 5184 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
															#line 489 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			availableSlots = std::vector<int>();
															#line 490 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			availableSlots.reserve(tasks.size());
															#line 491 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			for(int i = 0;i < tasks.size();++i) {
															#line 492 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				availableSlots.push_back(i);
															#line 5194 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
															#line 494 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			getTasks = std::vector<Future<Reference<Task>>>();
															#line 495 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			getBatchSize = 1;
															#line 497 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			;
															#line 5202 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = a_body1loopHead1(loopDepth);
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1loopBody1(int loopDepth) 
	{
															#line 499 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		++taskBucket->dispatchSlotChecksStarted;
															#line 500 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		;
															#line 5234 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1loopBody1cont1(int loopDepth) 
	{
															#line 532 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		++taskBucket->dispatchSlotChecksComplete;
															#line 536 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		Future<Void> w = ready(waitForAny(tasks));
															#line 537 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!availableSlots.empty())
															#line 5247 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 538 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (*pollDelay > 600)
															#line 5251 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 539 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				TraceEvent(SevWarnAlways, "TaskBucketLongPollDelay").suppressFor(1.0).detail("Delay", *pollDelay);
															#line 5255 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
															#line 541 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			w = w || delay(*pollDelay * (0.9 + deterministicRandom()->random01() / 5));
															#line 5259 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
															#line 544 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		...
		if (static_cast<DispatchActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), std::max(0, loopDepth - 1));
															#line 5265 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< DispatchActor, 1, Void >*>(static_cast<DispatchActor*>(this)));
															#line 5270 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1loopBody1loopBody1(int loopDepth) 
	{
															#line 500 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!(!availableSlots.empty()))
															#line 5286 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
			return a_body1loopBody1break1(loopDepth==0?0:loopDepth-1); // break
		}
															#line 501 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		getTasks.clear();
															#line 502 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		for(int i = 0, imax = std::min<unsigned int>(getBatchSize, availableSlots.size());i < imax;++i) {
															#line 503 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			getTasks.push_back(taskBucket->getOne(cx));
															#line 5296 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
															#line 504 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		...
		if (static_cast<DispatchActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), std::max(0, loopDepth - 2));
															#line 5302 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		...
		__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< DispatchActor, 0, Void >*>(static_cast<DispatchActor*>(this)));
															#line 5307 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	{
															#line 506 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		bool done = false;
															#line 507 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		for(int i = 0;i < getTasks.size();++i) {
															#line 508 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (getTasks[i].isError())
															#line 5333 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 509 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				++taskBucket->dispatchErrors;
															#line 510 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				done = true;
															#line 5339 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				continue;
			}
															#line 513 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			Reference<Task> task = getTasks[i].get();
															#line 514 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (task)
															#line 5346 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 516 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				++taskBucket->dispatchDoTasks;
															#line 517 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				int slot = availableSlots.back();
															#line 518 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				availableSlots.pop_back();
															#line 519 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				tasks[slot] = taskBucket->doTask(cx, futureBucket, task);
															#line 5356 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
			else
			{
															#line 521 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				++taskBucket->dispatchEmptyTasks;
															#line 522 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				done = true;
															#line 5364 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
		}
															#line 526 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (done)
															#line 5369 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 527 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			getBatchSize = 1;
															#line 5373 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			return a_body1loopBody1break1(loopDepth==0?0:loopDepth-1); // break
		}
		else
		{
															#line 530 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			getBatchSize = std::min<unsigned int>(getBatchSize * 2, maxConcurrentTasks);
															#line 5380 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
	...
	int a_body1loopBody1loopBody1cont1(Void && _,int loopDepth) 
	{
		...
		for(int i = 0;i < getTasks.size();++i) {
															#line 508 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (getTasks[i].isError())
															#line 5394 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 509 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				++taskBucket->dispatchErrors;
															#line 510 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				done = true;
															#line 5400 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				continue;
			}
															#line 513 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			Reference<Task> task = getTasks[i].get();
															#line 514 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (task)
															#line 5407 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 516 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				++taskBucket->dispatchDoTasks;
															#line 517 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				...
				availableSlots.pop_back();
															#line 519 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				tasks[slot] = taskBucket->doTask(cx, futureBucket, task);
															#line 5417 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
			else
			{
															#line 521 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				++taskBucket->dispatchEmptyTasks;
															...
															#line 5425 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
		}
															#line 526 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (done)
															#line 5430 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 527 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			getBatchSize = 1;
															#line 5434 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			return a_body1loopBody1break1(loopDepth==0?0:loopDepth-1); // break
		}
		else
		{
															#line 530 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			getBatchSize = std::min<unsigned int>(getBatchSize * 2, maxConcurrentTasks);
															#line 5441 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
		if (loopDepth == 0) return a_body1loopBody1loopHead1(0);
	...
	{
															#line 548 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		for(int i = 0;i < tasks.size();++i) {
															#line 549 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (tasks[i].isReady())
															#line 5516 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 550 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				availableSlots.push_back(i);
															#line 551 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				tasks[i] = Never();
															#line 5522 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
		}
		if (loopDepth == 0) return a_body1loopHead1(0);
	...
	int a_body1loopBody1cont2(Void && _,int loopDepth) 
	{
		...
		for(int i = 0;i < tasks.size();++i) {
															#line 549 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (tasks[i].isReady())
															#line 5535 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 550 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				availableSlots.push_back(i);
															#line 551 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				tasks[i] = Never();
															#line 5541 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
		}
		if (loopDepth == 0) return a_body1loopHead1(0);
	...
	unsigned int getBatchSize;
															#line 5629 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via dispatch()
															#line 478 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class DispatchActor final : public Actor<Void>, public ActorCallback< DispatchActor, 0, Void >, public ActorCallback< DispatchActor, 1, Void >, public FastAllocated<DispatchActor>, public DispatchActorState<DispatchActor> {
															#line 5634 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< DispatchActor, 1, Void >;
	...
	DispatchActor(Database const& cx,Reference<TaskBucket> const& taskBucket,Reference<FutureBucket> const& futureBucket,std::shared_ptr<double const> const& pollDelay,int const& maxConcurrentTasks) 
															#line 5646 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> dispatch( Database const& cx, Reference<TaskBucket> const& taskBucket, Reference<FutureBucket> const& futureBucket, std::shared_ptr<double const> const& pollDelay, int const& maxConcurrentTasks ) {
	...
	return Future<Void>(new DispatchActor(cx, taskBucket, futureBucket, pollDelay, maxConcurrentTasks));
															#line 5674 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 556 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 5679 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via watchPaused()
															#line 557 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class WatchPausedActor>
															#line 557 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class WatchPausedActorState {
															#line 5685 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 557 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	WatchPausedActorState(Database const& cx,Reference<TaskBucket> const& taskBucket,Reference<AsyncVar<bool>> const& paused) 
		 ...
		 : cx(cx),
		   ...
		   taskBucket(taskBucket),
															#line 557 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   paused(paused)
															#line 5696 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 560 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			;
															#line 5711 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = a_body1loopHead1(loopDepth);
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1loopBody1(int loopDepth) 
	{
															#line 561 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		tr = Reference<ReadYourWritesTransaction>(new ReadYourWritesTransaction(cx));
															#line 5741 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		try {
															#line 563 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskBucket->setOptions(tr);
															#line 564 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<WatchPausedActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 5749 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1loopBody1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1loopBody1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< WatchPausedActor, 0, Optional<Value> >*>(static_cast<WatchPausedActor*>(this)));
															#line 5754 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1loopBody1Catch1(error, loopDepth);
	...
	{
		try {
															#line 570 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<WatchPausedActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), std::max(0, loopDepth - 1));
															#line 5778 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			__when_expr_3.addCallbackAndClear(static_cast<ActorCallback< WatchPausedActor, 3, Void >*>(static_cast<WatchPausedActor*>(this)));
															#line 5783 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, std::max(0, loopDepth - 1));
	...
	{
															#line 565 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		paused->set(pausedVal.present());
															#line 566 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		watchPausedFuture = tr->watch(taskBucket->pauseKey);
															#line 567 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		StrictFuture<Void> __when_expr_1 = tr->commit();
															#line 567 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<WatchPausedActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 5804 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1loopBody1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1loopBody1cont2when1(__when_expr_1.get(), loopDepth); };
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< WatchPausedActor, 1, Void >*>(static_cast<WatchPausedActor*>(this)));
															#line 5809 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1loopBody1cont2(Optional<Value> && pausedVal,int loopDepth) 
	{
		...
		StrictFuture<Void> __when_expr_1 = tr->commit();
															#line 567 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<WatchPausedActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 5824 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1loopBody1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1loopBody1cont2when1(__when_expr_1.get(), loopDepth); };
		static_cast<WatchPausedActor*>(this)->actor_wait_state = 2;
															#line 567 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< WatchPausedActor, 1, Void >*>(static_cast<WatchPausedActor*>(this)));
															#line 5829 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	{
															#line 568 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		StrictFuture<Void> __when_expr_2 = watchPausedFuture;
															#line 568 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<WatchPausedActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 5903 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		...
		__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< WatchPausedActor, 2, Void >*>(static_cast<WatchPausedActor*>(this)));
															#line 5908 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1loopBody1cont3(Void && _,int loopDepth) 
	{
		...
		StrictFuture<Void> __when_expr_2 = watchPausedFuture;
															#line 568 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<WatchPausedActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 5919 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_2.isReady()) { if (__when_expr_2.isError()) return a_body1loopBody1Catch1(__when_expr_2.getError(), loopDepth); else return a_body1loopBody1cont3when1(__when_expr_2.get(), loopDepth); };
		static_cast<WatchPausedActor*>(this)->actor_wait_state = 3;
															#line 568 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< WatchPausedActor, 2, Void >*>(static_cast<WatchPausedActor*>(this)));
															#line 5924 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	Future<Void> watchPausedFuture;
															#line 6165 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via watchPaused()
															#line 557 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class WatchPausedActor final : public Actor<Void>, public ActorCallback< WatchPausedActor, 0, Optional<Value> >, public ActorCallback< WatchPausedActor, 1, Void >, public ActorCallback< WatchPausedActor, 2, Void >, public ActorCallback< WatchPausedActor, 3, Void >, public FastAllocated<WatchPausedActor>, public WatchPausedActorState<WatchPausedActor> {
															#line 6170 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< WatchPausedActor, 3, Void >;
	...
	WatchPausedActor(Database const& cx,Reference<TaskBucket> const& taskBucket,Reference<AsyncVar<bool>> const& paused) 
															#line 6184 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> watchPaused( Database const& cx, Reference<TaskBucket> const& taskBucket, Reference<AsyncVar<bool>> const& paused ) {
	...
	return Future<Void>(new WatchPausedActor(cx, taskBucket, paused));
															#line 6214 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 574 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 6219 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via run()
															#line 575 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class RunActor>
															#line 575 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class RunActorState {
															#line 6225 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 575 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	RunActorState(Database const& cx,Reference<TaskBucket> const& taskBucket,Reference<FutureBucket> const& futureBucket,std::shared_ptr<double const> const& pollDelay,int const& maxConcurrentTasks) 
		 ...
		 : cx(cx),
		   ...
		   pollDelay(pollDelay),
															#line 575 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   maxConcurrentTasks(maxConcurrentTasks),
															#line 580 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   paused(makeReference<AsyncVar<bool>>(true)),
															#line 581 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   watchPausedFuture(watchPaused(cx, taskBucket, paused))
															#line 6244 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 582 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskBucket->metricLogger = traceCounters( "TaskBucketMetrics", taskBucket->dbgid, CLIENT_KNOBS->TASKBUCKET_LOGGING_DELAY, &taskBucket->cc);
															#line 584 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			;
															#line 6261 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = a_body1loopHead1(loopDepth);
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1loopBody1(int loopDepth) 
	{
															#line 585 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		;
															#line 6291 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = a_body1loopBody1loopHead1(loopDepth);
	...
	int a_body1loopBody1cont1(int loopDepth) 
	{
															#line 589 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		...
		if (static_cast<RunActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), std::max(0, loopDepth - 1));
															#line 6302 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), std::max(0, loopDepth - 1)); else return a_body1loopBody1cont1when1(__when_expr_1.get(), loopDepth); };
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< RunActor, 1, Void >*>(static_cast<RunActor*>(this)));
															#line 6307 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1loopBody1loopBody1(int loopDepth) 
	{
															#line 585 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!(paused->get()))
															#line 6323 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
			return a_body1loopBody1break1(loopDepth==0?0:loopDepth-1); // break
		}
															#line 586 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		...
		if (static_cast<RunActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), std::max(0, loopDepth - 2));
															#line 6331 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), std::max(0, loopDepth - 2)); else return a_body1loopBody1loopBody1when1(__when_expr_0.get(), loopDepth); };
		...
		__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< RunActor, 0, Void >*>(static_cast<RunActor*>(this)));
															#line 6336 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	Reference<AsyncVar<bool>> paused;
															#line 581 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	Future<Void> watchPausedFuture;
															#line 6518 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via run()
															#line 575 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class RunActor final : public Actor<Void>, public ActorCallback< RunActor, 0, Void >, public ActorCallback< RunActor, 1, Void >, public FastAllocated<RunActor>, public RunActorState<RunActor> {
															#line 6523 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< RunActor, 1, Void >;
	...
	RunActor(Database const& cx,Reference<TaskBucket> const& taskBucket,Reference<FutureBucket> const& futureBucket,std::shared_ptr<double const> const& pollDelay,int const& maxConcurrentTasks) 
															#line 6535 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> run( Database const& cx, Reference<TaskBucket> const& taskBucket, Reference<FutureBucket> const& futureBucket, std::shared_ptr<double const> const& pollDelay, int const& maxConcurrentTasks ) {
	...
	return Future<Void>(new RunActor(cx, taskBucket, futureBucket, pollDelay, maxConcurrentTasks));
															#line 6563 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 593 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	...
	static Future<Standalone<StringRef>> addIdle(Database cx, Reference<TaskBucket> taskBucket) {
		return runRYWTransaction(cx, [=](Reference<ReadYourWritesTransaction> tr) { return addIdle(tr, taskBucket); });
																...
																#line 6580 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via isEmpty()
															#line 606 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class IsEmptyActor>
															#line 606 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class IsEmptyActorState {
															#line 6586 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 606 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	IsEmptyActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket) 
		 ...
		 : tr(tr),
															#line 606 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   taskBucket(taskBucket)
															#line 6595 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 607 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskBucket->setOptions(tr);
															#line 610 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			resultFutures = std::vector<Future<RangeResult>>();
															#line 611 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			for(int pri = 0;pri <= CLIENT_KNOBS->TASKBUCKET_MAX_PRIORITY;++pri) {
															#line 612 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				resultFutures.push_back(tr->getRange(taskBucket->getAvailableSpace(pri).range(), 1));
															#line 6616 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
															#line 615 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			i = int();
															#line 616 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			i = 0;
															#line 6622 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = a_body1loopHead1(loopDepth);
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont1(int loopDepth) 
	{
															#line 622 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		...
		if (static_cast<IsEmptyActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 6647 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< IsEmptyActor, 1, RangeResult >*>(static_cast<IsEmptyActor*>(this)));
															#line 6652 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1loopBody1(int loopDepth) 
	{
		...
		if (!(i < resultFutures.size()))
															#line 6668 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
			return a_body1break1(loopDepth==0?0:loopDepth-1); // break
		}
															#line 617 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		...
		if (static_cast<IsEmptyActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), std::max(0, loopDepth - 1));
															#line 6676 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		...
		__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< IsEmptyActor, 0, RangeResult >*>(static_cast<IsEmptyActor*>(this)));
															#line 6681 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	{
															#line 618 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (results.size() > 0)
															#line 6703 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 619 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<IsEmptyActor*>(this)->SAV<bool>::futures) { (void)(false); this->~IsEmptyActorState(); static_cast<IsEmptyActor*>(this)->destroy(); return 0; }
															#line 6707 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			return 0;
															...
															#line 616 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		++i;
															#line 6715 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (loopDepth == 0) return a_body1loopHead1(0);
	...
	int a_body1loopBody1cont1(RangeResult && results,int loopDepth) 
	{
															#line 618 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (results.size() > 0)
															#line 6724 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 619 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<IsEmptyActor*>(this)->SAV<bool>::futures) { (void)(false); this->~IsEmptyActorState(); static_cast<IsEmptyActor*>(this)->destroy(); return 0; }
															#line 6728 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<IsEmptyActor*>(this)->SAV< bool >::value()) bool(false);
			this->~IsEmptyActorState();
			static_cast<IsEmptyActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
															...
															#line 616 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		++i;
															#line 6736 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (loopDepth == 0) return a_body1loopHead1(0);
	...
	{
															#line 623 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (values.size() > 0)
															#line 6808 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 624 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<IsEmptyActor*>(this)->SAV<bool>::futures) { (void)(false); this->~IsEmptyActorState(); static_cast<IsEmptyActor*>(this)->destroy(); return 0; }
															#line 6812 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<IsEmptyActor*>(this)->SAV< bool >::value()) bool(false);
			this->~IsEmptyActorState();
			static_cast<IsEmptyActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
		}
															#line 626 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<IsEmptyActor*>(this)->SAV<bool>::futures) { (void)(true); this->~IsEmptyActorState(); static_cast<IsEmptyActor*>(this)->destroy(); return 0; }
															#line 6820 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont3(RangeResult && values,int loopDepth) 
	{
															#line 623 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (values.size() > 0)
															#line 6832 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 624 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<IsEmptyActor*>(this)->SAV<bool>::futures) { (void)(false); this->~IsEmptyActorState(); static_cast<IsEmptyActor*>(this)->destroy(); return 0; }
															#line 6836 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<IsEmptyActor*>(this)->SAV< bool >::value()) bool(false);
			this->~IsEmptyActorState();
			static_cast<IsEmptyActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
															...
															#line 626 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<IsEmptyActor*>(this)->SAV<bool>::futures) { (void)(true); this->~IsEmptyActorState(); static_cast<IsEmptyActor*>(this)->destroy(); return 0; }
															#line 6844 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<IsEmptyActor*>(this)->SAV< bool >::value()) bool(true);
		this->~IsEmptyActorState();
		static_cast<IsEmptyActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	std::vector<Future<RangeResult>> resultFutures;
															#line 615 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	int i;
															#line 6923 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via isEmpty()
															#line 606 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class IsEmptyActor final : public Actor<bool>, public ActorCallback< IsEmptyActor, 0, RangeResult >, public ActorCallback< IsEmptyActor, 1, RangeResult >, public FastAllocated<IsEmptyActor>, public IsEmptyActorState<IsEmptyActor> {
															#line 6928 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< IsEmptyActor, 1, RangeResult >;
	...
	IsEmptyActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket) 
															#line 6940 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<bool>(),
...
[[nodiscard]] static Future<bool> isEmpty( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket ) {
	...
	return Future<bool>(new IsEmptyActor(tr, taskBucket));
															#line 6968 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 628 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 6973 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via isBusy()
															#line 629 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class IsBusyActor>
															#line 629 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class IsBusyActorState {
															#line 6979 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 629 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	IsBusyActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket) 
		 ...
		 : tr(tr),
															#line 629 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   taskBucket(taskBucket)
															#line 6988 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 630 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskBucket->setOptions(tr);
															#line 633 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			resultFutures = std::vector<Future<RangeResult>>();
															#line 634 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			for(int pri = 0;pri <= CLIENT_KNOBS->TASKBUCKET_MAX_PRIORITY;++pri) {
															#line 635 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				resultFutures.push_back(tr->getRange(taskBucket->getAvailableSpace(pri).range(), 1));
															#line 7009 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
															#line 638 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			i = int();
															#line 639 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			i = 0;
															#line 7015 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = a_body1loopHead1(loopDepth);
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont1(int loopDepth) 
	{
															#line 645 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<IsBusyActor*>(this)->SAV<bool>::futures) { (void)(false); this->~IsBusyActorState(); static_cast<IsBusyActor*>(this)->destroy(); return 0; }
															#line 7038 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1loopBody1(int loopDepth) 
	{
															#line 639 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!(i < resultFutures.size()))
															#line 7057 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
			return a_body1break1(loopDepth==0?0:loopDepth-1); // break
		}
															#line 640 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		StrictFuture<RangeResult> __when_expr_0 = resultFutures[i];
															#line 640 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<IsBusyActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), std::max(0, loopDepth - 1));
															#line 7065 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), std::max(0, loopDepth - 1)); else return a_body1loopBody1when1(__when_expr_0.get(), loopDepth); };
		...
		__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< IsBusyActor, 0, RangeResult >*>(static_cast<IsBusyActor*>(this)));
															#line 7070 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1loopBody1cont1(RangeResult const& results,int loopDepth) 
	{
															#line 641 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (results.size() > 0)
															#line 7092 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 642 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<IsBusyActor*>(this)->SAV<bool>::futures) { (void)(true); this->~IsBusyActorState(); static_cast<IsBusyActor*>(this)->destroy(); return 0; }
															#line 7096 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			return 0;
															...
															#line 639 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		++i;
															#line 7104 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (loopDepth == 0) return a_body1loopHead1(0);
	...
	int a_body1loopBody1cont1(RangeResult && results,int loopDepth) 
	{
															#line 641 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (results.size() > 0)
															#line 7113 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 642 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<IsBusyActor*>(this)->SAV<bool>::futures) { (void)(true); this->~IsBusyActorState(); static_cast<IsBusyActor*>(this)->destroy(); return 0; }
															#line 7117 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<IsBusyActor*>(this)->SAV< bool >::value()) bool(true);
			this->~IsBusyActorState();
			static_cast<IsBusyActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
															...
															#line 639 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		++i;
															#line 7125 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (loopDepth == 0) return a_body1loopHead1(0);
	...
	std::vector<Future<RangeResult>> resultFutures;
															#line 638 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	int i;
															#line 7201 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via isBusy()
															#line 629 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class IsBusyActor final : public Actor<bool>, public ActorCallback< IsBusyActor, 0, RangeResult >, public FastAllocated<IsBusyActor>, public IsBusyActorState<IsBusyActor> {
															#line 7206 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< IsBusyActor, 0, RangeResult >;
	...
	IsBusyActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket) 
															#line 7217 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<bool>(),
...
[[nodiscard]] static Future<bool> isBusy( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket ) {
	...
	return Future<bool>(new IsBusyActor(tr, taskBucket));
															#line 7244 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 647 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

	// Verify that the task's keys are still in the timeout space at the expected timeout prefix
																#line 7250 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via isFinished()
															#line 649 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class IsFinishedActor>
															#line 649 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class IsFinishedActorState {
															#line 7256 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 649 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	IsFinishedActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<Task> const& task) 
		 ...
		 : tr(tr),
		   ...
		   taskBucket(taskBucket),
															#line 649 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   task(task)
															#line 7267 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 652 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskBucket->setOptions(tr);
															#line 654 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			Tuple t;
															#line 655 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			t.append(task->timeoutVersion);
															#line 656 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			t.append(task->key);
															#line 658 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<IsFinishedActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 7292 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< IsFinishedActor, 0, RangeResult >*>(static_cast<IsFinishedActor*>(this)));
															#line 7297 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	{
															#line 659 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (values.size() > 0)
															#line 7320 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 660 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<IsFinishedActor*>(this)->SAV<bool>::futures) { (void)(false); this->~IsFinishedActorState(); static_cast<IsFinishedActor*>(this)->destroy(); return 0; }
															#line 7324 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			return 0;
															...
															#line 662 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<IsFinishedActor*>(this)->SAV<bool>::futures) { (void)(true); this->~IsFinishedActorState(); static_cast<IsFinishedActor*>(this)->destroy(); return 0; }
															#line 7332 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont1(RangeResult && values,int loopDepth) 
	{
															#line 659 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (values.size() > 0)
															#line 7344 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 660 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<IsFinishedActor*>(this)->SAV<bool>::futures) { (void)(false); this->~IsFinishedActorState(); static_cast<IsFinishedActor*>(this)->destroy(); return 0; }
															#line 7348 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<IsFinishedActor*>(this)->SAV< bool >::value()) bool(false);
			this->~IsFinishedActorState();
			static_cast<IsFinishedActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
															...
															#line 662 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<IsFinishedActor*>(this)->SAV<bool>::futures) { (void)(true); this->~IsFinishedActorState(); static_cast<IsFinishedActor*>(this)->destroy(); return 0; }
															#line 7356 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<IsFinishedActor*>(this)->SAV< bool >::value()) bool(true);
		this->~IsFinishedActorState();
		static_cast<IsFinishedActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Reference<TaskBucket> taskBucket;
															#line 649 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	Reference<Task> task;
															#line 7433 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via isFinished()
															#line 649 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class IsFinishedActor final : public Actor<bool>, public ActorCallback< IsFinishedActor, 0, RangeResult >, public FastAllocated<IsFinishedActor>, public IsFinishedActorState<IsFinishedActor> {
															#line 7438 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< IsFinishedActor, 0, RangeResult >;
	...
	IsFinishedActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<Task> const& task) 
															#line 7449 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<bool>(),
...
[[nodiscard]] static Future<bool> isFinished( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket, Reference<Task> const& task ) {
	...
	return Future<bool>(new IsFinishedActor(tr, taskBucket, task));
															#line 7476 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 664 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 7481 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via getActiveKey()
															#line 665 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class GetActiveKeyActor>
															#line 665 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class GetActiveKeyActorState {
															#line 7487 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 665 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	GetActiveKeyActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Optional<Value> const& startingValue) 
		 ...
		 : tr(tr),
		   ...
		   startingValue(startingValue)
															#line 7498 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 668 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskBucket->setOptions(tr);
															#line 670 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<GetActiveKeyActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 7517 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< GetActiveKeyActor, 0, Optional<Value> >*>(static_cast<GetActiveKeyActor*>(this)));
															#line 7522 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	{
															#line 671 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (new_value != startingValue)
															#line 7545 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 672 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<GetActiveKeyActor*>(this)->SAV<bool>::futures) { (void)(true); this->~GetActiveKeyActorState(); static_cast<GetActiveKeyActor*>(this)->destroy(); return 0; }
															#line 7549 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			return 0;
															...
															#line 674 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<GetActiveKeyActor*>(this)->SAV<bool>::futures) { (void)(false); this->~GetActiveKeyActorState(); static_cast<GetActiveKeyActor*>(this)->destroy(); return 0; }
															#line 7557 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont1(Optional<Value> && new_value,int loopDepth) 
	{
															#line 671 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (new_value != startingValue)
															#line 7569 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 672 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<GetActiveKeyActor*>(this)->SAV<bool>::futures) { (void)(true); this->~GetActiveKeyActorState(); static_cast<GetActiveKeyActor*>(this)->destroy(); return 0; }
															#line 7573 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<GetActiveKeyActor*>(this)->SAV< bool >::value()) bool(true);
			this->~GetActiveKeyActorState();
			static_cast<GetActiveKeyActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
															...
															#line 674 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<GetActiveKeyActor*>(this)->SAV<bool>::futures) { (void)(false); this->~GetActiveKeyActorState(); static_cast<GetActiveKeyActor*>(this)->destroy(); return 0; }
															#line 7581 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<GetActiveKeyActor*>(this)->SAV< bool >::value()) bool(false);
		this->~GetActiveKeyActorState();
		static_cast<GetActiveKeyActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Optional<Value> startingValue;
															#line 7658 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via getActiveKey()
															#line 665 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class GetActiveKeyActor final : public Actor<bool>, public ActorCallback< GetActiveKeyActor, 0, Optional<Value> >, public FastAllocated<GetActiveKeyActor>, public GetActiveKeyActorState<GetActiveKeyActor> {
															#line 7663 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< GetActiveKeyActor, 0, Optional<Value> >;
	...
	GetActiveKeyActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Optional<Value> const& startingValue) 
															#line 7674 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<bool>(),
...
[[nodiscard]] static Future<bool> getActiveKey( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket, Optional<Value> const& startingValue ) {
	...
	return Future<bool>(new GetActiveKeyActor(tr, taskBucket, startingValue));
															#line 7701 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 676 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 7706 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via checkActive()
															#line 677 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class CheckActiveActor>
															#line 677 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class CheckActiveActorState {
															#line 7712 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 677 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	CheckActiveActorState(Database const& cx,Reference<TaskBucket> const& taskBucket) 
		 ...
		 : cx(cx),
															#line 677 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   taskBucket(taskBucket),
															#line 678 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   tr(new ReadYourWritesTransaction(cx)),
															#line 679 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   startingValue()
															#line 7725 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 681 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			;
															#line 7740 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = a_body1loopHead1(loopDepth);
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont1(int loopDepth) 
	{
															#line 700 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		idx = 0;
															#line 701 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		;
															#line 7765 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = a_body1cont1loopHead1(loopDepth);
	...
	{
		try {
															#line 683 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskBucket->setOptions(tr);
															#line 685 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<CheckActiveActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 7786 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1loopBody1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1loopBody1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< CheckActiveActor, 0, bool >*>(static_cast<CheckActiveActor*>(this)));
															#line 7791 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1loopBody1Catch1(error, loopDepth);
	...
	{
		try {
															#line 696 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<Void> __when_expr_4 = tr->onError(e);
															#line 696 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<CheckActiveActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), std::max(0, loopDepth - 1));
															#line 7828 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			__when_expr_4.addCallbackAndClear(static_cast<ActorCallback< CheckActiveActor, 4, Void >*>(static_cast<CheckActiveActor*>(this)));
															#line 7833 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, std::max(0, loopDepth - 1));
	...
	{
															#line 686 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!is_busy)
															#line 7848 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 687 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<Void> __when_expr_1 = success(addIdle(tr, taskBucket));
															#line 687 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<CheckActiveActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 7854 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1loopBody1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1loopBody1cont2when1(__when_expr_1.get(), loopDepth); };
			...
			__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< CheckActiveActor, 1, Void >*>(static_cast<CheckActiveActor*>(this)));
															#line 7859 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		else
		{
	...
	int a_body1loopBody1cont2(bool && is_busy,int loopDepth) 
	{
															#line 686 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!is_busy)
															#line 7873 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 687 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<Void> __when_expr_1 = success(addIdle(tr, taskBucket));
															#line 687 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<CheckActiveActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 7879 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1loopBody1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1loopBody1cont2when1(__when_expr_1.get(), loopDepth); };
			static_cast<CheckActiveActor*>(this)->actor_wait_state = 2;
															#line 687 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< CheckActiveActor, 1, Void >*>(static_cast<CheckActiveActor*>(this)));
															#line 7884 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		else
		{
	...
	int a_body1loopBody1cont3(int loopDepth) 
	{
															#line 690 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		StrictFuture<Optional<Value>> __when_expr_2 = tr->get(taskBucket->active.key());
															#line 690 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<CheckActiveActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 7963 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_2.isReady()) { if (__when_expr_2.isError()) return a_body1loopBody1Catch1(__when_expr_2.getError(), loopDepth); else return a_body1loopBody1cont3when1(__when_expr_2.get(), loopDepth); };
		...
		__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< CheckActiveActor, 2, Optional<Value> >*>(static_cast<CheckActiveActor*>(this)));
															#line 7968 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	{
															#line 691 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		startingValue = val;
															#line 693 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		StrictFuture<Void> __when_expr_3 = tr->commit();
															#line 693 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<CheckActiveActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 8056 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_3.isReady()) { if (__when_expr_3.isError()) return a_body1loopBody1Catch1(__when_expr_3.getError(), loopDepth); else return a_body1loopBody1cont5when1(__when_expr_3.get(), loopDepth); };
		...
		__when_expr_3.addCallbackAndClear(static_cast<ActorCallback< CheckActiveActor, 3, Void >*>(static_cast<CheckActiveActor*>(this)));
															#line 8061 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1loopBody1cont5(Optional<Value> && val,int loopDepth) 
	{
		...
		StrictFuture<Void> __when_expr_3 = tr->commit();
															#line 693 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<CheckActiveActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 8074 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_3.isReady()) { if (__when_expr_3.isError()) return a_body1loopBody1Catch1(__when_expr_3.getError(), loopDepth); else return a_body1loopBody1cont5when1(__when_expr_3.get(), loopDepth); };
		static_cast<CheckActiveActor*>(this)->actor_wait_state = 4;
															#line 693 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		__when_expr_3.addCallbackAndClear(static_cast<ActorCallback< CheckActiveActor, 3, Void >*>(static_cast<CheckActiveActor*>(this)));
															#line 8079 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1cont2(int loopDepth) 
	{
															#line 720 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		TEST(true);
															#line 721 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<CheckActiveActor*>(this)->SAV<bool>::futures) { (void)(false); this->~CheckActiveActorState(); static_cast<CheckActiveActor*>(this)->destroy(); return 0; }
															#line 8303 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont1loopBody1(int loopDepth) 
	{
		...
		if (!(idx < CLIENT_KNOBS->TASKBUCKET_CHECK_ACTIVE_AMOUNT))
															#line 8322 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
			return a_body1cont1break1(loopDepth==0?0:loopDepth-1); // break
		}
															#line 702 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		tr = Reference<ReadYourWritesTransaction>(new ReadYourWritesTransaction(cx));
															#line 703 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		;
															#line 8330 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont1loopBody1cont1(int loopDepth) 
	{
															#line 701 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		++idx;
															#line 8352 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (loopDepth == 0) return a_body1cont1loopHead1(0);
	...
	{
		try {
															#line 705 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskBucket->setOptions(tr);
															#line 707 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<CheckActiveActor*>(this)->actor_wait_state < 0) return a_body1cont1loopBody1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 8373 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			__when_expr_5.addCallbackAndClear(static_cast<ActorCallback< CheckActiveActor, 5, Void >*>(static_cast<CheckActiveActor*>(this)));
															#line 8378 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
	...
	{
		try {
															#line 715 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<CheckActiveActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), std::max(0, loopDepth - 2));
															#line 8415 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			__when_expr_7.addCallbackAndClear(static_cast<ActorCallback< CheckActiveActor, 7, Void >*>(static_cast<CheckActiveActor*>(this)));
															#line 8420 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, std::max(0, loopDepth - 2));
	...
	{
															#line 708 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		StrictFuture<bool> __when_expr_6 = getActiveKey(tr, taskBucket, startingValue);
															#line 708 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<CheckActiveActor*>(this)->actor_wait_state < 0) return a_body1cont1loopBody1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 8437 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		...
		__when_expr_6.addCallbackAndClear(static_cast<ActorCallback< CheckActiveActor, 6, bool >*>(static_cast<CheckActiveActor*>(this)));
															#line 8442 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1cont1loopBody1loopBody1cont2(Void && _,int loopDepth) 
	{
		...
		StrictFuture<bool> __when_expr_6 = getActiveKey(tr, taskBucket, startingValue);
															#line 708 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<CheckActiveActor*>(this)->actor_wait_state < 0) return a_body1cont1loopBody1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 8453 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_6.isReady()) { if (__when_expr_6.isError()) return a_body1cont1loopBody1loopBody1Catch1(__when_expr_6.getError(), loopDepth); else return a_body1cont1loopBody1loopBody1cont2when1(__when_expr_6.get(), loopDepth); };
		static_cast<CheckActiveActor*>(this)->actor_wait_state = 7;
															#line 708 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		__when_expr_6.addCallbackAndClear(static_cast<ActorCallback< CheckActiveActor, 6, bool >*>(static_cast<CheckActiveActor*>(this)));
															#line 8458 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	{
															#line 709 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (isActiveKey)
															#line 8530 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 710 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TEST(true);
															#line 711 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<CheckActiveActor*>(this)->SAV<bool>::futures) { (void)(true); this->~CheckActiveActorState(); static_cast<CheckActiveActor*>(this)->destroy(); return 0; }
															#line 8536 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont1loopBody1loopBody1cont3(bool && isActiveKey,int loopDepth) 
	{
															#line 709 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (isActiveKey)
															#line 8550 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 710 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TEST(true);
															#line 711 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<CheckActiveActor*>(this)->SAV<bool>::futures) { (void)(true); this->~CheckActiveActorState(); static_cast<CheckActiveActor*>(this)->destroy(); return 0; }
															#line 8556 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<CheckActiveActor*>(this)->SAV< bool >::value()) bool(true);
			this->~CheckActiveActorState();
			static_cast<CheckActiveActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
	...
	Optional<Value> startingValue;
															#line 700 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	int idx;
															#line 8714 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via checkActive()
															#line 677 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class CheckActiveActor final : public Actor<bool>, public ActorCallback< CheckActiveActor, 0, bool >, public ActorCallback< CheckActiveActor, 1, Void >, public ActorCallback< CheckActiveActor, 2, Optional<Value> >, public ActorCallback< CheckActiveActor, 3, Void >, public ActorCallback< CheckActiveActor, 4, Void >, public ActorCallback< CheckActiveActor, 5, Void >, public ActorCallback< CheckActiveActor, 6, bool >, public ActorCallback< CheckActiveActor, 7, Void >, public FastAllocated<CheckActiveActor>, public CheckActiveActorState<CheckActiveActor> {
															#line 8719 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< CheckActiveActor, 7, Void >;
	...
	CheckActiveActor(Database const& cx,Reference<TaskBucket> const& taskBucket) 
															#line 8737 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<bool>(),
...
[[nodiscard]] static Future<bool> checkActive( Database const& cx, Reference<TaskBucket> const& taskBucket ) {
	...
	return Future<bool>(new CheckActiveActor(cx, taskBucket));
															#line 8771 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 723 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 8776 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via getTaskCount()
															#line 724 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class GetTaskCountActor>
															#line 724 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class GetTaskCountActorState {
															#line 8782 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 724 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	GetTaskCountActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket) 
		 ...
		 : tr(tr),
															#line 724 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   taskBucket(taskBucket)
															#line 8791 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 726 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskBucket->setOptions(tr);
															#line 728 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<GetTaskCountActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 8810 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< GetTaskCountActor, 0, Optional<Value> >*>(static_cast<GetTaskCountActor*>(this)));
															#line 8815 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	{
															#line 730 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!val.present())
															#line 8838 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 731 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<GetTaskCountActor*>(this)->SAV<int64_t>::futures) { (void)(0); this->~GetTaskCountActorState(); static_cast<GetTaskCountActor*>(this)->destroy(); return 0; }
															#line 8842 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			...
			return 0;
															...
															#line 733 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		ASSERT(val.get().size() == sizeof(int64_t));
															#line 735 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		int64_t intValue = 0;
															#line 736 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		memcpy(&intValue, val.get().begin(), val.get().size());
															#line 738 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<GetTaskCountActor*>(this)->SAV<int64_t>::futures) { (void)(intValue); this->~GetTaskCountActorState(); static_cast<GetTaskCountActor*>(this)->destroy(); return 0; }
															#line 8856 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont1(Optional<Value> && val,int loopDepth) 
	{
															#line 730 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!val.present())
															#line 8868 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 731 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<GetTaskCountActor*>(this)->SAV<int64_t>::futures) { (void)(0); this->~GetTaskCountActorState(); static_cast<GetTaskCountActor*>(this)->destroy(); return 0; }
															#line 8872 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<GetTaskCountActor*>(this)->SAV< int64_t >::value()) int64_t(0);
			this->~GetTaskCountActorState();
			static_cast<GetTaskCountActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
		...
		memcpy(&intValue, val.get().begin(), val.get().size());
															#line 738 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<GetTaskCountActor*>(this)->SAV<int64_t>::futures) { (void)(intValue); this->~GetTaskCountActorState(); static_cast<GetTaskCountActor*>(this)->destroy(); return 0; }
															#line 8886 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<GetTaskCountActor*>(this)->SAV< int64_t >::value()) int64_t(intValue);
		this->~GetTaskCountActorState();
		static_cast<GetTaskCountActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Reference<ReadYourWritesTransaction> tr;
															#line 724 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	Reference<TaskBucket> taskBucket;
															#line 8961 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via getTaskCount()
															#line 724 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class GetTaskCountActor final : public Actor<int64_t>, public ActorCallback< GetTaskCountActor, 0, Optional<Value> >, public FastAllocated<GetTaskCountActor>, public GetTaskCountActorState<GetTaskCountActor> {
															#line 8966 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< GetTaskCountActor, 0, Optional<Value> >;
	...
	GetTaskCountActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket) 
															#line 8977 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<int64_t>(),
...
[[nodiscard]] static Future<int64_t> getTaskCount( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket ) {
	...
	return Future<int64_t>(new GetTaskCountActor(tr, taskBucket));
															#line 9004 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 740 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

	// Looks for tasks that have timed out and returns them to be available tasks.
	// Returns True if any tasks were affected.
																#line 9011 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via requeueTimedOutTasks()
															#line 743 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class RequeueTimedOutTasksActor>
															#line 743 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class RequeueTimedOutTasksActorState {
															#line 9017 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 743 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	RequeueTimedOutTasksActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket) 
		 ...
		 : tr(tr),
															#line 743 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   taskBucket(taskBucket)
															#line 9026 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 745 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TEST(true);
															#line 746 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<RequeueTimedOutTasksActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 9045 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< RequeueTimedOutTasksActor, 0, Version >*>(static_cast<RequeueTimedOutTasksActor*>(this)));
															#line 9050 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont1(Version const& end,int loopDepth) 
	{
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< RequeueTimedOutTasksActor, 1, RangeResult >*>(static_cast<RequeueTimedOutTasksActor*>(this)));
															#line 9082 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1cont1(Version && end,int loopDepth) 
	{
		...
		StrictFuture<RangeResult> __when_expr_1 = tr->getRange(range, CLIENT_KNOBS->TASKBUCKET_MAX_TASK_KEYS);
															#line 750 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<RequeueTimedOutTasksActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 9095 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		static_cast<RequeueTimedOutTasksActor*>(this)->actor_wait_state = 2;
															#line 750 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< RequeueTimedOutTasksActor, 1, RangeResult >*>(static_cast<RequeueTimedOutTasksActor*>(this)));
															#line 9100 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	{
															#line 757 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		Task task;
															#line 758 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		Key lastKey;
															#line 760 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		for( auto& iter : values ) {
															#line 761 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			Tuple t = taskBucket->timeouts.unpack(iter.key);
															#line 762 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			Key uid = t.getString(1);
															#line 763 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			Key param = t.getString(2);
															#line 766 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (uid != task.key)
															#line 9184 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 768 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				Subspace space = taskBucket->getAvailableSpace(task.getPriority()).get(task.key);
															#line 769 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				for( auto& p : task.params ) {
															#line 770 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
					tr->set(space.pack(p.key), p.value);
															#line 9192 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				}
															#line 772 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				task.params.clear();
															#line 773 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				task.key = uid;
															#line 774 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				lastKey = iter.key;
															#line 9200 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
															#line 777 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			task.params[param] = iter.value;
															#line 9204 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
															#line 781 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!values.more)
															#line 9208 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 782 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			Subspace space = taskBucket->getAvailableSpace(task.getPriority()).get(task.key);
															#line 783 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			for( auto& p : task.params ) {
															#line 784 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				tr->set(space.pack(p.key), p.value);
															#line 9216 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
															#line 786 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (values.size() > 0)
															#line 9220 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 787 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				tr->clear(range);
															#line 788 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				if (!static_cast<RequeueTimedOutTasksActor*>(this)->SAV<bool>::futures) { (void)(true); this->~RequeueTimedOutTasksActorState(); static_cast<RequeueTimedOutTasksActor*>(this)->destroy(); return 0; }
															#line 9226 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				...
				return 0;
															...
															#line 790 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<RequeueTimedOutTasksActor*>(this)->SAV<bool>::futures) { (void)(false); this->~RequeueTimedOutTasksActorState(); static_cast<RequeueTimedOutTasksActor*>(this)->destroy(); return 0; }
															#line 9234 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<RequeueTimedOutTasksActor*>(this)->SAV< bool >::value()) bool(false);
			this->~RequeueTimedOutTasksActorState();
			static_cast<RequeueTimedOutTasksActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
		}
															#line 793 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		ASSERT(lastKey != Key());
															#line 794 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		tr->clear(KeyRangeRef(range.begin, lastKey));
															#line 795 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<RequeueTimedOutTasksActor*>(this)->SAV<bool>::futures) { (void)(true); this->~RequeueTimedOutTasksActorState(); static_cast<RequeueTimedOutTasksActor*>(this)->destroy(); return 0; }
															#line 9246 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<RequeueTimedOutTasksActor*>(this)->SAV< bool >::value()) bool(true);
		this->~RequeueTimedOutTasksActorState();
		static_cast<RequeueTimedOutTasksActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	int a_body1cont2(RangeResult && values,int loopDepth) 
	{
		...
		for( auto& iter : values ) {
			...
			Key param = t.getString(2);
															#line 766 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (uid != task.key)
															#line 9270 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 768 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				Subspace space = taskBucket->getAvailableSpace(task.getPriority()).get(task.key);
															#line 769 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				for( auto& p : task.params ) {
															#line 770 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
					tr->set(space.pack(p.key), p.value);
															#line 9278 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				}
															#line 772 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				task.params.clear();
															#line 773 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				task.key = uid;
															#line 774 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				lastKey = iter.key;
															#line 9286 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
															#line 777 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			task.params[param] = iter.value;
															#line 9290 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
															#line 781 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!values.more)
															#line 9294 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 782 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			Subspace space = taskBucket->getAvailableSpace(task.getPriority()).get(task.key);
															#line 783 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			for( auto& p : task.params ) {
															#line 784 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				tr->set(space.pack(p.key), p.value);
															#line 9302 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
															#line 786 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (values.size() > 0)
															#line 9306 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 787 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				tr->clear(range);
															#line 788 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				if (!static_cast<RequeueTimedOutTasksActor*>(this)->SAV<bool>::futures) { (void)(true); this->~RequeueTimedOutTasksActorState(); static_cast<RequeueTimedOutTasksActor*>(this)->destroy(); return 0; }
															#line 9312 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				new (&static_cast<RequeueTimedOutTasksActor*>(this)->SAV< bool >::value()) bool(true);
				this->~RequeueTimedOutTasksActorState();
				static_cast<RequeueTimedOutTasksActor*>(this)->finishSendAndDelPromiseRef();
				return 0;
															...
															#line 790 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<RequeueTimedOutTasksActor*>(this)->SAV<bool>::futures) { (void)(false); this->~RequeueTimedOutTasksActorState(); static_cast<RequeueTimedOutTasksActor*>(this)->destroy(); return 0; }
															#line 9320 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<RequeueTimedOutTasksActor*>(this)->SAV< bool >::value()) bool(false);
			this->~RequeueTimedOutTasksActorState();
			static_cast<RequeueTimedOutTasksActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
		...
		tr->clear(KeyRangeRef(range.begin, lastKey));
															#line 795 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<RequeueTimedOutTasksActor*>(this)->SAV<bool>::futures) { (void)(true); this->~RequeueTimedOutTasksActorState(); static_cast<RequeueTimedOutTasksActor*>(this)->destroy(); return 0; }
															#line 9332 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<RequeueTimedOutTasksActor*>(this)->SAV< bool >::value()) bool(true);
		this->~RequeueTimedOutTasksActorState();
		static_cast<RequeueTimedOutTasksActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Reference<TaskBucket> taskBucket;
															#line 747 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	KeyRange range;
															#line 9409 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via requeueTimedOutTasks()
															#line 743 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class RequeueTimedOutTasksActor final : public Actor<bool>, public ActorCallback< RequeueTimedOutTasksActor, 0, Version >, public ActorCallback< RequeueTimedOutTasksActor, 1, RangeResult >, public FastAllocated<RequeueTimedOutTasksActor>, public RequeueTimedOutTasksActorState<RequeueTimedOutTasksActor> {
															#line 9414 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< RequeueTimedOutTasksActor, 1, RangeResult >;
	...
	RequeueTimedOutTasksActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket) 
															#line 9426 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<bool>(),
...
[[nodiscard]] static Future<bool> requeueTimedOutTasks( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket ) {
	...
	return Future<bool>(new RequeueTimedOutTasksActor(tr, taskBucket));
															#line 9454 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 797 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 9459 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via debugPrintRange()
															#line 798 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class DebugPrintRangeActor>
															#line 798 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class DebugPrintRangeActorState {
															#line 9465 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 798 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	DebugPrintRangeActorState(Reference<ReadYourWritesTransaction> const& tr,Subspace const& subspace,Key const& msg) 
		 ...
		 : tr(tr),
		   ...
		   subspace(subspace),
															#line 798 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   msg(msg)
															#line 9476 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 799 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			tr->setOption(FDBTransactionOptions::ACCESS_SYSTEM_KEYS);
															#line 800 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			tr->setOption(FDBTransactionOptions::LOCK_AWARE);
															#line 801 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<DebugPrintRangeActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 9497 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< DebugPrintRangeActor, 0, RangeResult >*>(static_cast<DebugPrintRangeActor*>(this)));
															#line 9502 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont1(RangeResult const& values,int loopDepth) 
	{
															#line 802 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		TraceEvent("TaskBucketDebugPrintRange") .detail("Key", subspace.key()) .detail("Count", values.size()) .detail("Msg", msg);
															#line 815 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<DebugPrintRangeActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~DebugPrintRangeActorState(); static_cast<DebugPrintRangeActor*>(this)->destroy(); return 0; }
															#line 9527 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont1(RangeResult && values,int loopDepth) 
	{
		...
		TraceEvent("TaskBucketDebugPrintRange") .detail("Key", subspace.key()) .detail("Count", values.size()) .detail("Msg", msg);
															#line 815 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<DebugPrintRangeActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~DebugPrintRangeActorState(); static_cast<DebugPrintRangeActor*>(this)->destroy(); return 0; }
															#line 9541 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<DebugPrintRangeActor*>(this)->SAV< Void >::value()) Void(Void());
		this->~DebugPrintRangeActorState();
		static_cast<DebugPrintRangeActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Subspace subspace;
															#line 798 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	Key msg;
															#line 9618 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via debugPrintRange()
															#line 798 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class DebugPrintRangeActor final : public Actor<Void>, public ActorCallback< DebugPrintRangeActor, 0, RangeResult >, public FastAllocated<DebugPrintRangeActor>, public DebugPrintRangeActorState<DebugPrintRangeActor> {
															#line 9623 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< DebugPrintRangeActor, 0, RangeResult >;
	...
	DebugPrintRangeActor(Reference<ReadYourWritesTransaction> const& tr,Subspace const& subspace,Key const& msg) 
															#line 9634 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> debugPrintRange( Reference<ReadYourWritesTransaction> const& tr, Subspace const& subspace, Key const& msg ) {
	...
	return Future<Void>(new DebugPrintRangeActor(tr, subspace, msg));
															#line 9661 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 817 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 9666 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via extendTimeout()
															#line 818 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class ExtendTimeoutActor>
															#line 818 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class ExtendTimeoutActorState {
															#line 9672 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 818 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	ExtendTimeoutActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<Task> const& task,UpdateParams const& updateParams,Version const& newTimeoutVersion) 
		 ...
		 : tr(tr),
		   ...
		   newTimeoutVersion(newTimeoutVersion)
															#line 9687 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 823 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskBucket->setOptions(tr);
															#line 826 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<ExtendTimeoutActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 9706 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< ExtendTimeoutActor, 0, Void >*>(static_cast<ExtendTimeoutActor*>(this)));
															#line 9711 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	{
															#line 829 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		oldTimeoutSpace = taskBucket->timeouts.get(task->timeoutVersion).get(task->key);
															#line 831 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		StrictFuture<Version> __when_expr_1 = tr->getReadVersion();
															#line 831 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<ExtendTimeoutActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 9738 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< ExtendTimeoutActor, 1, Version >*>(static_cast<ExtendTimeoutActor*>(this)));
															#line 9743 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1cont1(Void && _,int loopDepth) 
	{
		...
		StrictFuture<Version> __when_expr_1 = tr->getReadVersion();
															#line 831 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<ExtendTimeoutActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 9756 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		static_cast<ExtendTimeoutActor*>(this)->actor_wait_state = 2;
															#line 831 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< ExtendTimeoutActor, 1, Version >*>(static_cast<ExtendTimeoutActor*>(this)));
															#line 9761 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	{
															#line 833 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (newTimeoutVersion == invalidVersion)
															#line 9833 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 834 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			newTimeoutVersion = version + taskBucket->timeout;
															#line 9837 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
		else
		{
															#line 835 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (newTimeoutVersion <= version)
															#line 9843 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 836 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				newTimeoutVersion = version + 1;
															#line 9847 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
		}
															#line 840 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (newTimeoutVersion <= task->timeoutVersion)
															#line 9852 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 841 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			newTimeoutVersion = task->timeoutVersion + 1;
															#line 9856 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
															#line 845 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		newTimeoutSpace = taskBucket->timeouts.get(newTimeoutVersion).get(task->key);
															#line 847 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		tr->addReadConflictRange(oldTimeoutSpace.range());
															#line 848 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		tr->addWriteConflictRange(newTimeoutSpace.range());
															#line 851 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (updateParams)
															#line 9866 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 852 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TEST(true);
															#line 853 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			for( auto& p : task->params ) {
															#line 854 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				tr->set(newTimeoutSpace.pack(p.key), p.value);
															#line 9874 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
			loopDepth = a_body1cont3(loopDepth);
		}
		else
		{
															#line 857 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TEST(true);
															#line 859 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<RangeResult> __when_expr_2 = tr->getRange(oldTimeoutSpace.range(), CLIENT_KNOBS->TOO_MANY);
															#line 859 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<ExtendTimeoutActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 9886 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_2.isReady()) { if (__when_expr_2.isError()) return a_body1Catch1(__when_expr_2.getError(), loopDepth); else return a_body1cont2when1(__when_expr_2.get(), loopDepth); };
			...
			__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< ExtendTimeoutActor, 2, RangeResult >*>(static_cast<ExtendTimeoutActor*>(this)));
															#line 9891 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
	...
	int a_body1cont2(Version && version,int loopDepth) 
	{
															#line 833 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (newTimeoutVersion == invalidVersion)
															#line 9901 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 834 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			newTimeoutVersion = version + taskBucket->timeout;
															#line 9905 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
		else
		{
															#line 835 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (newTimeoutVersion <= version)
															#line 9911 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 836 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				newTimeoutVersion = version + 1;
															#line 9915 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
		}
															#line 840 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (newTimeoutVersion <= task->timeoutVersion)
															#line 9920 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 841 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			newTimeoutVersion = task->timeoutVersion + 1;
															#line 9924 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
															#line 845 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		newTimeoutSpace = taskBucket->timeouts.get(newTimeoutVersion).get(task->key);
															#line 847 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		...
		tr->addWriteConflictRange(newTimeoutSpace.range());
															#line 851 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (updateParams)
															#line 9934 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 852 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TEST(true);
															#line 853 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			for( auto& p : task->params ) {
															#line 854 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				tr->set(newTimeoutSpace.pack(p.key), p.value);
															#line 9942 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
			loopDepth = a_body1cont3(loopDepth);
		}
		else
		{
			...
			StrictFuture<RangeResult> __when_expr_2 = tr->getRange(oldTimeoutSpace.range(), CLIENT_KNOBS->TOO_MANY);
															#line 859 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<ExtendTimeoutActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 9954 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_2.isReady()) { if (__when_expr_2.isError()) return a_body1Catch1(__when_expr_2.getError(), loopDepth); else return a_body1cont2when1(__when_expr_2.get(), loopDepth); };
			static_cast<ExtendTimeoutActor*>(this)->actor_wait_state = 3;
															#line 859 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< ExtendTimeoutActor, 2, RangeResult >*>(static_cast<ExtendTimeoutActor*>(this)));
															#line 9959 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
	...
	int a_body1cont3(int loopDepth) 
	{
															#line 866 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		tr->clear(oldTimeoutSpace.range());
															#line 868 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<ExtendTimeoutActor*>(this)->SAV<Version>::futures) { (void)(newTimeoutVersion); this->~ExtendTimeoutActorState(); static_cast<ExtendTimeoutActor*>(this)->destroy(); return 0; }
															#line 10034 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	{
															#line 860 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		for( auto& kv : params ) {
															#line 861 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			Tuple paramKey = oldTimeoutSpace.unpack(kv.key);
															#line 862 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			tr->set(newTimeoutSpace.pack(paramKey), kv.value);
															#line 10050 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
		loopDepth = a_body1cont3(loopDepth);
	...
	int a_body1cont10(RangeResult && params,int loopDepth) 
	{
		...
		for( auto& kv : params ) {
			...
			Tuple paramKey = oldTimeoutSpace.unpack(kv.key);
															#line 862 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			tr->set(newTimeoutSpace.pack(paramKey), kv.value);
															#line 10064 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
		loopDepth = a_body1cont3(loopDepth);
	...
	Subspace newTimeoutSpace;
															#line 10147 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via extendTimeout()
															#line 818 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class ExtendTimeoutActor final : public Actor<Version>, public ActorCallback< ExtendTimeoutActor, 0, Void >, public ActorCallback< ExtendTimeoutActor, 1, Version >, public ActorCallback< ExtendTimeoutActor, 2, RangeResult >, public FastAllocated<ExtendTimeoutActor>, public ExtendTimeoutActorState<ExtendTimeoutActor> {
															#line 10152 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< ExtendTimeoutActor, 2, RangeResult >;
	...
	ExtendTimeoutActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<Task> const& task,UpdateParams const& updateParams,Version const& newTimeoutVersion) 
															#line 10165 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<Version>(),
...
[[nodiscard]] static Future<Version> extendTimeout( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket, Reference<Task> const& task, UpdateParams const& updateParams, Version const& newTimeoutVersion ) {
	...
	return Future<Version>(new ExtendTimeoutActor(tr, taskBucket, task, updateParams, newTimeoutVersion));
															#line 10194 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 870 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
};
...
void TaskBucket::setValidationCondition(Reference<Task> task, KeyRef vKey, KeyRef vValue) {
	...
	task->params[Task::reservedTaskParamValidValue] = vValue;
															...
															#line 10265 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
namespace {
// This generated class is to be used only via actorAddTask()
															#line 937 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class ActorAddTaskActor>
															#line 937 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class ActorAddTaskActorState {
															#line 10272 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 937 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	ActorAddTaskActorState(TaskBucket* const& tb,Reference<ReadYourWritesTransaction> const& tr,Reference<Task> const& task,KeyRef const& validationKey) 
		 ...
		 : tb(tb),
		   ...
		   validationKey(validationKey)
															#line 10285 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 941 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			tb->setOptions(tr);
															#line 943 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<ActorAddTaskActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 10304 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< ActorAddTaskActor, 0, Optional<Value> >*>(static_cast<ActorAddTaskActor*>(this)));
															#line 10309 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	{
															#line 945 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!validationValue.present())
															#line 10332 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 946 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TraceEvent(SevError, "TaskBucketAddTaskInvalidKey") .detail("Task", task->params[Task::reservedTaskParamKeyType]) .detail("ValidationKey", validationKey);
															#line 949 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			return a_body1Catch1(invalid_option_value(), loopDepth);
															#line 10338 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
															#line 952 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		TaskBucket::setValidationCondition(task, validationKey, validationValue.get());
															#line 954 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<ActorAddTaskActor*>(this)->SAV<Key>::futures) { (void)(tb->addTask(tr, task)); this->~ActorAddTaskActorState(); static_cast<ActorAddTaskActor*>(this)->destroy(); return 0; }
															#line 10344 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont1(Optional<Value> && validationValue,int loopDepth) 
	{
															#line 945 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!validationValue.present())
															#line 10356 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 946 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TraceEvent(SevError, "TaskBucketAddTaskInvalidKey") .detail("Task", task->params[Task::reservedTaskParamKeyType]) .detail("ValidationKey", validationKey);
															#line 949 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			return a_body1Catch1(invalid_option_value(), loopDepth);
															#line 10362 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
															#line 952 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		TaskBucket::setValidationCondition(task, validationKey, validationValue.get());
															#line 954 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<ActorAddTaskActor*>(this)->SAV<Key>::futures) { (void)(tb->addTask(tr, task)); this->~ActorAddTaskActorState(); static_cast<ActorAddTaskActor*>(this)->destroy(); return 0; }
															#line 10368 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<ActorAddTaskActor*>(this)->SAV< Key >::value()) Key(tb->addTask(tr, task));
		this->~ActorAddTaskActorState();
		static_cast<ActorAddTaskActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	KeyRef validationKey;
															#line 10447 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via actorAddTask()
															#line 937 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class ActorAddTaskActor final : public Actor<Key>, public ActorCallback< ActorAddTaskActor, 0, Optional<Value> >, public FastAllocated<ActorAddTaskActor>, public ActorAddTaskActorState<ActorAddTaskActor> {
															#line 10452 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< ActorAddTaskActor, 0, Optional<Value> >;
	...
	ActorAddTaskActor(TaskBucket* const& tb,Reference<ReadYourWritesTransaction> const& tr,Reference<Task> const& task,KeyRef const& validationKey) 
															#line 10463 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<Key>(),
...
[[nodiscard]] static Future<Key> actorAddTask( TaskBucket* const& tb, Reference<ReadYourWritesTransaction> const& tr, Reference<Task> const& task, KeyRef const& validationKey ) {
	...
	return Future<Key>(new ActorAddTaskActor(tb, tr, task, validationKey));
															#line 10491 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 956 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
...
public:
																#line 10584 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via isEmpty()
															#line 1045 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class IsEmptyActor1>
															#line 1045 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class IsEmptyActor1State {
															#line 10590 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 1045 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	IsEmptyActor1State(Reference<ReadYourWritesTransaction> const& tr,Reference<FutureBucket> const& futureBucket) 
		 ...
		 : tr(tr),
															#line 1045 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   futureBucket(futureBucket)
															#line 10599 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
		fdb_probe_actor_create("isEmpty", reinterpret_cast<unsigned long>(this));
	...
	{
		try {
															#line 1046 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			futureBucket->setOptions(tr);
															#line 1048 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<IsEmptyActor1*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 10618 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< IsEmptyActor1, 0, Key >*>(static_cast<IsEmptyActor1*>(this)));
															#line 10623 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	{
															#line 1049 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<IsEmptyActor1*>(this)->SAV<bool>::futures) { (void)(!futureBucket->prefix.contains(lastKey)); this->~IsEmptyActor1State(); static_cast<IsEmptyActor1*>(this)->destroy(); return 0; }
															#line 10646 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont1(Key && lastKey,int loopDepth) 
	{
															#line 1049 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<IsEmptyActor1*>(this)->SAV<bool>::futures) { (void)(!futureBucket->prefix.contains(lastKey)); this->~IsEmptyActor1State(); static_cast<IsEmptyActor1*>(this)->destroy(); return 0; }
															#line 10658 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<IsEmptyActor1*>(this)->SAV< bool >::value()) bool(!futureBucket->prefix.contains(lastKey));
		this->~IsEmptyActor1State();
		static_cast<IsEmptyActor1*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Reference<ReadYourWritesTransaction> tr;
															#line 1045 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	Reference<FutureBucket> futureBucket;
															#line 10733 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via isEmpty()
															#line 1045 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class IsEmptyActor1 final : public Actor<bool>, public ActorCallback< IsEmptyActor1, 0, Key >, public FastAllocated<IsEmptyActor1>, public IsEmptyActor1State<IsEmptyActor1> {
															#line 10738 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< IsEmptyActor1, 0, Key >;
	...
	IsEmptyActor1(Reference<ReadYourWritesTransaction> const& tr,Reference<FutureBucket> const& futureBucket) 
															#line 10749 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<bool>(),
...
[[nodiscard]] static Future<bool> isEmpty( Reference<ReadYourWritesTransaction> const& tr, Reference<FutureBucket> const& futureBucket ) {
	...
	return Future<bool>(new IsEmptyActor1(tr, futureBucket));
															#line 10776 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 1051 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
};
...
public:
																#line 10813 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via join()
															#line 1084 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class JoinActor>
															#line 1084 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class JoinActorState {
															#line 10819 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 1084 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	JoinActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<TaskFuture> const& taskFuture,std::vector<Reference<TaskFuture>> const& vectorFuture) 
		 ...
		 : tr(tr),
		   ...
		   vectorFuture(vectorFuture)
															#line 10832 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 1088 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskFuture->futureBucket->setOptions(tr);
															#line 1090 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<JoinActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 10851 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< JoinActor, 0, bool >*>(static_cast<JoinActor*>(this)));
															#line 10856 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont1(bool const& is_set,int loopDepth) 
	{
															#line 1091 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (is_set)
															#line 10879 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 1092 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<JoinActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~JoinActorState(); static_cast<JoinActor*>(this)->destroy(); return 0; }
															#line 10883 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<JoinActor*>(this)->SAV< Void >::value()) Void(Void());
			this->~JoinActorState();
			static_cast<JoinActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
		}
															#line 1095 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		tr->clear(taskFuture->blocks.pack(StringRef()));
															#line 1097 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		StrictFuture<Void> __when_expr_1 = _join(tr, taskBucket, taskFuture, vectorFuture);
															#line 1097 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<JoinActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 10895 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< JoinActor, 1, Void >*>(static_cast<JoinActor*>(this)));
															#line 10900 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1cont1(bool && is_set,int loopDepth) 
	{
															#line 1091 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (is_set)
															#line 10909 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 1092 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<JoinActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~JoinActorState(); static_cast<JoinActor*>(this)->destroy(); return 0; }
															#line 10913 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<JoinActor*>(this)->SAV< Void >::value()) Void(Void());
			this->~JoinActorState();
			static_cast<JoinActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
		...
		StrictFuture<Void> __when_expr_1 = _join(tr, taskBucket, taskFuture, vectorFuture);
															#line 1097 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<JoinActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 10925 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		static_cast<JoinActor*>(this)->actor_wait_state = 2;
															#line 1097 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< JoinActor, 1, Void >*>(static_cast<JoinActor*>(this)));
															#line 10930 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	{
															#line 1099 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<JoinActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~JoinActorState(); static_cast<JoinActor*>(this)->destroy(); return 0; }
															#line 11002 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<JoinActor*>(this)->SAV< Void >::value()) Void(Void());
		this->~JoinActorState();
		static_cast<JoinActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	int a_body1cont2(Void && _,int loopDepth) 
	{
															#line 1099 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<JoinActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~JoinActorState(); static_cast<JoinActor*>(this)->destroy(); return 0; }
															#line 11014 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<JoinActor*>(this)->SAV< Void >::value()) Void(Void());
		this->~JoinActorState();
		static_cast<JoinActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	std::vector<Reference<TaskFuture>> vectorFuture;
															#line 11093 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via join()
															#line 1084 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class JoinActor final : public Actor<Void>, public ActorCallback< JoinActor, 0, bool >, public ActorCallback< JoinActor, 1, Void >, public FastAllocated<JoinActor>, public JoinActorState<JoinActor> {
															#line 11098 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< JoinActor, 1, Void >;
	...
	JoinActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<TaskFuture> const& taskFuture,std::vector<Reference<TaskFuture>> const& vectorFuture) 
															#line 11110 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> join( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket, Reference<TaskFuture> const& taskFuture, std::vector<Reference<TaskFuture>> const& vectorFuture ) {
	...
	return Future<Void>(new JoinActor(tr, taskBucket, taskFuture, vectorFuture));
															#line 11138 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 1101 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 11143 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via _join()
															#line 1102 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class _joinActor>
															#line 1102 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class _joinActorState {
															#line 11149 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 1102 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	_joinActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<TaskFuture> const& taskFuture,std::vector<Reference<TaskFuture>> const& vectorFuture) 
		 ...
		 : tr(tr),
		   ...
		   taskFuture(taskFuture),
															#line 1102 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   vectorFuture(vectorFuture)
															#line 11162 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 1106 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			std::vector<Future<Void>> onSetFutures;
															#line 1107 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			for(int i = 0;i < vectorFuture.size();++i) {
															#line 1108 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				Key key = StringRef(deterministicRandom()->randomUniqueID().toString());
															#line 1109 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				taskFuture->addBlock(tr, key);
															#line 1110 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				auto task = makeReference<Task>();
															#line 1111 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				task->params[Task::reservedTaskParamKeyType] = LiteralStringRef("UnblockFuture");
															#line 1112 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				task->params[Task::reservedTaskParamKeyFuture] = taskFuture->key;
															#line 1113 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				task->params[Task::reservedTaskParamKeyBlockID] = key;
															#line 1114 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				onSetFutures.push_back(vectorFuture[i]->onSet(tr, taskBucket, task));
															#line 11193 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
															#line 1117 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<_joinActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 11199 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< _joinActor, 0, Void >*>(static_cast<_joinActor*>(this)));
															#line 11204 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont1(Void const& _,int loopDepth) 
	{
															#line 1119 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<_joinActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~_joinActorState(); static_cast<_joinActor*>(this)->destroy(); return 0; }
															#line 11227 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont1(Void && _,int loopDepth) 
	{
															#line 1119 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<_joinActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~_joinActorState(); static_cast<_joinActor*>(this)->destroy(); return 0; }
															#line 11239 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<_joinActor*>(this)->SAV< Void >::value()) Void(Void());
		this->~_joinActorState();
		static_cast<_joinActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Reference<TaskFuture> taskFuture;
															#line 1102 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	std::vector<Reference<TaskFuture>> vectorFuture;
															#line 11318 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via _join()
															#line 1102 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class _joinActor final : public Actor<Void>, public ActorCallback< _joinActor, 0, Void >, public FastAllocated<_joinActor>, public _joinActorState<_joinActor> {
															#line 11323 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< _joinActor, 0, Void >;
	...
	_joinActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<TaskFuture> const& taskFuture,std::vector<Reference<TaskFuture>> const& vectorFuture) 
															#line 11334 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> _join( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket, Reference<TaskFuture> const& taskFuture, std::vector<Reference<TaskFuture>> const& vectorFuture ) {
	...
	return Future<Void>(new _joinActor(tr, taskBucket, taskFuture, vectorFuture));
															#line 11361 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 1121 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 11366 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via isSet()
															#line 1122 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class IsSetActor>
															#line 1122 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class IsSetActorState {
															#line 11372 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 1122 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	IsSetActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskFuture> const& taskFuture) 
		 ...
		 : tr(tr),
															#line 1122 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   taskFuture(taskFuture)
															#line 11381 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 1123 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskFuture->futureBucket->setOptions(tr);
															#line 1125 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<IsSetActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 11400 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< IsSetActor, 0, RangeResult >*>(static_cast<IsSetActor*>(this)));
															#line 11405 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont1(RangeResult const& values,int loopDepth) 
	{
															#line 1126 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (values.size() > 0)
															#line 11428 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 1127 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<IsSetActor*>(this)->SAV<bool>::futures) { (void)(false); this->~IsSetActorState(); static_cast<IsSetActor*>(this)->destroy(); return 0; }
															#line 11432 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<IsSetActor*>(this)->SAV< bool >::value()) bool(false);
			this->~IsSetActorState();
			static_cast<IsSetActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
		}
															#line 1129 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<IsSetActor*>(this)->SAV<bool>::futures) { (void)(true); this->~IsSetActorState(); static_cast<IsSetActor*>(this)->destroy(); return 0; }
															#line 11440 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont1(RangeResult && values,int loopDepth) 
	{
															#line 1126 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (values.size() > 0)
															#line 11452 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 1127 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (!static_cast<IsSetActor*>(this)->SAV<bool>::futures) { (void)(false); this->~IsSetActorState(); static_cast<IsSetActor*>(this)->destroy(); return 0; }
															#line 11456 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			new (&static_cast<IsSetActor*>(this)->SAV< bool >::value()) bool(false);
			this->~IsSetActorState();
			static_cast<IsSetActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
															...
															#line 1129 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<IsSetActor*>(this)->SAV<bool>::futures) { (void)(true); this->~IsSetActorState(); static_cast<IsSetActor*>(this)->destroy(); return 0; }
															#line 11464 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<IsSetActor*>(this)->SAV< bool >::value()) bool(true);
		this->~IsSetActorState();
		static_cast<IsSetActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Reference<ReadYourWritesTransaction> tr;
															#line 1122 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	Reference<TaskFuture> taskFuture;
															#line 11539 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via isSet()
															#line 1122 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class IsSetActor final : public Actor<bool>, public ActorCallback< IsSetActor, 0, RangeResult >, public FastAllocated<IsSetActor>, public IsSetActorState<IsSetActor> {
															#line 11544 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< IsSetActor, 0, RangeResult >;
	...
	IsSetActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskFuture> const& taskFuture) 
															#line 11555 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<bool>(),
...
[[nodiscard]] static Future<bool> isSet( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskFuture> const& taskFuture ) {
	...
	return Future<bool>(new IsSetActor(tr, taskFuture));
															#line 11582 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 1131 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 11587 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via onSet()
															#line 1132 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class OnSetActor>
															#line 1132 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class OnSetActorState {
															#line 11593 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 1132 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	OnSetActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<TaskFuture> const& taskFuture,Reference<Task> const& task) 
		 ...
		 : tr(tr),
		   ...
		   taskFuture(taskFuture),
															#line 1132 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   task(task)
															#line 11606 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 1136 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskFuture->futureBucket->setOptions(tr);
															#line 1138 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<bool> __when_expr_0 = isSet(tr, taskFuture);
															#line 1138 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<OnSetActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 11625 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< OnSetActor, 0, bool >*>(static_cast<OnSetActor*>(this)));
															#line 11630 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont1(bool const& is_set,int loopDepth) 
	{
															#line 1140 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (is_set)
															#line 11653 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 1141 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TEST(true);
															#line 1142 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<Void> __when_expr_1 = performAction(tr, taskBucket, taskFuture, task);
															#line 1142 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<OnSetActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 11661 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
			...
			__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< OnSetActor, 1, Void >*>(static_cast<OnSetActor*>(this)));
															#line 11666 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		else
		{
															#line 1144 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TEST(true);
															#line 1145 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			Subspace callbackSpace = taskFuture->callbacks.get(StringRef(deterministicRandom()->randomUniqueID().toString()));
															#line 1147 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			for( auto& v : task->params ) {
															#line 1148 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				tr->set(callbackSpace.pack(v.key), v.value);
															#line 11679 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
			loopDepth = a_body1cont2(loopDepth);
		}
	...
	int a_body1cont1(bool && is_set,int loopDepth) 
	{
															#line 1140 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (is_set)
															#line 11690 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 1141 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TEST(true);
															#line 1142 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<Void> __when_expr_1 = performAction(tr, taskBucket, taskFuture, task);
															#line 1142 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<OnSetActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 11698 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
			static_cast<OnSetActor*>(this)->actor_wait_state = 2;
															#line 1142 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< OnSetActor, 1, Void >*>(static_cast<OnSetActor*>(this)));
															#line 11703 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		else
		{
			...
			for( auto& v : task->params ) {
															#line 1148 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				tr->set(callbackSpace.pack(v.key), v.value);
															#line 11716 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
			loopDepth = a_body1cont2(loopDepth);
		}
	...
	int a_body1cont2(int loopDepth) 
	{
															#line 1152 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<OnSetActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~OnSetActorState(); static_cast<OnSetActor*>(this)->destroy(); return 0; }
															#line 11790 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	Reference<TaskFuture> taskFuture;
															#line 1132 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	Reference<Task> task;
															#line 11881 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via onSet()
															#line 1132 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class OnSetActor final : public Actor<Void>, public ActorCallback< OnSetActor, 0, bool >, public ActorCallback< OnSetActor, 1, Void >, public FastAllocated<OnSetActor>, public OnSetActorState<OnSetActor> {
															#line 11886 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< OnSetActor, 1, Void >;
	...
	OnSetActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<TaskFuture> const& taskFuture,Reference<Task> const& task) 
															#line 11898 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> onSet( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket, Reference<TaskFuture> const& taskFuture, Reference<Task> const& task ) {
	...
	return Future<Void>(new OnSetActor(tr, taskBucket, taskFuture, task));
															#line 11926 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 1154 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 11931 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via set()
															#line 1155 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class SetActor>
															#line 1155 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class SetActorState {
															#line 11937 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 1155 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	SetActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<TaskFuture> const& taskFuture) 
		 ...
		 : tr(tr),
		   ...
		   taskBucket(taskBucket),
															#line 1155 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   taskFuture(taskFuture)
															#line 11948 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 1158 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskFuture->futureBucket->setOptions(tr);
															#line 1160 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			tr->clear(taskFuture->blocks.range());
															#line 1162 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<SetActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 11969 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< SetActor, 0, Void >*>(static_cast<SetActor*>(this)));
															#line 11974 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont1(Void const& _,int loopDepth) 
	{
															#line 1164 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<SetActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~SetActorState(); static_cast<SetActor*>(this)->destroy(); return 0; }
															#line 11997 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont1(Void && _,int loopDepth) 
	{
															#line 1164 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<SetActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~SetActorState(); static_cast<SetActor*>(this)->destroy(); return 0; }
															#line 12009 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<SetActor*>(this)->SAV< Void >::value()) Void(Void());
		this->~SetActorState();
		static_cast<SetActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Reference<TaskBucket> taskBucket;
															#line 1155 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	Reference<TaskFuture> taskFuture;
															#line 12086 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via set()
															#line 1155 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class SetActor final : public Actor<Void>, public ActorCallback< SetActor, 0, Void >, public FastAllocated<SetActor>, public SetActorState<SetActor> {
															#line 12091 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< SetActor, 0, Void >;
	...
	SetActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<TaskFuture> const& taskFuture) 
															#line 12102 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> set( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket, Reference<TaskFuture> const& taskFuture ) {
	...
	return Future<Void>(new SetActor(tr, taskBucket, taskFuture));
															#line 12129 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 1166 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 12134 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via performAction()
															#line 1167 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class PerformActionActor>
															#line 1167 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class PerformActionActorState {
															#line 12140 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 1167 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	PerformActionActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<TaskFuture> const& taskFuture,Reference<Task> const& task) 
		 ...
		 : tr(tr),
		   ...
		   taskFuture(taskFuture),
															#line 1167 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   task(task)
															#line 12153 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 1171 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskFuture->futureBucket->setOptions(tr);
															#line 1173 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (task && TaskFuncBase::isValidTask(task))
															#line 12170 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			{
															#line 1174 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				Reference<TaskFuncBase> taskFunc = TaskFuncBase::create(task->params[Task::reservedTaskParamKeyType]);
															#line 1175 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				if (taskFunc.getPtr())
															#line 12176 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				{
															#line 1176 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
					...
					if (static_cast<PerformActionActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 12182 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
					if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
					...
					__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< PerformActionActor, 0, Void >*>(static_cast<PerformActionActor*>(this)));
															#line 12187 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
					loopDepth = 0;
				}
				else
				{
	...
	int a_body1cont1(int loopDepth) 
	{
															#line 1180 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<PerformActionActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~PerformActionActorState(); static_cast<PerformActionActor*>(this)->destroy(); return 0; }
															#line 12220 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	Reference<TaskFuture> taskFuture;
															#line 1167 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	Reference<Task> task;
															#line 12317 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via performAction()
															#line 1167 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class PerformActionActor final : public Actor<Void>, public ActorCallback< PerformActionActor, 0, Void >, public FastAllocated<PerformActionActor>, public PerformActionActorState<PerformActionActor> {
															#line 12322 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< PerformActionActor, 0, Void >;
	...
	PerformActionActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<TaskFuture> const& taskFuture,Reference<Task> const& task) 
															#line 12333 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> performAction( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket, Reference<TaskFuture> const& taskFuture, Reference<Task> const& task ) {
	...
	return Future<Void>(new PerformActionActor(tr, taskBucket, taskFuture, task));
															#line 12360 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 1182 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 12365 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via performAllActions()
															#line 1183 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class PerformAllActionsActor>
															#line 1183 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class PerformAllActionsActorState {
															#line 12371 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 1183 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	PerformAllActionsActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<TaskFuture> const& taskFuture) 
		 ...
		 : tr(tr),
		   ...
		   taskBucket(taskBucket),
															#line 1183 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   taskFuture(taskFuture)
															#line 12382 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 1186 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskFuture->futureBucket->setOptions(tr);
															#line 1188 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<PerformAllActionsActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 12401 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< PerformAllActionsActor, 0, RangeResult >*>(static_cast<PerformAllActionsActor*>(this)));
															#line 12406 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont1(RangeResult const& values,int loopDepth) 
	{
															#line 1189 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		tr->clear(taskFuture->callbacks.range());
															#line 1191 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		std::vector<Future<Void>> actions;
															#line 1193 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (values.size() != 0)
															#line 12433 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 1194 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			task = Reference<Task>(new Task());
															#line 1195 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			Key lastTaskID;
															#line 1196 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			for( auto& s : values ) {
															#line 1197 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				Tuple t = taskFuture->callbacks.unpack(s.key);
															#line 1198 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				Key taskID = t.getString(0);
															#line 1199 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				Key key = t.getString(1);
															#line 1202 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				if (taskID.size() != 0 && taskID != lastTaskID)
															#line 12449 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				{
															#line 1203 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
					actions.push_back(performAction(tr, taskBucket, taskFuture, task));
															#line 1204 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
					task = makeReference<Task>();
															#line 12455 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				}
															#line 1206 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				task->params[key] = s.value;
															#line 1207 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				lastTaskID = taskID;
															#line 12461 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
															#line 1210 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			actions.push_back(performAction(tr, taskBucket, taskFuture, task));
															#line 12465 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
															#line 1213 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		StrictFuture<Void> __when_expr_1 = waitForAll(actions);
															#line 1213 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<PerformAllActionsActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 12471 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< PerformAllActionsActor, 1, Void >*>(static_cast<PerformAllActionsActor*>(this)));
															#line 12476 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1cont1(RangeResult && values,int loopDepth) 
	{
		...
		std::vector<Future<Void>> actions;
															#line 1193 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (values.size() != 0)
															#line 12489 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 1194 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			task = Reference<Task>(new Task());
															#line 1195 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			for( auto& s : values ) {
				...
				Key key = t.getString(1);
															#line 1202 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				if (taskID.size() != 0 && taskID != lastTaskID)
															#line 12505 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				{
															#line 1203 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
					actions.push_back(performAction(tr, taskBucket, taskFuture, task));
															#line 1204 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
					task = makeReference<Task>();
															#line 12511 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
				}
															#line 1206 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				task->params[key] = s.value;
															#line 1207 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
				lastTaskID = taskID;
															#line 12517 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			}
															#line 1210 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			actions.push_back(performAction(tr, taskBucket, taskFuture, task));
															#line 12521 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
															#line 1213 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		StrictFuture<Void> __when_expr_1 = waitForAll(actions);
															#line 1213 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<PerformAllActionsActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 12527 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		static_cast<PerformAllActionsActor*>(this)->actor_wait_state = 2;
															#line 1213 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< PerformAllActionsActor, 1, Void >*>(static_cast<PerformAllActionsActor*>(this)));
															#line 12532 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1cont2(Void const& _,int loopDepth) 
	{
															#line 1215 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<PerformAllActionsActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~PerformAllActionsActorState(); static_cast<PerformAllActionsActor*>(this)->destroy(); return 0; }
															#line 12604 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont2(Void && _,int loopDepth) 
	{
															#line 1215 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<PerformAllActionsActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~PerformAllActionsActorState(); static_cast<PerformAllActionsActor*>(this)->destroy(); return 0; }
															#line 12616 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<PerformAllActionsActor*>(this)->SAV< Void >::value()) Void(Void());
		this->~PerformAllActionsActorState();
		static_cast<PerformAllActionsActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Reference<TaskFuture> taskFuture;
															#line 1194 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	Reference<Task> task;
															#line 12695 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via performAllActions()
															#line 1183 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class PerformAllActionsActor final : public Actor<Void>, public ActorCallback< PerformAllActionsActor, 0, RangeResult >, public ActorCallback< PerformAllActionsActor, 1, Void >, public FastAllocated<PerformAllActionsActor>, public PerformAllActionsActorState<PerformAllActionsActor> {
															#line 12700 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< PerformAllActionsActor, 1, Void >;
	...
	PerformAllActionsActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<TaskFuture> const& taskFuture) 
															#line 12712 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> performAllActions( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket, Reference<TaskFuture> const& taskFuture ) {
	...
	return Future<Void>(new PerformAllActionsActor(tr, taskBucket, taskFuture));
															#line 12740 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 1217 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 12745 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via onSetAddTask()
															#line 1218 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class OnSetAddTaskActor>
															#line 1218 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class OnSetAddTaskActorState {
															#line 12751 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 1218 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	OnSetAddTaskActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<TaskFuture> const& taskFuture,Reference<Task> const& task) 
		 ...
		 : tr(tr),
		   ...
		   taskFuture(taskFuture),
															#line 1218 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   task(task)
															#line 12764 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 1222 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskFuture->futureBucket->setOptions(tr);
															#line 1224 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			task->params[Task::reservedTaskParamKeyAddTask] = task->params[Task::reservedTaskParamKeyType];
															#line 1225 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			task->params[Task::reservedTaskParamKeyType] = LiteralStringRef("AddTask");
															#line 1226 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<OnSetAddTaskActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 12787 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< OnSetAddTaskActor, 0, Void >*>(static_cast<OnSetAddTaskActor*>(this)));
															#line 12792 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont1(Void const& _,int loopDepth) 
	{
															#line 1228 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<OnSetAddTaskActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~OnSetAddTaskActorState(); static_cast<OnSetAddTaskActor*>(this)->destroy(); return 0; }
															#line 12815 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont1(Void && _,int loopDepth) 
	{
															#line 1228 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<OnSetAddTaskActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~OnSetAddTaskActorState(); static_cast<OnSetAddTaskActor*>(this)->destroy(); return 0; }
															#line 12827 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<OnSetAddTaskActor*>(this)->SAV< Void >::value()) Void(Void());
		this->~OnSetAddTaskActorState();
		static_cast<OnSetAddTaskActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Reference<TaskFuture> taskFuture;
															#line 1218 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	Reference<Task> task;
															#line 12906 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via onSetAddTask()
															#line 1218 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class OnSetAddTaskActor final : public Actor<Void>, public ActorCallback< OnSetAddTaskActor, 0, Void >, public FastAllocated<OnSetAddTaskActor>, public OnSetAddTaskActorState<OnSetAddTaskActor> {
															#line 12911 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< OnSetAddTaskActor, 0, Void >;
	...
	OnSetAddTaskActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<TaskFuture> const& taskFuture,Reference<Task> const& task) 
															#line 12922 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> onSetAddTask( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket, Reference<TaskFuture> const& taskFuture, Reference<Task> const& task ) {
	...
	return Future<Void>(new OnSetAddTaskActor(tr, taskBucket, taskFuture, task));
															#line 12949 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 1230 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"

																#line 12954 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via onSetAddTask()
															#line 1231 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class OnSetAddTaskActor1>
															#line 1231 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class OnSetAddTaskActor1State {
															#line 12960 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 1231 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	OnSetAddTaskActor1State(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<TaskFuture> const& taskFuture,Reference<Task> const& task,KeyRef const& validationKey) 
		 ...
		 : tr(tr),
		   ...
		   task(task),
															#line 1231 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   validationKey(validationKey)
															#line 12975 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
		fdb_probe_actor_create("onSetAddTask", reinterpret_cast<unsigned long>(this));
	...
	{
		try {
															#line 1236 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskFuture->futureBucket->setOptions(tr);
															#line 1238 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			StrictFuture<Optional<Value>> __when_expr_0 = tr->get(validationKey);
															#line 1238 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			if (static_cast<OnSetAddTaskActor1*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 12994 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< OnSetAddTaskActor1, 0, Optional<Value> >*>(static_cast<OnSetAddTaskActor1*>(this)));
															#line 12999 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont1(Optional<Value> const& validationValue,int loopDepth) 
	{
															#line 1240 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!validationValue.present())
															#line 13022 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 1241 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TraceEvent(SevError, "TaskBucketOnSetAddTaskInvalidKey") .detail("Task", task->params[Task::reservedTaskParamKeyType]) .detail("ValidationKey", validationKey);
															#line 1244 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			return a_body1Catch1(invalid_option_value(), loopDepth);
															#line 13028 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
															#line 1247 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		task->params[Task::reservedTaskParamValidKey] = validationKey;
															#line 1248 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		task->params[Task::reservedTaskParamValidValue] = validationValue.get();
															#line 1250 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		StrictFuture<Void> __when_expr_1 = onSetAddTask(tr, taskBucket, taskFuture, task);
															#line 1250 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<OnSetAddTaskActor1*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 13038 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< OnSetAddTaskActor1, 1, Void >*>(static_cast<OnSetAddTaskActor1*>(this)));
															#line 13043 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1cont1(Optional<Value> && validationValue,int loopDepth) 
	{
															#line 1240 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!validationValue.present())
															#line 13052 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		{
															#line 1241 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			TraceEvent(SevError, "TaskBucketOnSetAddTaskInvalidKey") .detail("Task", task->params[Task::reservedTaskParamKeyType]) .detail("ValidationKey", validationKey);
															#line 1244 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			return a_body1Catch1(invalid_option_value(), loopDepth);
															#line 13058 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		}
															#line 1247 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		task->params[Task::reservedTaskParamValidKey] = validationKey;
															#line 1248 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		...
		StrictFuture<Void> __when_expr_1 = onSetAddTask(tr, taskBucket, taskFuture, task);
															#line 1250 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (static_cast<OnSetAddTaskActor1*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 13068 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		static_cast<OnSetAddTaskActor1*>(this)->actor_wait_state = 2;
															#line 1250 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< OnSetAddTaskActor1, 1, Void >*>(static_cast<OnSetAddTaskActor1*>(this)));
															#line 13073 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1cont2(Void const& _,int loopDepth) 
	{
															#line 1252 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<OnSetAddTaskActor1*>(this)->SAV<Void>::futures) { (void)(Void()); this->~OnSetAddTaskActor1State(); static_cast<OnSetAddTaskActor1*>(this)->destroy(); return 0; }
															#line 13145 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont2(Void && _,int loopDepth) 
	{
															#line 1252 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<OnSetAddTaskActor1*>(this)->SAV<Void>::futures) { (void)(Void()); this->~OnSetAddTaskActor1State(); static_cast<OnSetAddTaskActor1*>(this)->destroy(); return 0; }
															#line 13157 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<OnSetAddTaskActor1*>(this)->SAV< Void >::value()) Void(Void());
		this->~OnSetAddTaskActor1State();
		static_cast<OnSetAddTaskActor1*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Reference<Task> task;
															#line 1231 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	KeyRef validationKey;
															#line 13238 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via onSetAddTask()
															#line 1231 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class OnSetAddTaskActor1 final : public Actor<Void>, public ActorCallback< OnSetAddTaskActor1, 0, Optional<Value> >, public ActorCallback< OnSetAddTaskActor1, 1, Void >, public FastAllocated<OnSetAddTaskActor1>, public OnSetAddTaskActor1State<OnSetAddTaskActor1> {
															#line 13243 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< OnSetAddTaskActor1, 1, Void >;
	...
	OnSetAddTaskActor1(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<TaskFuture> const& taskFuture,Reference<Task> const& task,KeyRef const& validationKey) 
															#line 13255 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> onSetAddTask( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket, Reference<TaskFuture> const& taskFuture, Reference<Task> const& task, KeyRef const& validationKey ) {
	...
	return Future<Void>(new OnSetAddTaskActor1(tr, taskBucket, taskFuture, task, validationKey));
															#line 13283 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 1254 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	...
	static Future<Void> onSetAddTask(Reference<ReadYourWritesTransaction> tr,
		...
		return onSetAddTask(tr, taskBucket, taskFuture, task);
																...
																#line 13302 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
// This generated class is to be used only via joinedFuture()
															#line 1269 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class JoinedFutureActor>
															#line 1269 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class JoinedFutureActorState {
															#line 13308 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 1269 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	JoinedFutureActorState(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<TaskFuture> const& taskFuture) 
		 ...
		 : tr(tr),
		   ...
		   taskBucket(taskBucket),
															#line 1269 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   taskFuture(taskFuture)
															#line 13319 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 1272 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			taskFuture->futureBucket->setOptions(tr);
															#line 1274 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			std::vector<Reference<TaskFuture>> vectorFuture;
															#line 1275 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			future = taskFuture->futureBucket->future(tr);
															#line 1276 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			vectorFuture.push_back(future);
															#line 1277 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<JoinedFutureActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 13344 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< JoinedFutureActor, 0, Void >*>(static_cast<JoinedFutureActor*>(this)));
															#line 13349 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont1(Void const& _,int loopDepth) 
	{
															#line 1278 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<JoinedFutureActor*>(this)->SAV<Reference<TaskFuture>>::futures) { (void)(future); this->~JoinedFutureActorState(); static_cast<JoinedFutureActor*>(this)->destroy(); return 0; }
															#line 13372 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont1(Void && _,int loopDepth) 
	{
															#line 1278 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<JoinedFutureActor*>(this)->SAV<Reference<TaskFuture>>::futures) { (void)(future); this->~JoinedFutureActorState(); static_cast<JoinedFutureActor*>(this)->destroy(); return 0; }
															#line 13384 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<JoinedFutureActor*>(this)->SAV< Reference<TaskFuture> >::value()) Reference<TaskFuture>(std::move(future)); // state_var_RVO
		this->~JoinedFutureActorState();
		static_cast<JoinedFutureActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Reference<TaskFuture> taskFuture;
															#line 1275 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	Reference<TaskFuture> future;
															#line 13463 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via joinedFuture()
															#line 1269 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class JoinedFutureActor final : public Actor<Reference<TaskFuture>>, public ActorCallback< JoinedFutureActor, 0, Void >, public FastAllocated<JoinedFutureActor>, public JoinedFutureActorState<JoinedFutureActor> {
															#line 13468 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< JoinedFutureActor, 0, Void >;
	...
	JoinedFutureActor(Reference<ReadYourWritesTransaction> const& tr,Reference<TaskBucket> const& taskBucket,Reference<TaskFuture> const& taskFuture) 
															#line 13479 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
...
[[nodiscard]] static Future<Reference<TaskFuture>> joinedFuture( Reference<ReadYourWritesTransaction> const& tr, Reference<TaskBucket> const& taskBucket, Reference<TaskFuture> const& taskFuture ) {
	...
	return Future<Reference<TaskFuture>>(new JoinedFutureActor(tr, taskBucket, taskFuture));
															#line 13506 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 1280 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
};
...
Future<Reference<TaskFuture>> TaskFuture::joinedFuture(Reference<ReadYourWritesTransaction> tr,
	...
	return TaskFutureImpl::joinedFuture(tr, taskBucket, Reference<TaskFuture>::addRef(this));
															...
															#line 13581 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
namespace {
// This generated class is to be used only via getCompletionKey()
															#line 1351 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
template <class GetCompletionKeyActor>
															#line 1351 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class GetCompletionKeyActorState {
															#line 13588 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
															#line 1351 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
	GetCompletionKeyActorState(TaskCompletionKey* const& self,Future<Reference<TaskFuture>> const& f) 
		 ...
		 : self(self),
															#line 1351 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		   f(f)
															#line 13597 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	{
	...
	{
		try {
															#line 1352 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
			...
			if (static_cast<GetCompletionKeyActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 13614 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< GetCompletionKeyActor, 0, Reference<TaskFuture> >*>(static_cast<GetCompletionKeyActor*>(this)));
															#line 13619 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	{
															#line 1353 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		self->joinFuture.clear();
															#line 1354 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		self->key = taskFuture->key;
															#line 1355 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<GetCompletionKeyActor*>(this)->SAV<Key>::futures) { (void)(self->key.get()); this->~GetCompletionKeyActorState(); static_cast<GetCompletionKeyActor*>(this)->destroy(); return 0; }
															#line 13646 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
	...
	int a_body1cont1(Reference<TaskFuture> && taskFuture,int loopDepth) 
	{
		...
		self->key = taskFuture->key;
															#line 1355 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
		if (!static_cast<GetCompletionKeyActor*>(this)->SAV<Key>::futures) { (void)(self->key.get()); this->~GetCompletionKeyActorState(); static_cast<GetCompletionKeyActor*>(this)->destroy(); return 0; }
															#line 13662 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		new (&static_cast<GetCompletionKeyActor*>(this)->SAV< Key >::value()) Key(self->key.get());
		this->~GetCompletionKeyActorState();
		static_cast<GetCompletionKeyActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Future<Reference<TaskFuture>> f;
															#line 13737 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
};
// This generated class is to be used only via getCompletionKey()
															#line 1351 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
class GetCompletionKeyActor final : public Actor<Key>, public ActorCallback< GetCompletionKeyActor, 0, Reference<TaskFuture> >, public FastAllocated<GetCompletionKeyActor>, public GetCompletionKeyActorState<GetCompletionKeyActor> {
															#line 13742 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
public:
...
friend struct ActorCallback< GetCompletionKeyActor, 0, Reference<TaskFuture> >;
	...
	GetCompletionKeyActor(TaskCompletionKey* const& self,Future<Reference<TaskFuture>> const& f) 
															#line 13753 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
		 : Actor<Key>(),
...
[[nodiscard]] Future<Key> getCompletionKey( TaskCompletionKey* const& self, Future<Reference<TaskFuture>> const& f ) {
	...
	return Future<Key>(new GetCompletionKeyActor(self, f));
															#line 13781 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.g.cpp"
}

#line 1357 "/usr/src/libfdb_c/fdbclient/TaskBucket.actor.cpp"
