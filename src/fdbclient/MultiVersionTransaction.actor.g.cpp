...
public:
	...
	{
		fdb_probe_actor_destroy("timeoutImpl", reinterpret_cast<unsigned long>(this));
	...
	int a_body1Catch1(Error error,int loopDepth=0) 
	{
		...
		static_cast<TimeoutImplActor*>(this)->sendErrorAndDelPromiseRef(error);
		loopDepth = 0;
	...
	void a_exitChoose1() 
	{
		if (static_cast<TimeoutImplActor*>(this)->actor_wait_state > 0) static_cast<TimeoutImplActor*>(this)->actor_wait_state = 0;
		static_cast<TimeoutImplActor*>(this)->ActorCallback< TimeoutImplActor, 0, Void >::remove();

	}
	void a_callback_fire(ActorCallback< TimeoutImplActor, 0, Void >*,Void const& value) 
	{
	...
	void a_callback_fire(ActorCallback< TimeoutImplActor, 0, Void >*,Void && value) 
	{
		fdb_probe_actor_enter("timeoutImpl", reinterpret_cast<unsigned long>(this), 0);
		a_exitChoose1();
		try {
	...
	void a_callback_error(ActorCallback< TimeoutImplActor, 0, Void >*,Error err) 
	{
		fdb_probe_actor_enter("timeoutImpl", reinterpret_cast<unsigned long>(this), 0);
		a_exitChoose1();
		try {
...
friend struct ActorCallback< TimeoutImplActor, 0, Void >;
	...
	{
		fdb_probe_actor_enter("timeoutImpl", reinterpret_cast<unsigned long>(this), -1);
		#ifdef ENABLE_SAMPLING
		this->lineage.setActorName("timeoutImpl");
		LineageScope _(&this->lineage);
		#endif
		this->a_body1();
		fdb_probe_actor_exit("timeoutImpl", reinterpret_cast<unsigned long>(this), -1);
	...
	void cancel() override
	{
		...
		switch (wait_state) {
		case 1: this->a_callback_error((ActorCallback< TimeoutImplActor, 0, Void >*)0, actor_cancelled()); break;
		}
...
public:
	...
	{
		fdb_probe_actor_destroy("checkUndestroyedFutures", reinterpret_cast<unsigned long>(this));
	...
	int a_body1Catch1(Error error,int loopDepth=0) 
	{
		...
		static_cast<CheckUndestroyedFuturesActor*>(this)->sendErrorAndDelPromiseRef(error);
		loopDepth = 0;
	...
	void a_exitChoose1() 
	{
		if (static_cast<CheckUndestroyedFuturesActor*>(this)->actor_wait_state > 0) static_cast<CheckUndestroyedFuturesActor*>(this)->actor_wait_state = 0;
		static_cast<CheckUndestroyedFuturesActor*>(this)->ActorCallback< CheckUndestroyedFuturesActor, 0, Void >::remove();

	}
	void a_callback_fire(ActorCallback< CheckUndestroyedFuturesActor, 0, Void >*,Void const& value) 
	{
		fdb_probe_actor_enter("checkUndestroyedFutures", reinterpret_cast<unsigned long>(this), 0);
		a_exitChoose1();
		try {
		...
		fdb_probe_actor_exit("checkUndestroyedFutures", reinterpret_cast<unsigned long>(this), 0);

	}
	void a_callback_fire(ActorCallback< CheckUndestroyedFuturesActor, 0, Void >*,Void && value) 
	{
		fdb_probe_actor_enter("checkUndestroyedFutures", reinterpret_cast<unsigned long>(this), 0);
		a_exitChoose1();
		try {
	...
	void a_callback_error(ActorCallback< CheckUndestroyedFuturesActor, 0, Void >*,Error err) 
	{
		fdb_probe_actor_enter("checkUndestroyedFutures", reinterpret_cast<unsigned long>(this), 0);
		a_exitChoose1();
		try {
	...
	{
		if (static_cast<CheckUndestroyedFuturesActor*>(this)->actor_wait_state > 0) static_cast<CheckUndestroyedFuturesActor*>(this)->actor_wait_state = 0;
		static_cast<CheckUndestroyedFuturesActor*>(this)->ActorCallback< CheckUndestroyedFuturesActor, 1, Void >::remove();

	}
	void a_callback_fire(ActorCallback< CheckUndestroyedFuturesActor, 1, Void >*,Void const& value) 
	{
		fdb_probe_actor_enter("checkUndestroyedFutures", reinterpret_cast<unsigned long>(this), 1);
		a_exitChoose2();
		try {
	...
	void a_callback_fire(ActorCallback< CheckUndestroyedFuturesActor, 1, Void >*,Void && value) 
	{
		fdb_probe_actor_enter("checkUndestroyedFutures", reinterpret_cast<unsigned long>(this), 1);
		a_exitChoose2();
		try {
	...
	void a_callback_error(ActorCallback< CheckUndestroyedFuturesActor, 1, Void >*,Error err) 
	{
		fdb_probe_actor_enter("checkUndestroyedFutures", reinterpret_cast<unsigned long>(this), 1);
		a_exitChoose2();
		try {
...
friend struct ActorCallback< CheckUndestroyedFuturesActor, 1, Void >;
		   ...
		   CheckUndestroyedFuturesActorState<CheckUndestroyedFuturesActor>(undestroyed)
	{
		fdb_probe_actor_enter("checkUndestroyedFutures", reinterpret_cast<unsigned long>(this), -1);
		#ifdef ENABLE_SAMPLING
		this->lineage.setActorName("checkUndestroyedFutures");
		LineageScope _(&this->lineage);
		#endif
		this->a_body1();
		fdb_probe_actor_exit("checkUndestroyedFutures", reinterpret_cast<unsigned long>(this), -1);
	...
	void cancel() override
	{
		...
		this->actor_wait_state = -1;
		switch (wait_state) {
		case 1: this->a_callback_error((ActorCallback< CheckUndestroyedFuturesActor, 0, Void >*)0, actor_cancelled()); break;
		case 2: this->a_callback_error((ActorCallback< CheckUndestroyedFuturesActor, 1, Void >*)0, actor_cancelled()); break;
		}
