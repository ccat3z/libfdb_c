...
#line 1 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
/*
...
Future<int> AsyncFileS3BlobStoreRead::read(void* data, int length, int64_t offset) {
	return m_bstore->readObject(m_bucket, m_object, data, length, offset);
															...
															#line 38 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
namespace {
// This generated class is to be used only via sendStuff()
															#line 36 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
template <class SendStuffActor>
															#line 36 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
class SendStuffActorState {
															#line 45 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
public:
															#line 36 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
	SendStuffActorState(int const& id,Reference<IRateControl> const& t,int const& bytes) 
		 ...
		 : id(id),
		   ...
		   t(t),
															#line 36 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
		   bytes(bytes)
															#line 56 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
	{
	...
	{
		try {
															#line 37 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			printf("Starting fake sender %d which will send send %d bytes.\n", id, bytes);
															#line 38 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			ts = timer();
															#line 39 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			total = 0;
															#line 40 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			;
															#line 77 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
	...
	{
															#line 45 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
		double dur = timer() - ts;
															#line 46 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
		printf("Sender %d: Sent %d in %fs, %f/s\n", id, total, dur, total / dur);
															#line 47 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
		if (!static_cast<SendStuffActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~SendStuffActorState(); static_cast<SendStuffActor*>(this)->destroy(); return 0; }
															#line 104 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
	...
	int a_body1loopBody1(int loopDepth) 
	{
															#line 40 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
		if (!(total < bytes))
															#line 123 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
		{
			return a_body1break1(loopDepth==0?0:loopDepth-1); // break
		}
															#line 41 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
		r = std::min<int>(deterministicRandom()->randomInt(0, 1000), bytes - total);
															#line 42 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
		...
		if (static_cast<SendStuffActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), std::max(0, loopDepth - 1));
															#line 133 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
		...
		__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< SendStuffActor, 0, Void >*>(static_cast<SendStuffActor*>(this)));
															#line 138 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
		loopDepth = 0;
	...
	{
															#line 43 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
		total += r;
															#line 160 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
	...
	int a_body1loopBody1cont1(Void && _,int loopDepth) 
	{
															#line 43 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
		total += r;
															#line 169 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
		if (loopDepth == 0) return a_body1loopHead1(0);
	...
	int total;
															#line 41 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
	int r;
															#line 249 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
};
// This generated class is to be used only via sendStuff()
															#line 36 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
class SendStuffActor final : public Actor<Void>, public ActorCallback< SendStuffActor, 0, Void >, public FastAllocated<SendStuffActor>, public SendStuffActorState<SendStuffActor> {
															#line 254 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
public:
...
friend struct ActorCallback< SendStuffActor, 0, Void >;
	...
	SendStuffActor(int const& id,Reference<IRateControl> const& t,int const& bytes) 
															#line 265 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] Future<Void> sendStuff( int const& id, Reference<IRateControl> const& t, int const& bytes ) {
	...
	return Future<Void>(new SendStuffActor(id, t, bytes));
															#line 293 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
}

#line 49 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"

															#line 298 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
namespace {
// This generated class is to be used only via flowTestCase50()
															#line 50 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
template <class FlowTestCase50Actor>
															#line 50 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
class FlowTestCase50ActorState {
															#line 305 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
public:
															#line 50 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
	FlowTestCase50ActorState(UnitTestParameters const& params) 
															...
															#line 50 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
		 : params(params)
															#line 312 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
	{
	...
	{
		try {
															#line 52 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			if (g_network->isSimulated())
															#line 327 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
			{
															#line 53 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
				if (!static_cast<FlowTestCase50Actor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~FlowTestCase50ActorState(); static_cast<FlowTestCase50Actor*>(this)->destroy(); return 0; }
															#line 331 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
				...
				return 0;
															...
															#line 55 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			limit = 100000;
															#line 56 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			t = Reference<IRateControl>(new SpeedLimit(limit, 1));
															#line 58 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			id = 1;
															#line 59 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			std::vector<Future<Void>> f;
															#line 60 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			ts = timer();
															#line 61 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			total = 0;
															#line 62 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			int s;
															#line 63 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			s = 500000;
															#line 64 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			f.push_back(sendStuff(id++, t, s));
															#line 65 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			total += s;
															#line 66 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			f.push_back(sendStuff(id++, t, s));
															#line 67 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			total += s;
															#line 68 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			s = 50000;
															#line 69 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			f.push_back(sendStuff(id++, t, s));
															#line 70 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			total += s;
															#line 71 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			f.push_back(sendStuff(id++, t, s));
															#line 72 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			total += s;
															#line 73 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			s = 5000;
															#line 74 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			f.push_back(sendStuff(id++, t, s));
															#line 75 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			total += s;
															#line 77 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
			...
			if (static_cast<FlowTestCase50Actor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 381 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< FlowTestCase50Actor, 0, Void >*>(static_cast<FlowTestCase50Actor*>(this)));
															#line 386 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	{
															#line 78 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
		double dur = timer() - ts;
															#line 79 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
		int speed = int(total / dur);
															#line 80 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
		printf("Speed limit was %d, measured speed was %d\n", limit, speed);
															#line 81 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
		ASSERT(abs(speed - limit) / limit < .01);
															#line 83 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
		if (!static_cast<FlowTestCase50Actor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~FlowTestCase50ActorState(); static_cast<FlowTestCase50Actor*>(this)->destroy(); return 0; }
															#line 417 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
		new (&static_cast<FlowTestCase50Actor*>(this)->SAV< Void >::value()) Void(Void());
		this->~FlowTestCase50ActorState();
		static_cast<FlowTestCase50Actor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	int a_body1cont1(Void && _,int loopDepth) 
	{
		...
		ASSERT(abs(speed - limit) / limit < .01);
															#line 83 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
		if (!static_cast<FlowTestCase50Actor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~FlowTestCase50ActorState(); static_cast<FlowTestCase50Actor*>(this)->destroy(); return 0; }
															#line 437 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
		new (&static_cast<FlowTestCase50Actor*>(this)->SAV< Void >::value()) Void(Void());
		this->~FlowTestCase50ActorState();
		static_cast<FlowTestCase50Actor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	double ts;
															#line 61 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
	int total;
															#line 520 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
};
// This generated class is to be used only via flowTestCase50()
															#line 50 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
class FlowTestCase50Actor final : public Actor<Void>, public ActorCallback< FlowTestCase50Actor, 0, Void >, public FastAllocated<FlowTestCase50Actor>, public FlowTestCase50ActorState<FlowTestCase50Actor> {
															#line 525 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
public:
...
friend struct ActorCallback< FlowTestCase50Actor, 0, Void >;
	...
	FlowTestCase50Actor(UnitTestParameters const& params) 
															#line 536 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
		 : Actor<Void>(),
...
static Future<Void> flowTestCase50( UnitTestParameters const& params ) {
	...
	return Future<Void>(new FlowTestCase50Actor(params));
															#line 564 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.g.cpp"
}
ACTOR_TEST_CASE(flowTestCase50, "/backup/throttling")

#line 85 "/usr/src/libfdb_c/fdbclient/AsyncFileS3BlobStore.actor.cpp"
