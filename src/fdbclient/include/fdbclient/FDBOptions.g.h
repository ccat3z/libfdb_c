...
struct FDBNetworkOptions {
	friend class FDBOptionInfoMap<FDBNetworkOptions>;
	...
	static FDBOptionInfoMap<FDBNetworkOptions> optionInfo;

private:
	static void init();
};

struct FDBDatabaseOptions {
	friend class FDBOptionInfoMap<FDBDatabaseOptions>;
	...
	static FDBOptionInfoMap<FDBDatabaseOptions> optionInfo;

private:
	static void init();
};

struct FDBTransactionOptions {
	friend class FDBOptionInfoMap<FDBTransactionOptions>;
	...
	static FDBOptionInfoMap<FDBTransactionOptions> optionInfo;

private:
	static void init();
};

struct FDBStreamingModes {
	friend class FDBOptionInfoMap<FDBStreamingModes>;
	...
	static FDBOptionInfoMap<FDBStreamingModes> optionInfo;

private:
	static void init();
};

struct FDBMutationTypes {
	friend class FDBOptionInfoMap<FDBMutationTypes>;
	...
	static FDBOptionInfoMap<FDBMutationTypes> optionInfo;

private:
	static void init();
};

struct FDBConflictRangeTypes {
	friend class FDBOptionInfoMap<FDBConflictRangeTypes>;
	...
	static FDBOptionInfoMap<FDBConflictRangeTypes> optionInfo;

private:
	static void init();
};

struct FDBErrorPredicates {
	friend class FDBOptionInfoMap<FDBErrorPredicates>;
	...
	static FDBOptionInfoMap<FDBErrorPredicates> optionInfo;
