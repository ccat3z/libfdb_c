...
#line 1 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.h"
/*
...
public:
	...
	Future<Void> getNext(Database cx);
																#line 73 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.g.h"
...
#line 72 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.h"
		...
		if (pipelineDepth > 0) {
			for (int h = 0; h < 256; ++h) {
				...
				pipelinedReaders[h]->startReading(cx);
																...
																#line 118 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.g.h"
// This generated class is to be used only via Create()
															#line 112 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.h"
template <class CreateActor>
															#line 112 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.h"
class CreateActorState {
															#line 124 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.g.h"
public:
															#line 112 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.h"
	CreateActorState(Database const& cx,Version const& bv,Version const& ev,Key const& uid,Key const& beginKey,unsigned const& pd) 
		 ...
		 : cx(cx),
		   ...
		   beginKey(beginKey),
															#line 112 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.h"
		   pd(pd),
															#line 118 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.h"
		   self(new MutationLogReader(cx, bv, ev, uid, beginKey, pd))
															#line 143 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.g.h"
	{
	...
	{
		try {
															#line 119 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.h"
			...
			if (static_cast<CreateActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 160 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.g.h"
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< CreateActor, 0, Void >*>(static_cast<CreateActor*>(this)));
															#line 165 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.g.h"
			loopDepth = 0;
		}
		catch (Error& error) {
	...
	{
															#line 120 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.h"
		if (!static_cast<CreateActor*>(this)->SAV<Reference<MutationLogReader>>::futures) { (void)(self); this->~CreateActorState(); static_cast<CreateActor*>(this)->destroy(); return 0; }
															#line 188 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.g.h"
	...
	int a_body1cont1(Void && _,int loopDepth) 
	{
															#line 120 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.h"
		if (!static_cast<CreateActor*>(this)->SAV<Reference<MutationLogReader>>::futures) { (void)(self); this->~CreateActorState(); static_cast<CreateActor*>(this)->destroy(); return 0; }
															#line 200 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.g.h"
		new (&static_cast<CreateActor*>(this)->SAV< Reference<MutationLogReader> >::value()) Reference<MutationLogReader>(std::move(self)); // state_var_RVO
		this->~CreateActorState();
		static_cast<CreateActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Reference<MutationLogReader> self;
															#line 285 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.g.h"
};
// This generated class is to be used only via Create()
															#line 112 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.h"
class CreateActor final : public Actor<Reference<MutationLogReader>>, public ActorCallback< CreateActor, 0, Void >, public FastAllocated<CreateActor>, public CreateActorState<CreateActor> {
															#line 290 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.g.h"
public:
...
friend struct ActorCallback< CreateActor, 0, Void >;
	...
	CreateActor(Database const& cx,Version const& bv,Version const& ev,Key const& uid,Key const& beginKey,unsigned const& pd) 
															#line 301 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.g.h"
...
[[nodiscard]] static Future<Reference<MutationLogReader>> Create( Database const& cx, Version const& bv, Version const& ev, Key const& uid, Key const& beginKey, unsigned const& pd ) {
	...
	return Future<Reference<MutationLogReader>>(new CreateActor(cx, bv, ev, uid, beginKey, pd));
															#line 328 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.g.h"
}

#line 122 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.h"

	Future<Standalone<RangeResultRef>> getNext();

private:
																#line 336 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.g.h"
...
#line 127 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.h"
																#line 341 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.g.h"
...
#line 128 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbclient/include/fdbclient/MutationLogReader.actor.h"
