...
#line 1 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
/*
		...
		if (successful >= ctis.size() / 2 + 1 && result.canBeSet()) {
			...
			if ((failed + totalRequestsOutstanding < ctis.size() / 2 + 1) &&
				...
				local.sendError(commit_unknown_result());
																...
																#line 65 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
// This generated class is to be used only via addRequestActor()
															#line 63 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
template <class AddRequestActorActor>
															#line 63 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
class AddRequestActorActorState {
															#line 71 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
public:
															#line 63 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
	AddRequestActorActorState(CommitQuorum* const& self,ConfigGeneration const& generation,ConfigTransactionInterface const& cti) 
		 ...
		 : self(self),
		   ...
		   generation(generation),
															#line 63 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		   cti(cti)
															#line 82 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	{
	...
	int a_body1(int loopDepth=0) 
	{
		try {
			try {
															#line 67 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
				if (cti.hostname.present())
															#line 98 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
				{
															#line 68 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
					...
					if (static_cast<AddRequestActorActor*>(this)->actor_wait_state < 0) return a_body1Catch2(actor_cancelled(), loopDepth);
															#line 104 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
					...
					__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< AddRequestActorActor, 0, Void >*>(static_cast<AddRequestActorActor*>(this)));
															#line 109 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
					loopDepth = 0;
				}
				else
				{
															#line 72 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
					StrictFuture<Void> __when_expr_1 = timeoutError(cti.commit.getReply(self->getCommitRequest(generation)), CLIENT_KNOBS->COMMIT_QUORUM_TIMEOUT);
															#line 72 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
					if (static_cast<AddRequestActorActor*>(this)->actor_wait_state < 0) return a_body1Catch2(actor_cancelled(), loopDepth);
															#line 118 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
					...
					__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< AddRequestActorActor, 1, Void >*>(static_cast<AddRequestActorActor*>(this)));
															#line 123 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
					loopDepth = 0;
				}
			}
			catch (Error& error) {
	...
	{
															#line 88 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		self->updateResult();
															#line 89 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (!static_cast<AddRequestActorActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~AddRequestActorActorState(); static_cast<AddRequestActorActor*>(this)->destroy(); return 0; }
															#line 155 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	...
	{
		try {
															#line 78 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			if (e.code() == error_code_actor_cancelled)
															#line 168 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			{
															#line 79 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
				return a_body1Catch1(e, loopDepth);
															#line 172 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			}
															#line 82 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			if (e.code() == error_code_not_committed || e.code() == error_code_timed_out)
															#line 176 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			{
															#line 83 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
				++self->failed;
															#line 180 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			}
			else
			{
															#line 85 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
				++self->maybeCommitted;
															#line 186 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			}
	...
	{
															#line 75 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		++self->successful;
															#line 202 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	...
	ConfigTransactionInterface cti;
															#line 376 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
};
// This generated class is to be used only via addRequestActor()
															#line 63 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
class AddRequestActorActor final : public Actor<Void>, public ActorCallback< AddRequestActorActor, 0, Void >, public ActorCallback< AddRequestActorActor, 1, Void >, public FastAllocated<AddRequestActorActor>, public AddRequestActorActorState<AddRequestActorActor> {
															#line 381 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
public:
...
friend struct ActorCallback< AddRequestActorActor, 1, Void >;
	...
	AddRequestActorActor(CommitQuorum* const& self,ConfigGeneration const& generation,ConfigTransactionInterface const& cti) 
															#line 393 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> addRequestActor( CommitQuorum* const& self, ConfigGeneration const& generation, ConfigTransactionInterface const& cti ) {
	...
	return Future<Void>(new AddRequestActorActor(self, generation, cti));
															#line 421 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
}

#line 91 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
...
class GetGenerationQuorum {
	...
	Future<ConfigGeneration> getGenerationFuture;
																...
																#line 467 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
// This generated class is to be used only via addRequestActor()
															#line 133 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
template <class AddRequestActorActor1>
															#line 133 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
class AddRequestActorActor1State {
															#line 473 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
public:
															#line 133 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
	AddRequestActorActor1State(GetGenerationQuorum* const& self,ConfigTransactionInterface const& cti) 
		 ...
		 : self(self),
															#line 133 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		   cti(cti)
															#line 482 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	{
		fdb_probe_actor_create("addRequestActor", reinterpret_cast<unsigned long>(this));
	...
	{
		try {
															#line 134 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			;
															#line 497 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	...
	int a_body1cont1(int loopDepth) 
	{
															#line 186 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (!static_cast<AddRequestActorActor1*>(this)->SAV<Void>::futures) { (void)(Void()); this->~AddRequestActorActor1State(); static_cast<AddRequestActorActor1*>(this)->destroy(); return 0; }
															#line 520 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	...
	{
		try {
															#line 136 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			reply = ConfigTransactionGetGenerationReply();
															#line 137 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			if (cti.hostname.present())
															#line 542 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			{
															#line 138 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
				...
				if (static_cast<AddRequestActorActor1*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 548 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
				...
				__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< AddRequestActorActor1, 0, Void >*>(static_cast<AddRequestActorActor1*>(this)));
															#line 553 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
				loopDepth = 0;
			}
			else
			{
															#line 145 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
				StrictFuture<Void> __when_expr_1 = timeoutError(store(reply, cti.getGeneration.getReply( ConfigTransactionGetGenerationRequest{ self->lastSeenLiveVersion })), CLIENT_KNOBS->GET_GENERATION_QUORUM_TIMEOUT);
															#line 145 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
				if (static_cast<AddRequestActorActor1*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 562 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
				...
				__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< AddRequestActorActor1, 1, Void >*>(static_cast<AddRequestActorActor1*>(this)));
															#line 567 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
				loopDepth = 0;
			}
		}
		catch (Error& error) {
	...
	{
		try {
															#line 170 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			if (e.code() == error_code_broken_promise)
															#line 597 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			{
				return a_body1loopHead1(loopDepth); // continue
			}
			else
			{
															#line 172 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
				if (e.code() == error_code_timed_out)
															#line 605 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
				{
															#line 173 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
					++self->totalRepliesReceived;
															#line 174 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
					if (self->totalRepliesReceived == self->ctis.size() && self->result.canBeSet() && !self->result.isError())
															#line 611 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
					{
															#line 177 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
						auto local = self->result;
															#line 178 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
						local.sendError(failed_to_reach_quorum());
															#line 617 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
					}
					return a_body1break1(loopDepth==0?0:loopDepth-1); // break
				}
				else
				{
															#line 182 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
					return a_body1Catch1(e, std::max(0, loopDepth - 1));
															#line 625 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
				}
			}
		}
		catch (Error& error) {
	...
	{
															#line 151 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		++self->totalRepliesReceived;
															#line 152 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		auto gen = reply.generation;
															#line 153 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		self->lastSeenLiveVersion = std::max(gen.liveVersion, self->lastSeenLiveVersion.orDefault(::invalidVersion));
															#line 155 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		auto& replicas = self->seenGenerations[gen];
															#line 156 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		replicas.push_back(cti);
															#line 157 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		self->maxAgreement = std::max(replicas.size(), self->maxAgreement);
															#line 158 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (replicas.size() >= self->ctis.size() / 2 + 1 && !self->result.isSet())
															#line 653 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		{
															#line 159 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			self->result.send(gen);
															#line 657 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		}
		else
		{
															#line 160 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			if (self->maxAgreement + (self->ctis.size() - self->totalRepliesReceived) < (self->ctis.size() / 2 + 1))
															#line 663 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			{
															#line 162 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
				if (!self->result.isError())
															#line 667 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
				{
															#line 164 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
					auto local = self->result;
															#line 165 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
					local.sendError(failed_to_reach_quorum());
															#line 673 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
				}
			}
		}
		return a_body1break1(loopDepth==0?0:loopDepth-1); // break
	...
	ConfigTransactionGetGenerationReply reply;
															#line 837 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
};
// This generated class is to be used only via addRequestActor()
															#line 133 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
class AddRequestActorActor1 final : public Actor<Void>, public ActorCallback< AddRequestActorActor1, 0, Void >, public ActorCallback< AddRequestActorActor1, 1, Void >, public FastAllocated<AddRequestActorActor1>, public AddRequestActorActor1State<AddRequestActorActor1> {
															#line 842 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
public:
...
friend struct ActorCallback< AddRequestActorActor1, 1, Void >;
	...
	AddRequestActorActor1(GetGenerationQuorum* const& self,ConfigTransactionInterface const& cti) 
															#line 854 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> addRequestActor( GetGenerationQuorum* const& self, ConfigTransactionInterface const& cti ) {
	...
	return Future<Void>(new AddRequestActorActor1(self, cti));
															#line 882 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
}

#line 188 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"

																#line 887 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
// This generated class is to be used only via getGenerationActor()
															#line 189 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
template <class GetGenerationActorActor>
															#line 189 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
class GetGenerationActorActorState {
															#line 893 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
public:
															#line 189 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
	GetGenerationActorActorState(GetGenerationQuorum* const& self) 
															...
															#line 189 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		 : self(self),
															#line 190 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		   retries(0)
															#line 902 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	{
	...
	{
		try {
															#line 191 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			;
															#line 917 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			loopDepth = a_body1loopHead1(loopDepth);
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1loopBody1(int loopDepth) 
	{
															#line 192 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		for( const auto& cti : self->ctis ) {
															#line 193 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			self->actors.add(addRequestActor(self, cti));
															#line 949 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		}
		try {
															#line 197 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			StrictFuture<ConfigGeneration> __when_expr_0 = self->result.getFuture();
															#line 196 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			if (static_cast<GetGenerationActorActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 956 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1loopBody1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1loopBody1when1(__when_expr_0.get(), loopDepth); };
															#line 200 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			StrictFuture<Void> __when_expr_1 = self->actors.getResult();
															#line 960 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1loopBody1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1loopBody1when2(__when_expr_1.get(), loopDepth); };
			...
			__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< GetGenerationActorActor, 1, Void >*>(static_cast<GetGenerationActorActor*>(this)));
															#line 967 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1loopBody1Catch1(error, loopDepth);
	...
	{
		try {
															#line 205 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			if (e.code() == error_code_failed_to_reach_quorum)
															#line 989 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			{
															#line 206 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
				TEST(true);
															#line 207 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
				...
				if (static_cast<GetGenerationActorActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), std::max(0, loopDepth - 1));
															#line 997 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
				...
				__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< GetGenerationActorActor, 2, Void >*>(static_cast<GetGenerationActorActor*>(this)));
															#line 1002 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
				loopDepth = 0;
			}
			else
			{
															#line 216 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
				return a_body1Catch1(e, std::max(0, loopDepth - 1));
															#line 1009 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			}
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, std::max(0, loopDepth - 1));
	...
	{
															#line 198 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (!static_cast<GetGenerationActorActor*>(this)->SAV<ConfigGeneration>::futures) { (void)(generation); this->~GetGenerationActorActorState(); static_cast<GetGenerationActorActor*>(this)->destroy(); return 0; }
															#line 1030 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	...
	int a_body1loopBody1when1(ConfigGeneration && generation,int loopDepth) 
	{
															#line 198 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (!static_cast<GetGenerationActorActor*>(this)->SAV<ConfigGeneration>::futures) { (void)(generation); this->~GetGenerationActorActorState(); static_cast<GetGenerationActorActor*>(this)->destroy(); return 0; }
															#line 1042 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		new (&static_cast<GetGenerationActorActor*>(this)->SAV< ConfigGeneration >::value()) ConfigGeneration(generation);
		this->~GetGenerationActorActorState();
		static_cast<GetGenerationActorActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	int a_body1loopBody1when2(Void const& _,int loopDepth) 
	{
															#line 201 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		ASSERT(false);
															#line 1054 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	...
	int a_body1loopBody1when2(Void && _,int loopDepth) 
	{
															#line 201 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		ASSERT(false);
															#line 1063 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		loopDepth = a_body1loopBody1cont3(loopDepth);
	...
	{
															#line 209 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		++retries;
															#line 210 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		self->actors.clear(false);
															#line 211 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		self->seenGenerations.clear();
															#line 212 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		self->result.reset();
															#line 213 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		self->totalRepliesReceived = 0;
															#line 214 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		self->maxAgreement = 0;
															#line 1198 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	...
	int a_body1loopBody1Catch1cont2(Void && _,int loopDepth) 
	{
		...
		self->totalRepliesReceived = 0;
															#line 214 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		self->maxAgreement = 0;
															#line 1217 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		loopDepth = a_body1loopBody1Catch1cont1(loopDepth);
	...
	GetGenerationQuorum* self;
															#line 190 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
	int retries;
															#line 1289 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
};
// This generated class is to be used only via getGenerationActor()
															#line 189 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
class GetGenerationActorActor final : public Actor<ConfigGeneration>, public ActorCallback< GetGenerationActorActor, 0, ConfigGeneration >, public ActorCallback< GetGenerationActorActor, 1, Void >, public ActorCallback< GetGenerationActorActor, 2, Void >, public FastAllocated<GetGenerationActorActor>, public GetGenerationActorActorState<GetGenerationActorActor> {
															#line 1294 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
public:
...
friend struct ActorCallback< GetGenerationActorActor, 2, Void >;
	...
	GetGenerationActorActor(GetGenerationQuorum* const& self) 
															#line 1307 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
...
[[nodiscard]] static Future<ConfigGeneration> getGenerationActor( GetGenerationQuorum* const& self ) {
	...
	return Future<ConfigGeneration>(new GetGenerationActorActor(self));
															#line 1335 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
}

#line 221 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
...
class PaxosConfigTransactionImpl {
	...
	Database cx;
																...
																#line 1372 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
// This generated class is to be used only via get()
															#line 254 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
template <class GetActor>
															#line 254 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
class GetActorState {
															#line 1378 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
public:
															#line 254 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
	GetActorState(PaxosConfigTransactionImpl* const& self,Key const& key) 
		 ...
		 : self(self),
															#line 254 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		   key(key),
															#line 255 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		   configKey(ConfigKey::decodeKey(key))
															#line 1389 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	{
	...
	{
		try {
															#line 256 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			;
															#line 1404 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			loopDepth = a_body1loopHead1(loopDepth);
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	{
		try {
															#line 258 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			...
			if (static_cast<GetActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 1437 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1loopBody1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1loopBody1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< GetActor, 0, ConfigGeneration >*>(static_cast<GetActor*>(this)));
															#line 1442 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1loopBody1Catch1(error, loopDepth);
	...
	{
		try {
															#line 281 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			if (e.code() != error_code_timed_out && e.code() != error_code_broken_promise)
															#line 1464 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			{
															#line 282 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
				return a_body1Catch1(e, std::max(0, loopDepth - 1));
															#line 1468 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			}
															#line 284 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			self->reset();
															#line 1472 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			loopDepth = a_body1loopBody1cont1(loopDepth);
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, std::max(0, loopDepth - 1));
	...
	int a_body1loopBody1cont2(int loopDepth) 
	{
															#line 259 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		readReplicas = self->getGenerationQuorum.getReadReplicas();
															#line 261 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		std::vector<Future<Void>> fs;
															#line 262 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		for( ConfigTransactionInterface& readReplica : readReplicas ) {
															#line 263 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			if (readReplica.hostname.present())
															#line 1493 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			{
															#line 264 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
				fs.push_back(tryInitializeRequestStream( &readReplica.get, readReplica.hostname.get(), WLTOKEN_CONFIGTXN_GET));
															#line 1497 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			}
		}
															#line 268 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		StrictFuture<Void> __when_expr_1 = waitForAll(fs);
															#line 268 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (static_cast<GetActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 1504 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< GetActor, 1, Void >*>(static_cast<GetActor*>(this)));
															#line 1509 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1loopBody1when1(ConfigGeneration const& __generation,int loopDepth) 
	{
		...
		generation = __generation;
															#line 1518 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		loopDepth = a_body1loopBody1cont2(loopDepth);
	...
	int a_body1loopBody1cont3(Void const& _,int loopDepth) 
	{
															#line 269 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		configNodes = Reference<ConfigTransactionInfo>(new ConfigTransactionInfo(readReplicas));
															#line 270 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		StrictFuture<ConfigTransactionGetReply> __when_expr_2 = timeoutError(basicLoadBalance(configNodes, &ConfigTransactionInterface::get, ConfigTransactionGetRequest{ generation, configKey }), CLIENT_KNOBS->GET_KNOB_TIMEOUT);
															#line 270 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (static_cast<GetActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 1589 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		...
		__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< GetActor, 2, ConfigTransactionGetReply >*>(static_cast<GetActor*>(this)));
															#line 1594 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1loopBody1cont3(Void && _,int loopDepth) 
	{
		...
		StrictFuture<ConfigTransactionGetReply> __when_expr_2 = timeoutError(basicLoadBalance(configNodes, &ConfigTransactionInterface::get, ConfigTransactionGetRequest{ generation, configKey }), CLIENT_KNOBS->GET_KNOB_TIMEOUT);
															#line 270 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (static_cast<GetActor*>(this)->actor_wait_state < 0) return a_body1loopBody1Catch1(actor_cancelled(), loopDepth);
															#line 1607 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		if (__when_expr_2.isReady()) { if (__when_expr_2.isError()) return a_body1loopBody1Catch1(__when_expr_2.getError(), loopDepth); else return a_body1loopBody1cont3when1(__when_expr_2.get(), loopDepth); };
		static_cast<GetActor*>(this)->actor_wait_state = 3;
															#line 270 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< GetActor, 2, ConfigTransactionGetReply >*>(static_cast<GetActor*>(this)));
															#line 1612 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		loopDepth = 0;
	...
	{
															#line 275 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (reply.value.present())
															#line 1684 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		{
															#line 276 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			if (!static_cast<GetActor*>(this)->SAV<Optional<Value>>::futures) { (void)(reply.value.get().toValue()); this->~GetActorState(); static_cast<GetActor*>(this)->destroy(); return 0; }
															#line 1688 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		...
		{
															#line 278 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			if (!static_cast<GetActor*>(this)->SAV<Optional<Value>>::futures) { (void)(Optional<Value>{}); this->~GetActorState(); static_cast<GetActor*>(this)->destroy(); return 0; }
															#line 1698 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	...
	int a_body1loopBody1cont6(ConfigTransactionGetReply && reply,int loopDepth) 
	{
															#line 275 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (reply.value.present())
															#line 1711 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		{
															#line 276 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			if (!static_cast<GetActor*>(this)->SAV<Optional<Value>>::futures) { (void)(reply.value.get().toValue()); this->~GetActorState(); static_cast<GetActor*>(this)->destroy(); return 0; }
															#line 1715 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			new (&static_cast<GetActor*>(this)->SAV< Optional<Value> >::value()) Optional<Value>(reply.value.get().toValue());
			this->~GetActorState();
			static_cast<GetActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
		...
		else
		{
															#line 278 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			if (!static_cast<GetActor*>(this)->SAV<Optional<Value>>::futures) { (void)(Optional<Value>{}); this->~GetActorState(); static_cast<GetActor*>(this)->destroy(); return 0; }
															#line 1725 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			new (&static_cast<GetActor*>(this)->SAV< Optional<Value> >::value()) Optional<Value>(Optional<Value>{});
			this->~GetActorState();
			static_cast<GetActor*>(this)->finishSendAndDelPromiseRef();
			return 0;
	...
	Reference<ConfigTransactionInfo> configNodes;
															#line 1809 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
};
// This generated class is to be used only via get()
															#line 254 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
class GetActor final : public Actor<Optional<Value>>, public ActorCallback< GetActor, 0, ConfigGeneration >, public ActorCallback< GetActor, 1, Void >, public ActorCallback< GetActor, 2, ConfigTransactionGetReply >, public FastAllocated<GetActor>, public GetActorState<GetActor> {
															#line 1814 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
public:
...
friend struct ActorCallback< GetActor, 2, ConfigTransactionGetReply >;
	...
	GetActor(PaxosConfigTransactionImpl* const& self,Key const& key) 
															#line 1827 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
...
[[nodiscard]] static Future<Optional<Value>> get( PaxosConfigTransactionImpl* const& self, Key const& key ) {
	...
	return Future<Optional<Value>>(new GetActor(self, key));
															#line 1856 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
}

#line 288 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"

																#line 1861 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
// This generated class is to be used only via getConfigClasses()
															#line 289 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
template <class GetConfigClassesActor>
															#line 289 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
class GetConfigClassesActorState {
															#line 1867 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
public:
															#line 289 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
	GetConfigClassesActorState(PaxosConfigTransactionImpl* const& self) 
															...
															#line 289 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		 : self(self)
															#line 1874 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	{
	...
	{
		try {
															#line 290 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			StrictFuture<ConfigGeneration> __when_expr_0 = self->getGenerationQuorum.getGeneration();
															#line 290 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			if (static_cast<GetConfigClassesActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 1891 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< GetConfigClassesActor, 0, ConfigGeneration >*>(static_cast<GetConfigClassesActor*>(this)));
															#line 1896 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont1(int loopDepth) 
	{
															#line 291 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		readReplicas = self->getGenerationQuorum.getReadReplicas();
															#line 292 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		std::vector<Future<Void>> fs;
															#line 293 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		for( ConfigTransactionInterface& readReplica : readReplicas ) {
															#line 294 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			if (readReplica.hostname.present())
															#line 1925 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			{
															#line 295 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
				fs.push_back(tryInitializeRequestStream( &readReplica.getClasses, readReplica.hostname.get(), WLTOKEN_CONFIGTXN_GETCLASSES));
															#line 1929 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			}
		}
															#line 299 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		StrictFuture<Void> __when_expr_1 = waitForAll(fs);
															#line 299 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (static_cast<GetConfigClassesActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 1936 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< GetConfigClassesActor, 1, Void >*>(static_cast<GetConfigClassesActor*>(this)));
															#line 1941 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1when1(ConfigGeneration const& __generation,int loopDepth) 
	{
															#line 290 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		generation = __generation;
															#line 1950 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		loopDepth = a_body1cont1(loopDepth);
	...
	{
															#line 300 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		configNodes = Reference<ConfigTransactionInfo>(new ConfigTransactionInfo(readReplicas));
															#line 301 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		StrictFuture<ConfigTransactionGetConfigClassesReply> __when_expr_2 = basicLoadBalance(configNodes, &ConfigTransactionInterface::getClasses, ConfigTransactionGetConfigClassesRequest{ generation });
															#line 301 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (static_cast<GetConfigClassesActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 2021 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		...
		__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< GetConfigClassesActor, 2, ConfigTransactionGetConfigClassesReply >*>(static_cast<GetConfigClassesActor*>(this)));
															#line 2026 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1cont2(Void && _,int loopDepth) 
	{
		...
		StrictFuture<ConfigTransactionGetConfigClassesReply> __when_expr_2 = basicLoadBalance(configNodes, &ConfigTransactionInterface::getClasses, ConfigTransactionGetConfigClassesRequest{ generation });
															#line 301 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (static_cast<GetConfigClassesActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 2039 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		if (__when_expr_2.isReady()) { if (__when_expr_2.isError()) return a_body1Catch1(__when_expr_2.getError(), loopDepth); else return a_body1cont2when1(__when_expr_2.get(), loopDepth); };
		static_cast<GetConfigClassesActor*>(this)->actor_wait_state = 3;
															#line 301 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< GetConfigClassesActor, 2, ConfigTransactionGetConfigClassesReply >*>(static_cast<GetConfigClassesActor*>(this)));
															#line 2044 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		loopDepth = 0;
	...
	{
															#line 305 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		RangeResult result;
															#line 306 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		result.reserve(result.arena(), reply.configClasses.size());
															#line 307 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		for( const auto& configClass : reply.configClasses ) {
															#line 308 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			result.push_back_deep(result.arena(), KeyValueRef(configClass, ""_sr));
															#line 2122 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		}
															#line 310 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (!static_cast<GetConfigClassesActor*>(this)->SAV<RangeResult>::futures) { (void)(result); this->~GetConfigClassesActorState(); static_cast<GetConfigClassesActor*>(this)->destroy(); return 0; }
															#line 2126 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	...
	int a_body1cont5(ConfigTransactionGetConfigClassesReply && reply,int loopDepth) 
	{
		...
		for( const auto& configClass : reply.configClasses ) {
															#line 308 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			result.push_back_deep(result.arena(), KeyValueRef(configClass, ""_sr));
															#line 2144 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		}
															#line 310 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (!static_cast<GetConfigClassesActor*>(this)->SAV<RangeResult>::futures) { (void)(result); this->~GetConfigClassesActorState(); static_cast<GetConfigClassesActor*>(this)->destroy(); return 0; }
															#line 2148 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		new (&static_cast<GetConfigClassesActor*>(this)->SAV< RangeResult >::value()) RangeResult(result);
		this->~GetConfigClassesActorState();
		static_cast<GetConfigClassesActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	std::vector<ConfigTransactionInterface> readReplicas;
															#line 300 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
	Reference<ConfigTransactionInfo> configNodes;
															#line 2227 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
};
// This generated class is to be used only via getConfigClasses()
															#line 289 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
class GetConfigClassesActor final : public Actor<RangeResult>, public ActorCallback< GetConfigClassesActor, 0, ConfigGeneration >, public ActorCallback< GetConfigClassesActor, 1, Void >, public ActorCallback< GetConfigClassesActor, 2, ConfigTransactionGetConfigClassesReply >, public FastAllocated<GetConfigClassesActor>, public GetConfigClassesActorState<GetConfigClassesActor> {
															#line 2232 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
public:
...
friend struct ActorCallback< GetConfigClassesActor, 2, ConfigTransactionGetConfigClassesReply >;
	...
	GetConfigClassesActor(PaxosConfigTransactionImpl* const& self) 
															#line 2245 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		 : Actor<RangeResult>(),
...
[[nodiscard]] static Future<RangeResult> getConfigClasses( PaxosConfigTransactionImpl* const& self ) {
	...
	return Future<RangeResult>(new GetConfigClassesActor(self));
															#line 2274 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
}

#line 312 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"

																#line 2279 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
// This generated class is to be used only via getKnobs()
															#line 313 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
template <class GetKnobsActor>
															#line 313 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
class GetKnobsActorState {
															#line 2285 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
public:
															#line 313 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
	GetKnobsActorState(PaxosConfigTransactionImpl* const& self,Optional<Key> const& configClass) 
		 ...
		 : self(self),
		   ...
		   configClass(configClass)
															#line 2294 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	{
	...
	{
		try {
															#line 314 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			StrictFuture<ConfigGeneration> __when_expr_0 = self->getGenerationQuorum.getGeneration();
															#line 314 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			if (static_cast<GetKnobsActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 2311 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< GetKnobsActor, 0, ConfigGeneration >*>(static_cast<GetKnobsActor*>(this)));
															#line 2316 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont1(int loopDepth) 
	{
															#line 315 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		readReplicas = self->getGenerationQuorum.getReadReplicas();
															#line 316 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		std::vector<Future<Void>> fs;
															#line 317 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		for( ConfigTransactionInterface& readReplica : readReplicas ) {
															#line 318 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			if (readReplica.hostname.present())
															#line 2345 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			{
															#line 319 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
				fs.push_back(tryInitializeRequestStream( &readReplica.getKnobs, readReplica.hostname.get(), WLTOKEN_CONFIGTXN_GETKNOBS));
															#line 2349 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			}
		}
															#line 323 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		StrictFuture<Void> __when_expr_1 = waitForAll(fs);
															#line 323 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (static_cast<GetKnobsActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 2356 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< GetKnobsActor, 1, Void >*>(static_cast<GetKnobsActor*>(this)));
															#line 2361 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1when1(ConfigGeneration const& __generation,int loopDepth) 
	{
															#line 314 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		generation = __generation;
															#line 2370 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		loopDepth = a_body1cont1(loopDepth);
	...
	int a_body1cont2(Void const& _,int loopDepth) 
	{
															#line 324 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		configNodes = Reference<ConfigTransactionInfo>(new ConfigTransactionInfo(readReplicas));
															#line 325 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		StrictFuture<ConfigTransactionGetKnobsReply> __when_expr_2 = basicLoadBalance(configNodes, &ConfigTransactionInterface::getKnobs, ConfigTransactionGetKnobsRequest{ generation, configClass });
															#line 325 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (static_cast<GetKnobsActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 2441 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		if (__when_expr_2.isReady()) { if (__when_expr_2.isError()) return a_body1Catch1(__when_expr_2.getError(), loopDepth); else return a_body1cont2when1(__when_expr_2.get(), loopDepth); };
		...
		__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< GetKnobsActor, 2, ConfigTransactionGetKnobsReply >*>(static_cast<GetKnobsActor*>(this)));
															#line 2446 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1cont2(Void && _,int loopDepth) 
	{
		...
		StrictFuture<ConfigTransactionGetKnobsReply> __when_expr_2 = basicLoadBalance(configNodes, &ConfigTransactionInterface::getKnobs, ConfigTransactionGetKnobsRequest{ generation, configClass });
															#line 325 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (static_cast<GetKnobsActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 2459 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		if (__when_expr_2.isReady()) { if (__when_expr_2.isError()) return a_body1Catch1(__when_expr_2.getError(), loopDepth); else return a_body1cont2when1(__when_expr_2.get(), loopDepth); };
		static_cast<GetKnobsActor*>(this)->actor_wait_state = 3;
															#line 325 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< GetKnobsActor, 2, ConfigTransactionGetKnobsReply >*>(static_cast<GetKnobsActor*>(this)));
															#line 2464 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		loopDepth = 0;
	...
	{
															#line 329 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		RangeResult result;
															#line 330 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		result.reserve(result.arena(), reply.knobNames.size());
															#line 331 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		for( const auto& knobName : reply.knobNames ) {
															#line 332 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			result.push_back_deep(result.arena(), KeyValueRef(knobName, ""_sr));
															#line 2542 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		}
															#line 334 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (!static_cast<GetKnobsActor*>(this)->SAV<RangeResult>::futures) { (void)(result); this->~GetKnobsActorState(); static_cast<GetKnobsActor*>(this)->destroy(); return 0; }
															#line 2546 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	...
	int a_body1cont5(ConfigTransactionGetKnobsReply && reply,int loopDepth) 
	{
		...
		for( const auto& knobName : reply.knobNames ) {
															#line 332 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			result.push_back_deep(result.arena(), KeyValueRef(knobName, ""_sr));
															#line 2564 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		}
															#line 334 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (!static_cast<GetKnobsActor*>(this)->SAV<RangeResult>::futures) { (void)(result); this->~GetKnobsActorState(); static_cast<GetKnobsActor*>(this)->destroy(); return 0; }
															#line 2568 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		new (&static_cast<GetKnobsActor*>(this)->SAV< RangeResult >::value()) RangeResult(result);
		this->~GetKnobsActorState();
		static_cast<GetKnobsActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	std::vector<ConfigTransactionInterface> readReplicas;
															#line 324 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
	Reference<ConfigTransactionInfo> configNodes;
															#line 2649 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
};
// This generated class is to be used only via getKnobs()
															#line 313 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
class GetKnobsActor final : public Actor<RangeResult>, public ActorCallback< GetKnobsActor, 0, ConfigGeneration >, public ActorCallback< GetKnobsActor, 1, Void >, public ActorCallback< GetKnobsActor, 2, ConfigTransactionGetKnobsReply >, public FastAllocated<GetKnobsActor>, public GetKnobsActorState<GetKnobsActor> {
															#line 2654 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
public:
...
friend struct ActorCallback< GetKnobsActor, 2, ConfigTransactionGetKnobsReply >;
	...
	GetKnobsActor(PaxosConfigTransactionImpl* const& self,Optional<Key> const& configClass) 
															#line 2667 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		 : Actor<RangeResult>(),
...
[[nodiscard]] static Future<RangeResult> getKnobs( PaxosConfigTransactionImpl* const& self, Optional<Key> const& configClass ) {
	...
	return Future<RangeResult>(new GetKnobsActor(self, configClass));
															#line 2696 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
}

#line 336 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"

																#line 2701 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
// This generated class is to be used only via commit()
															#line 337 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
template <class CommitActor>
															#line 337 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
class CommitActorState {
															#line 2707 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
public:
															#line 337 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
	CommitActorState(PaxosConfigTransactionImpl* const& self) 
															...
															#line 337 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		 : self(self)
															#line 2714 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	{
	...
	{
		try {
															#line 338 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			StrictFuture<ConfigGeneration> __when_expr_0 = self->getGenerationQuorum.getGeneration();
															#line 338 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			if (static_cast<CommitActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 2731 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< CommitActor, 0, ConfigGeneration >*>(static_cast<CommitActor*>(this)));
															#line 2736 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	{
															#line 339 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		self->commitQuorum.setTimestamp();
															#line 340 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		StrictFuture<Void> __when_expr_1 = self->commitQuorum.commit(generation);
															#line 340 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (static_cast<CommitActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 2763 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< CommitActor, 1, Void >*>(static_cast<CommitActor*>(this)));
															#line 2768 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1cont1(ConfigGeneration && generation,int loopDepth) 
	{
		...
		StrictFuture<Void> __when_expr_1 = self->commitQuorum.commit(generation);
															#line 340 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (static_cast<CommitActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 2781 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		static_cast<CommitActor*>(this)->actor_wait_state = 2;
															#line 340 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< CommitActor, 1, Void >*>(static_cast<CommitActor*>(this)));
															#line 2786 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		loopDepth = 0;
	...
	int a_body1cont2(Void const& _,int loopDepth) 
	{
															#line 341 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (!static_cast<CommitActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~CommitActorState(); static_cast<CommitActor*>(this)->destroy(); return 0; }
															#line 2858 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	...
	int a_body1cont2(Void && _,int loopDepth) 
	{
															#line 341 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (!static_cast<CommitActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~CommitActorState(); static_cast<CommitActor*>(this)->destroy(); return 0; }
															#line 2870 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		new (&static_cast<CommitActor*>(this)->SAV< Void >::value()) Void(Void());
		this->~CommitActorState();
		static_cast<CommitActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	void a_callback_error(ActorCallback< CommitActor, 1, Void >*,Error err) 
	{
		...
		fdb_probe_actor_exit("commit", reinterpret_cast<unsigned long>(this), 1);
															...
															#line 337 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
	PaxosConfigTransactionImpl* self;
															#line 2943 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
};
// This generated class is to be used only via commit()
															#line 337 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
class CommitActor final : public Actor<Void>, public ActorCallback< CommitActor, 0, ConfigGeneration >, public ActorCallback< CommitActor, 1, Void >, public FastAllocated<CommitActor>, public CommitActorState<CommitActor> {
															#line 2948 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
public:
...
friend struct ActorCallback< CommitActor, 1, Void >;
	...
	CommitActor(PaxosConfigTransactionImpl* const& self) 
															#line 2960 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> commit( PaxosConfigTransactionImpl* const& self ) {
	...
	return Future<Void>(new CommitActor(self));
															#line 2988 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
}

#line 343 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"

																#line 2993 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
// This generated class is to be used only via onError()
															#line 344 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
template <class OnErrorActor>
															#line 344 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
class OnErrorActorState {
															#line 2999 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
public:
															#line 344 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
	OnErrorActorState(PaxosConfigTransactionImpl* const& self,Error const& e) 
		 ...
		 : self(self),
															#line 344 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		   e(e)
															#line 3008 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	{
	...
	{
		try {
															#line 346 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			TraceEvent("ConfigIncrementOnError").error(e).detail("NumRetries", self->numRetries);
															#line 347 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
			if (e.code() == error_code_transaction_too_old || e.code() == error_code_not_committed)
															#line 3025 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
			{
															#line 348 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
				...
				if (static_cast<OnErrorActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 3031 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
				if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
				...
				__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< OnErrorActor, 0, Void >*>(static_cast<OnErrorActor*>(this)));
															#line 3036 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
				loopDepth = 0;
			}
			else
			{
	...
	int a_body1cont1(int loopDepth) 
	{
															#line 354 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		return a_body1Catch1(e, loopDepth);
															#line 3064 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"

		return loopDepth;
	}
	int a_body1cont2(Void const& _,int loopDepth) 
	{
															#line 351 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		self->reset();
															#line 352 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (!static_cast<OnErrorActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~OnErrorActorState(); static_cast<OnErrorActor*>(this)->destroy(); return 0; }
															#line 3074 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
	...
	int a_body1cont2(Void && _,int loopDepth) 
	{
		...
		self->reset();
															#line 352 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
		if (!static_cast<OnErrorActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~OnErrorActorState(); static_cast<OnErrorActor*>(this)->destroy(); return 0; }
															#line 3088 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		new (&static_cast<OnErrorActor*>(this)->SAV< Void >::value()) Void(Void());
		this->~OnErrorActorState();
		static_cast<OnErrorActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	PaxosConfigTransactionImpl* self;
															#line 344 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
	Error e;
															#line 3163 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
};
// This generated class is to be used only via onError()
															#line 344 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
class OnErrorActor final : public Actor<Void>, public ActorCallback< OnErrorActor, 0, Void >, public FastAllocated<OnErrorActor>, public OnErrorActorState<OnErrorActor> {
															#line 3168 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
public:
...
friend struct ActorCallback< OnErrorActor, 0, Void >;
	...
	OnErrorActor(PaxosConfigTransactionImpl* const& self,Error const& e) 
															#line 3179 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> onError( PaxosConfigTransactionImpl* const& self, Error const& e ) {
	...
	return Future<Void>(new OnErrorActor(self, e));
															#line 3206 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.g.cpp"
}

#line 356 "/usr/src/libfdb_c/fdbclient/PaxosConfigTransaction.actor.cpp"
