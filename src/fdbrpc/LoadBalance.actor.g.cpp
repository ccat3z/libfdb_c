...
// these requests
															#line 33 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.g.cpp"
namespace {
// This generated class is to be used only via allAlternativesFailedDelay()
															#line 31 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.cpp"
template <class AllAlternativesFailedDelayActor>
															#line 31 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.cpp"
class AllAlternativesFailedDelayActorState {
															#line 40 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.g.cpp"
public:
															#line 31 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.cpp"
	AllAlternativesFailedDelayActorState(Future<Void> const& okFuture) 
															...
															#line 31 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.cpp"
		 : okFuture(okFuture)
															#line 47 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.g.cpp"
	{
	...
	{
		try {
															#line 32 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.cpp"
			if (now() - g_network->networkInfo.newestAlternativesFailure > FLOW_KNOBS->ALTERNATIVES_FAILURE_RESET_TIME)
															#line 62 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.g.cpp"
			{
				...
				g_network->networkInfo.oldestAlternativesFailure = now();
															#line 66 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.g.cpp"
			}
															#line 36 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.cpp"
			...
			if (now() - g_network->networkInfo.lastAlternativesFailureSkipDelay > FLOW_KNOBS->ALTERNATIVES_FAILURE_SKIP_DELAY)
															#line 72 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.g.cpp"
			{
				...
				g_network->networkInfo.lastAlternativesFailureSkipDelay = now();
															#line 76 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.g.cpp"
			}
			else
			{
															#line 40 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.cpp"
				...
				delay = std::max(delay, std::min(elapsed * FLOW_KNOBS->ALTERNATIVES_FAILURE_DELAY_RATIO, FLOW_KNOBS->ALTERNATIVES_FAILURE_MAX_DELAY));
															#line 44 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.cpp"
				delay = std::max(delay, std::min(elapsed * FLOW_KNOBS->ALTERNATIVES_FAILURE_SLOW_DELAY_RATIO, FLOW_KNOBS->ALTERNATIVES_FAILURE_SLOW_MAX_DELAY));
															#line 86 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.g.cpp"
			}
			...
			g_network->networkInfo.newestAlternativesFailure = now();
															#line 52 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.cpp"
			...
			if (static_cast<AllAlternativesFailedDelayActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 94 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.g.cpp"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
															#line 53 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.cpp"
			StrictFuture<Void> __when_expr_1 = ::delayJittered(delay);
															#line 98 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.g.cpp"
			...
			__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< AllAlternativesFailedDelayActor, 1, Void >*>(static_cast<AllAlternativesFailedDelayActor*>(this)));
															#line 105 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.g.cpp"
			loopDepth = 0;
		}
		catch (Error& error) {
	...
	{
															#line 57 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.cpp"
		if (!static_cast<AllAlternativesFailedDelayActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~AllAlternativesFailedDelayActorState(); static_cast<AllAlternativesFailedDelayActor*>(this)->destroy(); return 0; }
															#line 128 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.g.cpp"
	...
	int a_body1when2(Void const& _,int loopDepth) 
	{
		...
		return a_body1Catch1(all_alternatives_failed(), loopDepth);
															#line 152 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.g.cpp"
	...
	int a_body1when2(Void && _,int loopDepth) 
	{
															#line 54 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.cpp"
		return a_body1Catch1(all_alternatives_failed(), loopDepth);
															#line 160 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.g.cpp"
	...
	Future<Void> okFuture;
															#line 263 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.g.cpp"
};
// This generated class is to be used only via allAlternativesFailedDelay()
															#line 31 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.cpp"
class AllAlternativesFailedDelayActor final : public Actor<Void>, public ActorCallback< AllAlternativesFailedDelayActor, 0, Void >, public ActorCallback< AllAlternativesFailedDelayActor, 1, Void >, public FastAllocated<AllAlternativesFailedDelayActor>, public AllAlternativesFailedDelayActorState<AllAlternativesFailedDelayActor> {
															#line 268 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.g.cpp"
public:
...
friend struct ActorCallback< AllAlternativesFailedDelayActor, 1, Void >;
	...
	AllAlternativesFailedDelayActor(Future<Void> const& okFuture) 
															#line 280 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.g.cpp"
		 : Actor<Void>(),
...
[[nodiscard]] Future<Void> allAlternativesFailedDelay( Future<Void> const& okFuture ) {
	...
	return Future<Void>(new AllAlternativesFailedDelayActor(okFuture));
															#line 308 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.g.cpp"
}

#line 59 "/home/ccat3z/Documents/moqi/foundationdb-client/src/fdbrpc/LoadBalance.actor.cpp"
