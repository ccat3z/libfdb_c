...
#line 1 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
/*
...
public:
	...
	static bool lock_fd(int fd) {
		...
		return true;
																...
																#line 78 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
// This generated class is to be used only via open()
															#line 76 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
template <class OpenActor>
															#line 76 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class OpenActorState {
															#line 84 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
															#line 76 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	OpenActorState(std::string const& filename,int const& flags,int const& mode,void* const& ignore) 
		 ...
		 : filename(filename),
		   ...
		   mode(mode),
															#line 76 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   ignore(ignore)
															#line 97 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	{
	...
	{
		try {
															#line 77 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			std::string open_filename = filename;
															#line 78 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			if (flags & OPEN_ATOMIC_WRITE_AND_CREATE)
															#line 114 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			{
															#line 79 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				ASSERT((flags & OPEN_CREATE) && (flags & OPEN_READWRITE) && !(flags & OPEN_EXCLUSIVE));
															#line 80 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				open_filename = filename + ".part";
															#line 120 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			}
															#line 83 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			p = Promise<Void>();
															#line 84 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			r = eio_open(open_filename.c_str(), openFlags(flags), mode, 0, eio_callback, &p);
															#line 126 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			try {
															#line 86 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				...
				if (static_cast<OpenActor*>(this)->actor_wait_state < 0) return a_body1Catch2(actor_cancelled(), loopDepth);
															#line 132 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				...
				__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< OpenActor, 0, Void >*>(static_cast<OpenActor*>(this)));
															#line 137 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				loopDepth = 0;
			}
			catch (Error& error) {
	...
	{
															#line 91 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (r->result < 0)
															#line 166 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		{
															#line 92 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			errno = r->errorno;
															#line 93 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			bool notFound = errno == ENOENT;
															#line 94 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			Error e = notFound ? file_not_found() : io_error();
															#line 95 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			TraceEvent(notFound ? SevWarn : SevWarnAlways, "FileOpenError") .error(e) .GetLastError() .detail("File", filename) .detail("Flags", flags) .detail("Mode", mode);
															#line 101 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			return a_body1Catch1(e, loopDepth);
															#line 178 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
															#line 103 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		TraceEvent("AsyncFileOpened") .suppressFor(1.0) .detail("Filename", filename) .detail("Fd", r->result) .detail("Flags", flags);
															#line 109 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if ((flags & OPEN_LOCK) && !lock_fd(r->result))
															#line 184 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		{
															#line 110 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			TraceEvent(SevError, "UnableToLockFile").detail("Filename", filename).GetLastError();
															#line 111 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			return a_body1Catch1(io_error(), loopDepth);
															#line 190 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
															#line 114 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<OpenActor*>(this)->SAV<Reference<IAsyncFile>>::futures) { (void)(Reference<IAsyncFile>(new AsyncFileEIO(r->result, flags, filename))); this->~OpenActorState(); static_cast<OpenActor*>(this)->destroy(); return 0; }
															#line 194 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	{
		try {
															#line 88 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			eio_cancel(r);
															#line 89 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			return a_body1Catch1(__current_error, loopDepth);
															#line 209 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
		} catch (...) {
	...
	Promise<Void> p;
															#line 84 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	eio_req* r;
															#line 319 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
};
// This generated class is to be used only via open()
															#line 76 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class OpenActor final : public Actor<Reference<IAsyncFile>>, public ActorCallback< OpenActor, 0, Void >, public FastAllocated<OpenActor>, public OpenActorState<OpenActor> {
															#line 324 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
...
friend struct ActorCallback< OpenActor, 0, Void >;
	...
	OpenActor(std::string const& filename,int const& flags,int const& mode,void* const& ignore) 
															#line 335 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
...
[[nodiscard]] static Future<Reference<IAsyncFile>> open( std::string const& filename, int const& flags, int const& mode, void* const& ignore ) {
	...
	return Future<Reference<IAsyncFile>>(new OpenActor(filename, flags, mode, ignore));
															#line 362 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
}

#line 116 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	static Future<Void> deleteFile(std::string filename, bool mustBeDurable) {
		...
		if (mustBeDurable) {
			...
			return Void();
																...
																#line 375 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
// This generated class is to be used only via renameFile()
															#line 125 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
template <class RenameFileActor>
															#line 125 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class RenameFileActorState {
															#line 381 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
															#line 125 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	RenameFileActorState(std::string const& from,std::string const& to) 
		 ...
		 : from(from),
															#line 125 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   to(to),
															#line 126 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   taskID(g_network->getCurrentTask()),
															#line 127 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   p(),
															#line 128 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   r(eio_rename(from.c_str(), to.c_str(), 0, eio_callback, &p))
															#line 396 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	{
	...
	int a_body1(int loopDepth=0) 
	{
		try {
			try {
															#line 130 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				StrictFuture<Void> __when_expr_0 = p.getFuture();
															#line 130 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				if (static_cast<RenameFileActor*>(this)->actor_wait_state < 0) return a_body1Catch2(actor_cancelled(), loopDepth);
															#line 414 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch2(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
				...
				__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< RenameFileActor, 0, Void >*>(static_cast<RenameFileActor*>(this)));
															#line 419 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				loopDepth = 0;
			}
			catch (Error& error) {
				loopDepth = a_body1Catch2(error, loopDepth);
	...
	{
		try {
															#line 137 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			result = r->result;
															#line 138 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			if (result == -1)
															#line 451 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			{
															#line 139 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				TraceEvent(SevError, "FileRenameError").detail("Errno", r->errorno);
															#line 140 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				return a_body1cont1Catch1(internal_error(), loopDepth);
															#line 457 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			}
			else
			{
															#line 142 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				...
				if (static_cast<RenameFileActor*>(this)->actor_wait_state < 0) return a_body1cont1Catch1(actor_cancelled(), loopDepth);
															#line 465 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				...
				__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< RenameFileActor, 1, Void >*>(static_cast<RenameFileActor*>(this)));
															#line 470 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				loopDepth = 0;
			}
		}
		catch (Error& error) {
	...
	{
		try {
															#line 132 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			g_network->setCurrentTask(taskID);
															#line 133 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			eio_cancel(r);
															#line 134 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			return a_body1Catch1(__current_error, loopDepth);
															#line 491 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
		} catch (...) {
	...
	{
		try {
															#line 146 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			_e = e;
															#line 147 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			...
			if (static_cast<RenameFileActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 598 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			...
			__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< RenameFileActor, 2, Void >*>(static_cast<RenameFileActor*>(this)));
															#line 603 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	{
															#line 143 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<RenameFileActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~RenameFileActorState(); static_cast<RenameFileActor*>(this)->destroy(); return 0; }
															#line 618 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	int a_body1cont7(Void && _,int loopDepth) 
	{
															#line 143 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<RenameFileActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~RenameFileActorState(); static_cast<RenameFileActor*>(this)->destroy(); return 0; }
															#line 630 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		new (&static_cast<RenameFileActor*>(this)->SAV< Void >::value()) Void(Void());
		this->~RenameFileActorState();
		static_cast<RenameFileActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	{
															#line 148 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		return a_body1Catch1(_e, loopDepth);
															#line 705 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	int a_body1cont1Catch1cont1(Void && _,int loopDepth) 
	{
															#line 148 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		return a_body1Catch1(_e, loopDepth);
															#line 713 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	int result;
															#line 146 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	Error _e;
															#line 794 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
};
// This generated class is to be used only via renameFile()
															#line 125 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class RenameFileActor final : public Actor<Void>, public ActorCallback< RenameFileActor, 0, Void >, public ActorCallback< RenameFileActor, 1, Void >, public ActorCallback< RenameFileActor, 2, Void >, public FastAllocated<RenameFileActor>, public RenameFileActorState<RenameFileActor> {
															#line 799 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
...
friend struct ActorCallback< RenameFileActor, 2, Void >;
	...
	RenameFileActor(std::string const& from,std::string const& to) 
															#line 812 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> renameFile( std::string const& from, std::string const& to ) {
	...
	return Future<Void>(new RenameFileActor(from, to));
															#line 841 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
}

#line 151 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"

																#line 846 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
// This generated class is to be used only via lastWriteTime()
															#line 152 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
template <class LastWriteTimeActor>
															#line 152 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class LastWriteTimeActorState {
															#line 852 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
															#line 152 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	LastWriteTimeActorState(std::string const& filename) 
															...
															#line 152 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		 : filename(filename)
															#line 859 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	{
	...
	{
		try {
															#line 153 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			...
			if (static_cast<LastWriteTimeActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 876 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< LastWriteTimeActor, 0, EIO_STRUCT_STAT >*>(static_cast<LastWriteTimeActor*>(this)));
															#line 881 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	{
															#line 154 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<LastWriteTimeActor*>(this)->SAV<std::time_t>::futures) { (void)(statdata.st_mtime); this->~LastWriteTimeActorState(); static_cast<LastWriteTimeActor*>(this)->destroy(); return 0; }
															#line 904 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	int a_body1cont1(EIO_STRUCT_STAT && statdata,int loopDepth) 
	{
															#line 154 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<LastWriteTimeActor*>(this)->SAV<std::time_t>::futures) { (void)(statdata.st_mtime); this->~LastWriteTimeActorState(); static_cast<LastWriteTimeActor*>(this)->destroy(); return 0; }
															#line 916 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		new (&static_cast<LastWriteTimeActor*>(this)->SAV< std::time_t >::value()) std::time_t(statdata.st_mtime);
		this->~LastWriteTimeActorState();
		static_cast<LastWriteTimeActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	void a_callback_error(ActorCallback< LastWriteTimeActor, 0, EIO_STRUCT_STAT >*,Error err) 
	{
		...
		fdb_probe_actor_exit("lastWriteTime", reinterpret_cast<unsigned long>(this), 0);
															...
															#line 152 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	std::string filename;
															#line 989 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
};
// This generated class is to be used only via lastWriteTime()
															#line 152 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class LastWriteTimeActor final : public Actor<std::time_t>, public ActorCallback< LastWriteTimeActor, 0, EIO_STRUCT_STAT >, public FastAllocated<LastWriteTimeActor>, public LastWriteTimeActorState<LastWriteTimeActor> {
															#line 994 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
...
friend struct ActorCallback< LastWriteTimeActor, 0, EIO_STRUCT_STAT >;
	...
	LastWriteTimeActor(std::string const& filename) 
															#line 1005 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		 : Actor<std::time_t>(),
...
[[nodiscard]] static Future<std::time_t> lastWriteTime( std::string const& filename ) {
	...
	return Future<std::time_t>(new LastWriteTimeActor(filename));
															#line 1032 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
}

#line 156 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	...
	std::string getFilename() const override { return filename; }
																...
																#line 1079 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
// This generated class is to be used only via async_fsync_parent()
															#line 199 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
template <class Async_fsync_parentActor>
															#line 199 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class Async_fsync_parentActorState {
															#line 1085 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
															#line 199 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	Async_fsync_parentActorState(std::string const& filename) 
															...
															#line 199 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		 : filename(filename)
															#line 1092 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	{
	...
	{
		try {
															#line 200 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			std::string folder = parentDirectory(filename);
															#line 201 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			TraceEvent("FSyncParentDir").detail("Folder", folder).detail("File", filename);
															#line 202 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			folderFD = ::open(folder.c_str(), O_DIRECTORY | O_CLOEXEC, 0);
															#line 203 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			if (folderFD < 0)
															#line 1113 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			{
															#line 204 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				return a_body1Catch1(io_error(), loopDepth);
															#line 1117 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			}
			try {
															#line 206 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				...
				if (static_cast<Async_fsync_parentActor*>(this)->actor_wait_state < 0) return a_body1Catch2(actor_cancelled(), loopDepth);
															#line 1124 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch2(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
				...
				__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< Async_fsync_parentActor, 0, Void >*>(static_cast<Async_fsync_parentActor*>(this)));
															#line 1129 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				loopDepth = 0;
			}
			catch (Error& error) {
				loopDepth = a_body1Catch2(error, loopDepth);
	...
	int a_body1cont1(int loopDepth) 
	{
															#line 211 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		close(folderFD);
															#line 212 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<Async_fsync_parentActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~Async_fsync_parentActorState(); static_cast<Async_fsync_parentActor*>(this)->destroy(); return 0; }
															#line 1160 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	{
		try {
															#line 208 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			close(folderFD);
															#line 209 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			return a_body1Catch1(__current_error, loopDepth);
															#line 1175 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
		} catch (...) {
	...
	std::string filename;
															#line 202 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	int folderFD;
															#line 1277 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
};
// This generated class is to be used only via async_fsync_parent()
															#line 199 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class Async_fsync_parentActor final : public Actor<Void>, public ActorCallback< Async_fsync_parentActor, 0, Void >, public FastAllocated<Async_fsync_parentActor>, public Async_fsync_parentActorState<Async_fsync_parentActor> {
															#line 1282 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
...
friend struct ActorCallback< Async_fsync_parentActor, 0, Void >;
	...
	Async_fsync_parentActor(std::string const& filename) 
															#line 1293 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> async_fsync_parent( std::string const& filename ) {
	...
	return Future<Void>(new Async_fsync_parentActor(filename));
															#line 1320 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
}

#line 214 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	...
	static Future<Void> async_fsync(int fd) {
		...
		return sync_impl(fd, makeReference<ErrorInfo>(), true);
																...
																#line 1333 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
// This generated class is to be used only via waitAndAtomicRename()
															#line 223 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
template <class WaitAndAtomicRenameActor>
															#line 223 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class WaitAndAtomicRenameActorState {
															#line 1339 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
															#line 223 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	WaitAndAtomicRenameActorState(Future<Void> const& fsync,std::string const& part_filename,std::string const& final_filename) 
		 ...
		 : fsync(fsync),
		   ...
		   final_filename(final_filename)
															#line 1350 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	{
	...
	{
		try {
															#line 227 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			...
			if (static_cast<WaitAndAtomicRenameActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 1367 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< WaitAndAtomicRenameActor, 0, Void >*>(static_cast<WaitAndAtomicRenameActor*>(this)));
															#line 1372 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	{
															#line 230 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (rename(part_filename.c_str(), final_filename.c_str()))
															#line 1395 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		{
															#line 231 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			TraceEvent("AsyncFileEIORenameError").detail("Filename", final_filename).GetLastError();
															#line 232 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			return a_body1Catch1(io_error(), loopDepth);
															#line 1401 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
															#line 236 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		StrictFuture<Void> __when_expr_1 = async_fsync_parent(final_filename);
															#line 236 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (static_cast<WaitAndAtomicRenameActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 1407 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< WaitAndAtomicRenameActor, 1, Void >*>(static_cast<WaitAndAtomicRenameActor*>(this)));
															#line 1412 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		loopDepth = 0;
	...
	int a_body1cont1(Void && _,int loopDepth) 
	{
															#line 230 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (rename(part_filename.c_str(), final_filename.c_str()))
															#line 1421 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		{
															#line 231 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			TraceEvent("AsyncFileEIORenameError").detail("Filename", final_filename).GetLastError();
															#line 232 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			return a_body1Catch1(io_error(), loopDepth);
															#line 1427 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
															#line 236 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		StrictFuture<Void> __when_expr_1 = async_fsync_parent(final_filename);
															#line 236 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (static_cast<WaitAndAtomicRenameActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 1433 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		static_cast<WaitAndAtomicRenameActor*>(this)->actor_wait_state = 2;
															#line 236 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< WaitAndAtomicRenameActor, 1, Void >*>(static_cast<WaitAndAtomicRenameActor*>(this)));
															#line 1438 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		loopDepth = 0;
	...
	int a_body1cont2(Void const& _,int loopDepth) 
	{
															#line 238 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<WaitAndAtomicRenameActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~WaitAndAtomicRenameActorState(); static_cast<WaitAndAtomicRenameActor*>(this)->destroy(); return 0; }
															#line 1510 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	int a_body1cont2(Void && _,int loopDepth) 
	{
															#line 238 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<WaitAndAtomicRenameActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~WaitAndAtomicRenameActorState(); static_cast<WaitAndAtomicRenameActor*>(this)->destroy(); return 0; }
															#line 1522 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		new (&static_cast<WaitAndAtomicRenameActor*>(this)->SAV< Void >::value()) Void(Void());
		this->~WaitAndAtomicRenameActorState();
		static_cast<WaitAndAtomicRenameActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	std::string final_filename;
															#line 1599 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
};
// This generated class is to be used only via waitAndAtomicRename()
															#line 223 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class WaitAndAtomicRenameActor final : public Actor<Void>, public ActorCallback< WaitAndAtomicRenameActor, 0, Void >, public ActorCallback< WaitAndAtomicRenameActor, 1, Void >, public FastAllocated<WaitAndAtomicRenameActor>, public WaitAndAtomicRenameActorState<WaitAndAtomicRenameActor> {
															#line 1604 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
...
friend struct ActorCallback< WaitAndAtomicRenameActor, 1, Void >;
	...
	WaitAndAtomicRenameActor(Future<Void> const& fsync,std::string const& part_filename,std::string const& final_filename) 
															#line 1616 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> waitAndAtomicRename( Future<Void> const& fsync, std::string const& part_filename, std::string const& final_filename ) {
	...
	return Future<Void>(new WaitAndAtomicRenameActor(fsync, part_filename, final_filename));
															#line 1644 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
}

#line 240 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	...
	static void error(const char* context,
		...
		if (err)
			...
			throw e;
																...
																#line 1731 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
// This generated class is to be used only via close_impl()
															#line 323 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
template <class Close_implActor>
															#line 323 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class Close_implActorState {
															#line 1737 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
															#line 323 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	Close_implActorState(int const& fd) 
															...
															#line 323 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		 : fd(fd),
															#line 324 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   p(),
															#line 325 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   r(eio_close(fd, 0, eio_callback, &p))
															#line 1748 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	{
	...
	{
		try {
															#line 326 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			StrictFuture<Void> __when_expr_0 = p.getFuture();
															#line 326 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
															#line 1765 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			...
			__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< Close_implActor, 0, Void >*>(static_cast<Close_implActor*>(this)));
															#line 1769 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont1(Void const& _,int loopDepth) 
	{
															#line 327 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (r->result)
															#line 1791 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		{
															#line 328 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			error("CloseError", fd, r);
															#line 1795 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
															#line 329 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		TraceEvent("AsyncFileClosed").suppressFor(1.0).detail("Fd", fd);
															#line 1799 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		loopDepth = a_body1cont4(loopDepth);
	...
	int a_body1cont1(Void && _,int loopDepth) 
	{
															#line 327 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (r->result)
															#line 1808 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		{
															#line 328 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			error("CloseError", fd, r);
															#line 1812 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
															#line 329 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		TraceEvent("AsyncFileClosed").suppressFor(1.0).detail("Fd", fd);
															#line 1816 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		loopDepth = a_body1cont4(loopDepth);
	...
	int a_body1cont4(int loopDepth) 
	{
															#line 323 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		delete static_cast<Close_implActor*>(this);
															#line 1888 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		return 0;
	...
	Promise<Void> p;
															#line 325 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	eio_req* r;
															#line 1899 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
};
// This generated class is to be used only via close_impl()
															#line 323 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class Close_implActor final : public Actor<void>, public ActorCallback< Close_implActor, 0, Void >, public FastAllocated<Close_implActor>, public Close_implActorState<Close_implActor> {
															#line 1904 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
...
friend struct ActorCallback< Close_implActor, 0, Void >;
	...
	Close_implActor(int const& fd) 
															#line 1915 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		 : Actor<void>(),
...
static void close_impl( int const& fd ) {
	...
	new Close_implActor(fd);
															#line 1933 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
}

#line 331 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"

																#line 1938 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
// This generated class is to be used only via read_impl()
															#line 332 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
template <class Read_implActor>
															#line 332 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class Read_implActorState {
															#line 1944 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
															#line 332 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	Read_implActorState(int const& fd,void* const& data,int const& length,int64_t const& offset) 
		 ...
		 : fd(fd),
		   ...
		   length(length),
															#line 332 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   offset(offset),
															#line 333 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   taskID(g_network->getCurrentTask()),
															#line 334 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   p(),
															#line 336 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   r(eio_read(fd, data, length, offset, 0, eio_callback, &p))
															#line 1963 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	{
	...
	int a_body1(int loopDepth=0) 
	{
		try {
			try {
															#line 338 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				StrictFuture<Void> __when_expr_0 = p.getFuture();
															#line 338 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				if (static_cast<Read_implActor*>(this)->actor_wait_state < 0) return a_body1Catch2(actor_cancelled(), loopDepth);
															#line 1981 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch2(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
				...
				__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< Read_implActor, 0, Void >*>(static_cast<Read_implActor*>(this)));
															#line 1986 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				loopDepth = 0;
			}
			catch (Error& error) {
				loopDepth = a_body1Catch2(error, loopDepth);
	...
	{
		try {
															#line 345 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			result = r->result;
															#line 347 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			if (result == -1)
															#line 2018 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			{
															#line 348 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				error("ReadError", fd, r);
															#line 349 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				return a_body1cont1Catch1(internal_error(), loopDepth);
															#line 2024 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			}
			else
			{
															#line 351 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				StrictFuture<Void> __when_expr_1 = delay(0, taskID);
															#line 351 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				if (static_cast<Read_implActor*>(this)->actor_wait_state < 0) return a_body1cont1Catch1(actor_cancelled(), loopDepth);
															#line 2032 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1cont1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
				...
				__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< Read_implActor, 1, Void >*>(static_cast<Read_implActor*>(this)));
															#line 2037 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				loopDepth = 0;
			}
		}
		catch (Error& error) {
	...
	{
		try {
															#line 340 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			g_network->setCurrentTask(taskID);
															#line 341 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			eio_cancel(r);
															#line 342 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			return a_body1Catch1(__current_error, loopDepth);
															#line 2058 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
		} catch (...) {
	...
	{
		try {
															#line 355 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			e = _e;
															#line 356 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			StrictFuture<Void> __when_expr_2 = delay(0, taskID);
															#line 356 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			if (static_cast<Read_implActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 2165 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			if (__when_expr_2.isReady()) { if (__when_expr_2.isError()) return a_body1Catch1(__when_expr_2.getError(), loopDepth); else return a_body1cont1Catch1when1(__when_expr_2.get(), loopDepth); };
			...
			__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< Read_implActor, 2, Void >*>(static_cast<Read_implActor*>(this)));
															#line 2170 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	int a_body1cont7(Void const& _,int loopDepth) 
	{
															#line 352 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<Read_implActor*>(this)->SAV<int>::futures) { (void)(result); this->~Read_implActorState(); static_cast<Read_implActor*>(this)->destroy(); return 0; }
															#line 2185 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	int a_body1cont7(Void && _,int loopDepth) 
	{
															#line 352 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<Read_implActor*>(this)->SAV<int>::futures) { (void)(result); this->~Read_implActorState(); static_cast<Read_implActor*>(this)->destroy(); return 0; }
															#line 2197 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		new (&static_cast<Read_implActor*>(this)->SAV< int >::value()) int(std::move(result)); // state_var_RVO
		this->~Read_implActorState();
		static_cast<Read_implActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	int a_body1cont1Catch1cont1(Void const& _,int loopDepth) 
	{
															#line 357 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		return a_body1Catch1(e, loopDepth);
															#line 2272 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	int a_body1cont1Catch1cont1(Void && _,int loopDepth) 
	{
															#line 357 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		return a_body1Catch1(e, loopDepth);
															#line 2280 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	int result;
															#line 355 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	Error e;
															#line 2365 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
};
// This generated class is to be used only via read_impl()
															#line 332 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class Read_implActor final : public Actor<int>, public ActorCallback< Read_implActor, 0, Void >, public ActorCallback< Read_implActor, 1, Void >, public ActorCallback< Read_implActor, 2, Void >, public FastAllocated<Read_implActor>, public Read_implActorState<Read_implActor> {
															#line 2370 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
...
friend struct ActorCallback< Read_implActor, 2, Void >;
	...
	Read_implActor(int const& fd,void* const& data,int const& length,int64_t const& offset) 
															#line 2383 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		 : Actor<int>(),
...
[[nodiscard]] static Future<int> read_impl( int const& fd, void* const& data, int const& length, int64_t const& offset ) {
	...
	return Future<int>(new Read_implActor(fd, data, length, offset));
															#line 2412 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
}

#line 360 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"

																#line 2417 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
// This generated class is to be used only via write_impl()
															#line 361 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
template <class Write_implActor>
															#line 361 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class Write_implActorState {
															#line 2423 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
															#line 361 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	Write_implActorState(int const& fd,Reference<ErrorInfo> const& err,StringRef const& data,int64_t const& offset) 
		 ...
		 : fd(fd),
		   ...
		   data(data),
															#line 361 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   offset(offset),
															#line 362 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   taskID(g_network->getCurrentTask()),
															#line 363 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   p(),
															#line 364 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   r(eio_write(fd, (void*)data.begin(), data.size(), offset, 0, eio_callback, &p))
															#line 2442 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	{
	...
	int a_body1(int loopDepth=0) 
	{
		try {
			try {
															#line 366 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				StrictFuture<Void> __when_expr_0 = p.getFuture();
															#line 366 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				if (static_cast<Write_implActor*>(this)->actor_wait_state < 0) return a_body1Catch2(actor_cancelled(), loopDepth);
															#line 2460 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch2(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
				...
				__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< Write_implActor, 0, Void >*>(static_cast<Write_implActor*>(this)));
															#line 2465 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				loopDepth = 0;
			}
			catch (Error& error) {
				loopDepth = a_body1Catch2(error, loopDepth);
	...
	int a_body1cont1(int loopDepth) 
	{
															#line 372 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (r->result != data.size())
															#line 2494 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		{
															#line 373 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			error("WriteError", fd, r, err);
															#line 2498 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
															#line 374 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		StrictFuture<Void> __when_expr_1 = delay(0, taskID);
															#line 374 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (static_cast<Write_implActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 2504 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< Write_implActor, 1, Void >*>(static_cast<Write_implActor*>(this)));
															#line 2509 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		loopDepth = 0;
	...
	{
		try {
															#line 368 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			g_network->setCurrentTask(taskID);
															#line 369 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			eio_cancel(r);
															#line 370 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			return a_body1Catch1(__current_error, loopDepth);
															#line 2523 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
		} catch (...) {
	...
	{
															#line 375 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<Write_implActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~Write_implActorState(); static_cast<Write_implActor*>(this)->destroy(); return 0; }
															#line 2625 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	int a_body1cont4(Void && _,int loopDepth) 
	{
															#line 375 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<Write_implActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~Write_implActorState(); static_cast<Write_implActor*>(this)->destroy(); return 0; }
															#line 2637 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		new (&static_cast<Write_implActor*>(this)->SAV< Void >::value()) Void(Void());
		this->~Write_implActorState();
		static_cast<Write_implActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Promise<Void> p;
															#line 364 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	eio_req* r;
															#line 2722 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
};
// This generated class is to be used only via write_impl()
															#line 361 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class Write_implActor final : public Actor<Void>, public ActorCallback< Write_implActor, 0, Void >, public ActorCallback< Write_implActor, 1, Void >, public FastAllocated<Write_implActor>, public Write_implActorState<Write_implActor> {
															#line 2727 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
...
friend struct ActorCallback< Write_implActor, 1, Void >;
	...
	Write_implActor(int const& fd,Reference<ErrorInfo> const& err,StringRef const& data,int64_t const& offset) 
															#line 2739 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> write_impl( int const& fd, Reference<ErrorInfo> const& err, StringRef const& data, int64_t const& offset ) {
	...
	return Future<Void>(new Write_implActor(fd, err, data, offset));
															#line 2767 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
}

#line 377 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"

																#line 2772 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
// This generated class is to be used only via truncate_impl()
															#line 378 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
template <class Truncate_implActor>
															#line 378 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class Truncate_implActorState {
															#line 2778 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
															#line 378 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	Truncate_implActorState(int const& fd,Reference<ErrorInfo> const& err,int64_t const& size) 
		 ...
		 : fd(fd),
		   ...
		   err(err),
															#line 378 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   size(size),
															#line 379 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   taskID(g_network->getCurrentTask()),
															#line 380 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   p(),
															#line 381 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   r(eio_ftruncate(fd, size, 0, eio_callback, &p))
															#line 2795 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	{
	...
	int a_body1(int loopDepth=0) 
	{
		try {
			try {
															#line 383 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				StrictFuture<Void> __when_expr_0 = p.getFuture();
															#line 383 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				if (static_cast<Truncate_implActor*>(this)->actor_wait_state < 0) return a_body1Catch2(actor_cancelled(), loopDepth);
															#line 2813 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch2(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
				...
				__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< Truncate_implActor, 0, Void >*>(static_cast<Truncate_implActor*>(this)));
															#line 2818 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				loopDepth = 0;
			}
			catch (Error& error) {
				loopDepth = a_body1Catch2(error, loopDepth);
	...
	int a_body1cont1(int loopDepth) 
	{
															#line 389 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (r->result)
															#line 2847 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		{
															#line 390 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			error("TruncateError", fd, r, err);
															#line 2851 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
															#line 391 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		StrictFuture<Void> __when_expr_1 = delay(0, taskID);
															#line 391 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (static_cast<Truncate_implActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 2857 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< Truncate_implActor, 1, Void >*>(static_cast<Truncate_implActor*>(this)));
															#line 2862 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		loopDepth = 0;
	...
	{
		try {
															#line 385 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			g_network->setCurrentTask(taskID);
															#line 386 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			eio_cancel(r);
															#line 387 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			return a_body1Catch1(__current_error, loopDepth);
															#line 2876 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
		} catch (...) {
	...
	int a_body1cont4(Void const& _,int loopDepth) 
	{
															#line 392 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<Truncate_implActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~Truncate_implActorState(); static_cast<Truncate_implActor*>(this)->destroy(); return 0; }
															#line 2978 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	int a_body1cont4(Void && _,int loopDepth) 
	{
															#line 392 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<Truncate_implActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~Truncate_implActorState(); static_cast<Truncate_implActor*>(this)->destroy(); return 0; }
															#line 2990 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		new (&static_cast<Truncate_implActor*>(this)->SAV< Void >::value()) Void(Void());
		this->~Truncate_implActorState();
		static_cast<Truncate_implActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	Promise<Void> p;
															#line 381 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	eio_req* r;
															#line 3073 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
};
// This generated class is to be used only via truncate_impl()
															#line 378 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class Truncate_implActor final : public Actor<Void>, public ActorCallback< Truncate_implActor, 0, Void >, public ActorCallback< Truncate_implActor, 1, Void >, public FastAllocated<Truncate_implActor>, public Truncate_implActorState<Truncate_implActor> {
															#line 3078 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
...
friend struct ActorCallback< Truncate_implActor, 1, Void >;
	...
	Truncate_implActor(int const& fd,Reference<ErrorInfo> const& err,int64_t const& size) 
															#line 3090 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> truncate_impl( int const& fd, Reference<ErrorInfo> const& err, int64_t const& size ) {
	...
	return Future<Void>(new Truncate_implActor(fd, err, size));
															#line 3118 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
}

#line 394 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	...
	static eio_req* start_fsync(int fd, Promise<Void>& p, bool sync_metadata) {
		...
		if (sync_metadata)
			...
			return eio_fdatasync(fd, 0, eio_callback, &p);
																...
																#line 3144 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
// This generated class is to be used only via sync_impl()
															#line 416 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
template <class Sync_implActor>
															#line 416 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class Sync_implActorState {
															#line 3150 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
															#line 416 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	Sync_implActorState(int const& fd,Reference<ErrorInfo> const& err,bool const& sync_metadata = false) 
		 ...
		 : fd(fd),
		   ...
		   sync_metadata(sync_metadata),
															#line 417 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   taskID(g_network->getCurrentTask()),
															#line 418 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   p(),
															#line 419 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   r(start_fsync(fd, p, sync_metadata))
															#line 3167 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	{
	...
	int a_body1(int loopDepth=0) 
	{
		try {
			try {
															#line 422 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				StrictFuture<Void> __when_expr_0 = p.getFuture();
															#line 422 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				if (static_cast<Sync_implActor*>(this)->actor_wait_state < 0) return a_body1Catch2(actor_cancelled(), loopDepth);
															#line 3185 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch2(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
				...
				__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< Sync_implActor, 0, Void >*>(static_cast<Sync_implActor*>(this)));
															#line 3190 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				loopDepth = 0;
			}
			catch (Error& error) {
				loopDepth = a_body1Catch2(error, loopDepth);
	...
	{
		try {
															#line 430 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			err->report();
															#line 432 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			if (r->result)
															#line 3222 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			{
															#line 433 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				error("SyncError", fd, r);
															#line 3226 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			}
															#line 434 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			StrictFuture<Void> __when_expr_1 = delay(0, taskID);
															#line 434 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			if (static_cast<Sync_implActor*>(this)->actor_wait_state < 0) return a_body1cont1Catch1(actor_cancelled(), loopDepth);
															#line 3232 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1cont1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
			...
			__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< Sync_implActor, 1, Void >*>(static_cast<Sync_implActor*>(this)));
															#line 3237 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1cont1Catch1(error, loopDepth);
	...
	{
		try {
															#line 424 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			g_network->setCurrentTask(taskID);
															#line 425 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			eio_cancel(r);
															#line 426 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			return a_body1Catch1(__current_error, loopDepth);
															#line 3257 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
		} catch (...) {
	...
	{
		try {
															#line 437 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			e = _e;
															#line 438 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			StrictFuture<Void> __when_expr_2 = delay(0, taskID);
															#line 438 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			if (static_cast<Sync_implActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 3364 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			if (__when_expr_2.isReady()) { if (__when_expr_2.isError()) return a_body1Catch1(__when_expr_2.getError(), loopDepth); else return a_body1cont1Catch1when1(__when_expr_2.get(), loopDepth); };
			...
			__when_expr_2.addCallbackAndClear(static_cast<ActorCallback< Sync_implActor, 2, Void >*>(static_cast<Sync_implActor*>(this)));
															#line 3369 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
			loopDepth = 0;
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
	...
	{
															#line 435 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<Sync_implActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~Sync_implActorState(); static_cast<Sync_implActor*>(this)->destroy(); return 0; }
															#line 3384 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	int a_body1cont5(Void && _,int loopDepth) 
	{
															#line 435 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<Sync_implActor*>(this)->SAV<Void>::futures) { (void)(Void()); this->~Sync_implActorState(); static_cast<Sync_implActor*>(this)->destroy(); return 0; }
															#line 3396 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		new (&static_cast<Sync_implActor*>(this)->SAV< Void >::value()) Void(Void());
		this->~Sync_implActorState();
		static_cast<Sync_implActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	int a_body1cont1Catch1cont1(Void const& _,int loopDepth) 
	{
															#line 439 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		return a_body1Catch1(e, loopDepth);
															#line 3471 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	int a_body1cont1Catch1cont1(Void && _,int loopDepth) 
	{
															#line 439 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		return a_body1Catch1(e, loopDepth);
															#line 3479 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	eio_req* r;
															#line 437 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	Error e;
															#line 3560 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
};
// This generated class is to be used only via sync_impl()
															#line 416 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class Sync_implActor final : public Actor<Void>, public ActorCallback< Sync_implActor, 0, Void >, public ActorCallback< Sync_implActor, 1, Void >, public ActorCallback< Sync_implActor, 2, Void >, public FastAllocated<Sync_implActor>, public Sync_implActorState<Sync_implActor> {
															#line 3565 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
...
friend struct ActorCallback< Sync_implActor, 2, Void >;
	...
	Sync_implActor(int const& fd,Reference<ErrorInfo> const& err,bool const& sync_metadata = false) 
															#line 3578 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		 : Actor<Void>(),
...
[[nodiscard]] static Future<Void> sync_impl( int const& fd, Reference<ErrorInfo> const& err, bool const& sync_metadata = false ) {
	...
	return Future<Void>(new Sync_implActor(fd, err, sync_metadata));
															#line 3607 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
}

#line 442 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"

																#line 3612 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
// This generated class is to be used only via size_impl()
															#line 443 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
template <class Size_implActor>
															#line 443 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class Size_implActorState {
															#line 3618 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
															#line 443 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	Size_implActorState(int const& fd) 
															...
															#line 443 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		 : fd(fd),
															#line 444 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   taskID(g_network->getCurrentTask()),
															#line 445 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   p(),
															#line 446 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   r(eio_fstat(fd, 0, eio_callback, &p))
															#line 3631 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	{
	...
	int a_body1(int loopDepth=0) 
	{
		try {
			try {
															#line 448 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				StrictFuture<Void> __when_expr_0 = p.getFuture();
															#line 448 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				if (static_cast<Size_implActor*>(this)->actor_wait_state < 0) return a_body1Catch2(actor_cancelled(), loopDepth);
															#line 3649 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch2(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
				...
				__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< Size_implActor, 0, Void >*>(static_cast<Size_implActor*>(this)));
															#line 3654 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				loopDepth = 0;
			}
			catch (Error& error) {
				loopDepth = a_body1Catch2(error, loopDepth);
	...
	int a_body1cont1(int loopDepth) 
	{
															#line 454 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (r->result)
															#line 3683 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		{
															#line 455 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			error("FStatError", fd, r);
															#line 3687 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
															#line 456 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		EIO_STRUCT_STAT* statdata = (EIO_STRUCT_STAT*)r->ptr2;
															#line 457 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!statdata)
															#line 3693 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		{
															#line 458 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			error("FStatBufferError", fd, r);
															#line 3697 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
															#line 459 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		size = statdata->st_size;
															#line 460 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		StrictFuture<Void> __when_expr_1 = delay(0, taskID);
															#line 460 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (static_cast<Size_implActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 3705 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< Size_implActor, 1, Void >*>(static_cast<Size_implActor*>(this)));
															#line 3710 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		loopDepth = 0;
	...
	{
		try {
															#line 450 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			g_network->setCurrentTask(taskID);
															#line 451 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			eio_cancel(r);
															#line 452 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			return a_body1Catch1(__current_error, loopDepth);
															#line 3724 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
		} catch (...) {
	...
	int a_body1cont4(Void const& _,int loopDepth) 
	{
															#line 461 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<Size_implActor*>(this)->SAV<int64_t>::futures) { (void)(size); this->~Size_implActorState(); static_cast<Size_implActor*>(this)->destroy(); return 0; }
															#line 3826 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	int a_body1cont4(Void && _,int loopDepth) 
	{
															#line 461 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<Size_implActor*>(this)->SAV<int64_t>::futures) { (void)(size); this->~Size_implActorState(); static_cast<Size_implActor*>(this)->destroy(); return 0; }
															#line 3838 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		new (&static_cast<Size_implActor*>(this)->SAV< int64_t >::value()) int64_t(std::move(size)); // state_var_RVO
		this->~Size_implActorState();
		static_cast<Size_implActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	eio_req* r;
															#line 459 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	int64_t size;
															#line 3919 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
};
// This generated class is to be used only via size_impl()
															#line 443 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class Size_implActor final : public Actor<int64_t>, public ActorCallback< Size_implActor, 0, Void >, public ActorCallback< Size_implActor, 1, Void >, public FastAllocated<Size_implActor>, public Size_implActorState<Size_implActor> {
															#line 3924 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
...
friend struct ActorCallback< Size_implActor, 1, Void >;
	...
	Size_implActor(int const& fd) 
															#line 3936 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		 : Actor<int64_t>(),
...
[[nodiscard]] static Future<int64_t> size_impl( int const& fd ) {
	...
	return Future<int64_t>(new Size_implActor(fd));
															#line 3964 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
}

#line 463 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"

																#line 3969 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
// This generated class is to be used only via stat_impl()
															#line 464 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
template <class Stat_implActor>
															#line 464 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class Stat_implActorState {
															#line 3975 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
															#line 464 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	Stat_implActorState(std::string const& filename) 
															...
															#line 464 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		 : filename(filename),
															#line 465 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   taskID(g_network->getCurrentTask()),
															#line 466 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   p(),
															#line 467 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   statdata(),
															#line 468 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   r(eio_stat(filename.c_str(), 0, eio_callback, &p))
															#line 3990 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	{
	...
	int a_body1(int loopDepth=0) 
	{
		try {
			try {
															#line 470 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				StrictFuture<Void> __when_expr_0 = p.getFuture();
															#line 470 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				if (static_cast<Stat_implActor*>(this)->actor_wait_state < 0) return a_body1Catch2(actor_cancelled(), loopDepth);
															#line 4008 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch2(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
				...
				__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< Stat_implActor, 0, Void >*>(static_cast<Stat_implActor*>(this)));
															#line 4013 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				loopDepth = 0;
			}
			catch (Error& error) {
				loopDepth = a_body1Catch2(error, loopDepth);
	...
	int a_body1cont1(int loopDepth) 
	{
															#line 476 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (r->result)
															#line 4042 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		{
															#line 477 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			error("StatError", 0, r);
															#line 4046 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
															#line 478 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!r->ptr2)
															#line 4050 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		{
															#line 479 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			error("StatBufferError", 0, r);
															#line 4054 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
															#line 480 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		statdata = *EIO_STAT_BUF(r);
															#line 481 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		StrictFuture<Void> __when_expr_1 = delay(0, taskID);
															#line 481 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (static_cast<Stat_implActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 4062 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< Stat_implActor, 1, Void >*>(static_cast<Stat_implActor*>(this)));
															#line 4067 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		loopDepth = 0;
	...
	{
		try {
															#line 472 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			g_network->setCurrentTask(taskID);
															#line 473 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			eio_cancel(r);
															#line 474 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			return a_body1Catch1(__current_error, loopDepth);
															#line 4081 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
		} catch (...) {
	...
	int a_body1cont4(Void const& _,int loopDepth) 
	{
															#line 482 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<Stat_implActor*>(this)->SAV<EIO_STRUCT_STAT>::futures) { (void)(statdata); this->~Stat_implActorState(); static_cast<Stat_implActor*>(this)->destroy(); return 0; }
															#line 4183 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	int a_body1cont4(Void && _,int loopDepth) 
	{
															#line 482 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<Stat_implActor*>(this)->SAV<EIO_STRUCT_STAT>::futures) { (void)(statdata); this->~Stat_implActorState(); static_cast<Stat_implActor*>(this)->destroy(); return 0; }
															#line 4195 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		new (&static_cast<Stat_implActor*>(this)->SAV< EIO_STRUCT_STAT >::value()) EIO_STRUCT_STAT(std::move(statdata)); // state_var_RVO
		this->~Stat_implActorState();
		static_cast<Stat_implActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	EIO_STRUCT_STAT statdata;
															#line 468 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	eio_req* r;
															#line 4276 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
};
// This generated class is to be used only via stat_impl()
															#line 464 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class Stat_implActor final : public Actor<EIO_STRUCT_STAT>, public ActorCallback< Stat_implActor, 0, Void >, public ActorCallback< Stat_implActor, 1, Void >, public FastAllocated<Stat_implActor>, public Stat_implActorState<Stat_implActor> {
															#line 4281 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
...
friend struct ActorCallback< Stat_implActor, 1, Void >;
	...
	Stat_implActor(std::string const& filename) 
															#line 4293 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
...
[[nodiscard]] static Future<EIO_STRUCT_STAT> stat_impl( std::string const& filename ) {
	...
	return Future<EIO_STRUCT_STAT>(new Stat_implActor(filename));
															#line 4321 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
}

#line 484 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"

																#line 4326 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
// This generated class is to be used only via dispatch_impl()
															#line 485 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
template <class R, class Dispatch_implActor>
															#line 485 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class Dispatch_implActorState {
															#line 4332 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
															#line 485 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	Dispatch_implActorState(std::function<R()> const& func) 
															...
															#line 485 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		 : func(func),
															#line 487 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   data(func),
															#line 488 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   taskID(g_network->getCurrentTask()),
															#line 490 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		   r(eio_custom( [](eio_req* req) { auto data = reinterpret_cast<Dispatch<R>*>(req->data); try { data->result = data->func(); req->result = 0; } catch (Error& e) { data->result = e; req->result = -1; } catch (...) { data->result = unknown_error(); req->result = -1; } }, 0, [](eio_req* req) { if (EIO_CANCELLED(req)) return 0; auto data = reinterpret_cast<Dispatch<R>*>(req->data); Promise<Void> p = std::move(data->done); p.send(Void()); return 0; }, &data))
															#line 4345 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	{
	...
	int a_body1(int loopDepth=0) 
	{
		try {
			try {
															#line 517 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
				...
				if (static_cast<Dispatch_implActor*>(this)->actor_wait_state < 0) return a_body1Catch2(actor_cancelled(), loopDepth);
															#line 4363 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch2(__when_expr_0.getError(), loopDepth); else return a_body1when1(__when_expr_0.get(), loopDepth); };
				...
				__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< Dispatch_implActor, 0, Void >*>(static_cast<Dispatch_implActor*>(this)));
															#line 4368 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
				loopDepth = 0;
			}
			catch (Error& error) {
				loopDepth = a_body1Catch2(error, loopDepth);
	...
	int a_body1cont1(int loopDepth) 
	{
															#line 524 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		StrictFuture<Void> __when_expr_1 = delay(0, taskID);
															#line 524 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (static_cast<Dispatch_implActor*>(this)->actor_wait_state < 0) return a_body1Catch1(actor_cancelled(), loopDepth);
															#line 4399 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		if (__when_expr_1.isReady()) { if (__when_expr_1.isError()) return a_body1Catch1(__when_expr_1.getError(), loopDepth); else return a_body1cont1when1(__when_expr_1.get(), loopDepth); };
		...
		__when_expr_1.addCallbackAndClear(static_cast<ActorCallback< Dispatch_implActor, 1, Void >*>(static_cast<Dispatch_implActor*>(this)));
															#line 4404 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		loopDepth = 0;
	...
	{
		try {
															#line 519 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			g_network->setCurrentTask(taskID);
															#line 520 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			eio_cancel(r);
															#line 521 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			return a_body1Catch1(__current_error, loopDepth);
															#line 4418 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
		catch (Error& error) {
			loopDepth = a_body1Catch1(error, loopDepth);
		} catch (...) {
	...
	int a_body1cont4(Void const& _,int loopDepth) 
	{
															#line 525 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (data.result.isError())
															#line 4520 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		{
															#line 526 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			return a_body1Catch1(data.result.getError(), loopDepth);
															#line 4524 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
															#line 527 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<Dispatch_implActor*>(this)->SAV<R>::futures) { (void)(data.result.get()); this->~Dispatch_implActorState(); static_cast<Dispatch_implActor*>(this)->destroy(); return 0; }
															#line 4528 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	int a_body1cont4(Void && _,int loopDepth) 
	{
															#line 525 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (data.result.isError())
															#line 4540 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		{
															#line 526 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			return a_body1Catch1(data.result.getError(), loopDepth);
															#line 4544 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		}
															#line 527 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!static_cast<Dispatch_implActor*>(this)->SAV<R>::futures) { (void)(data.result.get()); this->~Dispatch_implActorState(); static_cast<Dispatch_implActor*>(this)->destroy(); return 0; }
															#line 4548 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		new (&static_cast<Dispatch_implActor*>(this)->SAV< R >::value()) R(data.result.get());
		this->~Dispatch_implActorState();
		static_cast<Dispatch_implActor*>(this)->finishSendAndDelPromiseRef();
		return 0;
	...
	TaskPriority taskID;
															#line 490 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	eio_req* r;
															#line 4627 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
};
// This generated class is to be used only via dispatch_impl()
															#line 485 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
template <class R>
...
class Dispatch_implActor final : public Actor<R>, public ActorCallback< Dispatch_implActor<R>, 0, Void >, public ActorCallback< Dispatch_implActor<R>, 1, Void >, public FastAllocated<Dispatch_implActor<R>>, public Dispatch_implActorState<R, Dispatch_implActor<R>> {
															#line 4634 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
...
friend struct ActorCallback< Dispatch_implActor<R>, 1, Void >;
	...
	Dispatch_implActor(std::function<R()> const& func) 
															#line 4646 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		 : Actor<R>(),
...
[[nodiscard]] static Future<R> dispatch_impl( std::function<R()> const& func ) {
	...
	return Future<R>(new Dispatch_implActor<R>(func));
															#line 4676 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
}

#line 529 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"

	static std::atomic<int32_t> want_poll;

																#line 4683 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
// This generated class is to be used only via poll_eio()
															#line 532 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
template <class Poll_eioActor>
															#line 532 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
class Poll_eioActorState {
															#line 4689 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
															#line 532 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	Poll_eioActorState() 
															#line 532 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	{
															#line 4695 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	{
		try {
															#line 533 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
			;
															#line 4709 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
	...
	int a_body1cont1(int loopDepth) 
	{
															#line 535 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		want_poll = 0;
															#line 4731 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		loopDepth = a_body1cont3(loopDepth);
	...
	int a_body1loopBody1(int loopDepth) 
	{
															#line 533 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (!(eio_poll() == -1))
															#line 4747 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		{
			return a_body1break1(loopDepth==0?0:loopDepth-1); // break
		}
															#line 534 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		StrictFuture<Void> __when_expr_0 = yield();
															#line 534 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		if (__when_expr_0.isReady()) { if (__when_expr_0.isError()) return a_body1Catch1(__when_expr_0.getError(), std::max(0, loopDepth - 1)); else return a_body1loopBody1when1(__when_expr_0.get(), loopDepth); };
															#line 4755 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		...
		__when_expr_0.addCallbackAndClear(static_cast<ActorCallback< Poll_eioActor, 0, Void >*>(static_cast<Poll_eioActor*>(this)));
															#line 4759 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		loopDepth = 0;
	...
	int a_body1cont3(int loopDepth) 
	{
															#line 532 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
		delete static_cast<Poll_eioActor*>(this);
															#line 4856 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		return 0;
...
class Poll_eioActor final : public Actor<void>, public ActorCallback< Poll_eioActor, 0, Void >, public FastAllocated<Poll_eioActor>, public Poll_eioActorState<Poll_eioActor> {
															#line 4865 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
public:
...
friend struct ActorCallback< Poll_eioActor, 0, Void >;
															#line 532 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	Poll_eioActor() 
															#line 4876 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
		 : Actor<void>(),
...
static void poll_eio(  ) {
															#line 532 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
	new Poll_eioActor();
															#line 4894 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.g.h"
}

#line 537 "/usr/src/libfdb_c/fdbrpc/AsyncFileEIO.actor.h"
